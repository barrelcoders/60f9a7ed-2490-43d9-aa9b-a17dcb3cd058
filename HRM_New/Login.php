...
if ($_REQUEST["isSubmit"]=="yes")
{
	...
	else
	{
			if ($spassword==$password)
			{
				...
				echo "<script type='text/javascript'>window.location.href = 'EmployeeBase.php';</script>";
				exit();
				die();
			}
			else
...
<style>
 ...
 .fiw a{margin-left:10%}.fiw a:first-child{margin-left:0%}
</style>
...
<div align="right"><a href="../index.php"><img src="../Admin/images/BackButton.png" width="7%"></a></div>
 <div class="row">
  <div class="col-md-7">
   <img src="../Admin/images/DPS.jpg" class="img-responsive" style="height:72%">
    ...
    <tr>
	 ...
	 <td align="center">
	   <h3 align="center" style="color:rgba(11,70,45,0.84);">STAFF LOGIN</h3>
		  ...
		  <input type="button" name="Abutton1" value="Login" id="pupillogin" onClick="Javascript:Validate();"></br> <br>
		  <input type="checkbox" value="r">&nbsp;&nbsp;Remember me 
		  <a href="#forget.html" style="margin-left:25%"><u>Forget Password</u></a><br><br><br>
		 </td>
    </tr>
     <tr>
  <td align="center" class="fiw">
