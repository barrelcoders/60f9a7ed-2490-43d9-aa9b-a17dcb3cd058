...
<head>
 <meta charset='utf-8'>
   ...
   <title>Employee Portal</title><link rel="icon" href="l.png" type="image/x-icon">
...
<div id="container">
 ...
 <div class="table_top">
  <table>
   <tr> 
    <td> <u><b class="heading">Student Attendance Register</b></u> </td>
 ...
 <div class="row new_row new_row1">
  ...
  <div class="col-md-3"><a href="studentattendance.php">Upload Student Attendance</a> </div>
  <div class="col-md-3 active"><a href="studentattendancereport.php">Previous Uploaded Attendance Report</a> </div>
 ...
 <div class="row attendance_row">
  ...
  <div class="col-md-2"> <input type="date" name="txtDate" id="txtDate" value="Classwork Date" class="text-box"></div>
  <div class="col-md-2">Roll No.:</div>
  <div class="col-md-2"> <input type="text" name="studentrollno" id="txtrollno" placeholder="Student Roll No." class="text-box"></div>
