...
.form .hr{border:1px solid #eaeaea; padding:0; width:100%;}
.form{padding:0%; width:100%; margin-top:2%;}
.form .table1, .form .table2{width:100%;} .form .table1 table, .form .table2 table{width:100%;}
.form .text-box{border:1px solid rgba(11,70,45,0.4); border-radius:3px; width:80%; padding:1% 1%; font-size:13px!important; height:30px;}
input:focus, button:focus, textarea:focus{box-shadow:none; outline:none;} .form .col-xs-3{} .form .row div{float:left;}
.form .col-xs-3, .form .col-xs-6{margin:0.5% 0;} .form .col-xs-2, .form .col-xs-7, .form .col-xs-5{margin:1% 0; font-size:13px; text-align:justify;}
.form table td{padding:0.5% 1%;} .form b{color:#060;}
.form .head{color:#060; font-size:15px; font-weight:600;} .form .head1{color:#090; font-size:14px; font-weight:600;}
.form .table12 table td{width:25%; text-align:justify; font-size:13px; padding:0.5% 1.2%;} 
.form .table12 table td .text-box{font-size:14px!important; padding:2% 2%; height:30px; width:100%;}
.form .table1 table tr, .form .table12 table tr, .form .table3 table tr{border:none;}
.form .table1 table td{text-align:justify; font-size:13px; padding:1% 1.5%;} .form .table1 table td:first-child{width:10%;} 
.form .table1 table td .text-box{font-size:14px!important; padding:2% 2%; height:30px; width:100%;} .form .table1 table td:nth-child(3n+3){width:25%;}
.form .col-xs-5 .tb23{padding:2%; height:30px; font-size:14px;} .form .col-xs-6 .tbta{height:35px; min-width:80%; padding:2%;}
.form .table3 table td:first-child{width:8%;}  .form .col-xs-5 .text-box{height:30px;}
.form .table3 table td{width:33%; padding:1% 1%; font-size:13px;} .form .table3 table td .text-box{width:80%; padding:2%; height:30px;}
.form .table4 table{width:100%;} .form .table4 table td{font-size:13px; padding:0.7% 0.5%;} .form .table4 table .col td{  background:#6aec6a; } 
.form .table4 table td .text-box{width:100%; padding:2%; height:30px;} .form .table4 table tr{border-bottom:1px solid #ccc;}
.form .btns{text-align:center;} .form .tba3{height:30px;}
.form .btns .submit-btn{border:1px solid #4cae4c; background:#5cb85c; color:#fff; padding:0.5% 1.5%; border-radius:3px;} 
.form .btns .submit-btn:hover{background:#690;} .form .btns .clear-btn:hover{background:#690;}
.form .btns .clear-btn{border:1px solid #eea236; background:#f0ad4e; color:#fff; padding:0.5% 1.5%; border-radius:3px;} 
.form .last p{font-size:13px; line-height:3;} .form .last p b{margin-right:1.5%;}
.form #scroll {position:fixed; right:10px; bottom:10px; cursor:pointer; width:50px; height:50px; background-color:#0b462d; text-indent:-9999px; display:none;    -webkit-border-radius:60px;  -moz-border-radius:60px;  border-radius:60px }
#scroll span{position:absolute; top:50%; left:50%; margin-left:-8px; margin-top:-12px; height:0; width:0; border:8px solid transparent;    border-bottom-color:#ffffff }
.form #scroll:hover {  background-color:#5cb85c;  opacity:1;filter:"alpha(opacity=100)";  -ms-filter:"alpha(opacity=100)"; }
.form input[type=radio]{margin-right:3%; zoom: 1.3;} .form input[type=checkbox] {zoom: 1.5;}  
</style>
<body>
<div id="container">
<!----Header--------->
...
<div class="row c">
 <div class="col-md-2 hris1"> 
  <h4>SELF SERVICE</h4>
  <ul>
   <li><a href="payroll.php">View Payslip</a></li>
   <li><a href="#payrollfbp.php">FBP Planner</a></li>
   <li class="active"><a href="investment_declaration.php">Investment Declaration</a></li>
   <li><a href="#payrollnewfbp.php">NEW FBP CLAIM</a></li>
   <li><a href="#payrollmyfbp.php">MY FBP CLAIMS</a></li>
   <li><a href="payrollproofsubmission.php">Proof Submission</a></li>
   <li><a href="payrollform16.php">Form16</a></li>
   <li><a href="#payrollnpsdecl.php">NPS Declaration</a></li>
  </ul>
 </div>
 <!------------------------->
 <div class="col-md-10">
