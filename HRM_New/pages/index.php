...
<head>
 <meta charset='utf-8'>
   ...
   <title>DPS Faridabad</title><link rel="icon" href="../l.png" type="image/x-icon">
   ...
   <script src="../js/jquery-ui-datepicker.min"></script>
</head>
...
<div class="c1">
<div class="row c">
 <div class="col-md-3 a1" style="width:20%"> <?php include 'sidemanu.php'; ?> </div>
 ...
 <div class="col-md-3 r" style="width:20%">
  <h4>EVENTS</h4>
...
<script>
  ...
  <a href="#" style="float:right;" ><img src="../images/bdv.png" class="img-circle" width="25px;" height="20px"></a><hr>
  <a href="#robert">Robert Wilton C (11792)</a>
  <a href="#" style="float:right;" ><img src="../images/bdv.png" class="img-circle" width="25px;" height="20px"></a><hr><br>
