...
function Validate()
{
	if(document.getElementById("hEWSCategory").value !="Yes")
	{
		if(document.getElementById("F4").value=="")
		{
			alert("Father's ITR is mandatory!");
			return;
		}
		if(document.getElementById("cboMotherITRAvailable").value=="Yes")
		{
			if(document.getElementById("F5").value=="")
			{
				alert("Mother's ITR is mandatory!");
				return;
			}
		}
	}
...
{
	if(document.getElementById("cboClass").value=="10th")
	{
...
function fnlMandatoruShowHide()
{
	...
	{
		document.getElementById("tdMandatorySubject").innerHTML ="<b><u><font face='Cambria'>Mandatory Subjects :</u></b> <br><br>1. English Core<br>2. History<br>3. Political Science<br>4*. (a) Economics<br>    (a) Phychology</font>";
	}
...
<strong><font face="Cambria" style="font-size: 14pt">&nbsp;STREAM AND INFORMATION UPDATE 
FORM</font></strong></p>
...
<p  style="height: 12px" align="left" class="style25">&nbsp;</p>
	...
	<form name="frmNewStudent" id="frmNewStudent" method="post" action="SubmitfrmStudentMasterInfo.php" enctype="multipart/form-data">
		...
		&nbsp;</td>
			...
			<tr>
				...
				<td style="width: 16%" class="auto-style11">				<font face="Cambria">
		...
		<font face="Cambria">8. Class
				...
				<span class="auto-style33"><font face="Cambria">Currently 
		Studying</font></span><span style="color: #000000" class="auto-style33"><font face="Cambria"> 
		in*:</font></span></td>
		...
		&nbsp;</td>
			...
			<tr>
				<td style="width: 16%" class="auto-style11">
		<span class="style30">9.</span> <span class="auto-style21">
		<font face="Cambria">Aadhar Card No.</font></span></td>
				<td style="width: 16%" class="auto-style11">
		<input name="txtAadharCardNo" type="text" class="text-box"></td>
				<td style="width: 3%" class="auto-style11">
				&nbsp;</td>
				<td style="width: 159px" class="auto-style19" colspan="2">
		&nbsp;</td>
	...
	<td class="style32" colspan="2" valign="top" id="tdMandatorySubject">
		...
		(Select Any Two Only):</strong></font><strong><br>
				...
				<br>
				<select size="16" name="cboOptionalSubject" id="cboOptionalSubject" onclick="fnlSelectionCheck();" multiple>
...
&nbsp;&nbsp;</td>
		...
		&nbsp;</td>
			...
			<tr>
				<td style="width: 212px; " class="auto-style11">
		<font face="Cambria"><b>14.</b>School TransportRequired</font></td>
				<td class="auto-style11" colspan="2">
		...
		If you do not fall into any category, please select Others.)</i></font></span>
		</td>
				</tr>
			<tr>
				<td class="auto-style11" colspan="6">
...
<tr>			
		...
		<p>
		3<font face="Cambria">. Copy of Previous year Father's ITR :<input type="file" name="F4" id="F4" size="20"></font>
		</p>
		<p>
		<strong>Mother's ITR available : </strong>
		<select name="cboMotherITRAvailable" id="cboMotherITRAvailable">
		<option selected="" value="Yes">Yes</option>
		<option value="No">No</option>
		</select></p>
		<p>
		4<font face="Cambria">. Copy of Previous year Mother's ITR :<input type="file" name="F5" id="F5" size="20"></font>
		<p>
		&nbsp;</td>
		...
		<font face="Cambria"><b>20. Marks / Grades Obtained in Class X : </b>
		</font></td>
</tr>
		<tr>
		<td style="border-bottom-width: 1px">
		...
		<font face="Cambria">1. I understand that rendering false / incorrect or 
		misleading information may invoke disciplinary action against my ward as 
		per school rules and regulation</font></p>
		<p><font face="Cambria">2. I have carefully read the rules, regulations 
		and procedures laid down by the school, I hereby agree to abide by them 
		in all respects</font></p>
		<p><font face="Cambria">3. I hereby certify that my ward and I shall 
