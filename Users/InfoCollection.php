...
<!---<table border="1" width="100%" cellspacing="1" style="border-width:0px; border-collapse: collapse" height="80" bordercolor="#000000" id="table1">
	<tr>
<td> 
<p align="center"><font size="5" face="Verdana" color="#FF0000">Coming Soon</font></td>
...
<table border="1" width="100%" cellspacing="1" style="border-width:0px; border-collapse: collapse" height="80" bordercolor="#000000" id="table1">
	<tr>
		...
		Information Collection Center</span></td>
	</tr>
	<tr>		<td style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-bottom-style: none; border-bottom-width: medium">
		...
		<table border="1" width="1012" height="131">
			<tr>
				<td colspan="4" align="center" height="38"><b>
				<font face="Cambria"><span style="background-color: #FFFF00">In 
				this section, you are requested to Submit the Information as 
				requested by School in various forms. Please read the 
				descriptions and click on the link as appropriate</span></font></b><p>&nbsp;</td>
			</tr>
			<tr>
				<td align="center" width="74" height="32"><b>
				<font face="Cambria">Sr No</font></b></td>
				<td align="center" width="370" height="32"><b>
				<font face="Cambria">Parameter</font></b></td>
				<td align="center" width="505" height="32"><b>
				<font face="Cambria">Description</font></b></td>
				<td align="center" width="505" height="32">
				<b><font face="Cambria">Link For Submission</font></b></td>
			</tr>
	...
	$rs=mysql_query("SELECT `sclass`, `parameter`, `description`, `URL`, `Status` FROM `StudentInfoCollectionMaster` where `sclass`='$class' ");
	...
	?>
			...
			<tr>
				<td align="center"><font face="Cambria"><?php echo $recno; ?></font></td>
				<td align="center" class="style2" width="321">
				<font face="Cambria"><?php echo $Parameter;?></font></td>



		<td align="center" class="style2" width="321"><font face="Cambria"><?php echo $Description;?></font></td>

	  <td align="center" class="style2"><font face="Cambria"><a href="<?php echo $URL;?>">Click Here</a></font></td>
			</tr>
			<?php
	$recno=$recno+1;
