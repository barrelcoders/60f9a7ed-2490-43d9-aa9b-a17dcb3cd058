...
$ssql="SELECT a.`sclass` , a.`subject` , a.`testdate` ,a.`testtype` FROM `datesheet` a where  a.`sclass`='$StudentClass ' and testtype=''";
...
$rsTestType=mysql_query("select distinct `testtype` from `datesheet` where `sclass`='$StudentClass ' order by `testtype`");
...

{
	...
	$ssql="SELECT a.`sclass` , a.`subject` , a.`testdate` ,a.`testtype` FROM `datesheet` a where  a.`sclass`='$StudentClass ' and a.`testtype`='$TstType'";
$rs= mysql_query($ssql);
...
<div class="wrapper col2">
  <div id="breadcrumb">
    <ul>
      ...
      <li>»</li>
		<li class="current"><a href="#">Datesheet</a></li>
    </ul>
  </div>
</div>
...
<table border="1" width="100%" cellspacing="1" style="border-width:0px; border-collapse: collapse" height="80" bordercolor="#000000" id="table1">
	...
	<tr>
		...
		<td bgcolor="#AA3F41" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-top-style: none; border-top-width: medium">

		<p style="margin-left: 10px">

		<span style="font-family:Cambria;font-size:18px;font-weight:bold;font-style:normal;text-decoration:none;color:#FFFFFF;">

		Exams Datesheet</span></td>
	...
	<tr>
		...
		<table border="1" width="100%" id="table6" style="border-width:0px; border-collapse: collapse; " bordercolor="#000000">
<form name ="frmTestType" id="frmTestType" method="POST" action="DateSheet.php">
			<tr>

				<td width="129" height="35" align="center" style="border-top:medium none #000000; border-bottom:medium none #000000; border-left-style:none; border-left-width:medium; border-right-style:none; border-right-width:medium" bgcolor="#FFFFFF">

					<select size="1" name="cboTestType" id="cboTestType" onchange ="fnlSearByTestType();">
				...
				<a href="DateSheet.php"><font color="#FFFFFF"><b>

				<span style="text-decoration: none">Date Sheet</span></b></font></a></td>-->
		...
		<table border="1" width="100%" style="border-collapse: collapse" bordercolor="#000000" id="table3">
			...
			<tr>
				...
				<td height="35" width="348" bgcolor="#FFFFFF" align="center">
				...
				<td height="35" bgcolor="#FFFFFF" align="center" width="349">
			...
			<tr>
				...
				<td height="35" width="348" align="center">
				...
				<?php echo $testdate; ?></span></td>

				<td height="35" width="349" align="center">

				<span style="font-family: Cambria; font-size: 15px; font-weight: normal; font-style: normal; text-decoration: none; color: #000000">

				<?php echo $testtype; ?></span></td>
			...
			<tr>
				...
				<td height="35" width="348" align="center">&nbsp;</td>

				<td height="35" width="348" align="center">&nbsp;</td>

				<td height="35" width="348" align="center">&nbsp;</td>

				<td height="35" width="349" align="center">&nbsp;</td>
