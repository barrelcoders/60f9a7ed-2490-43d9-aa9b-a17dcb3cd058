...
//$rs=mysql_query("select `ReceiptCode` from `fees_receipt_code1` where `ReceiptNo`='$receiptno' and `sadmissionno`='$sadmission'");
$rs=mysql_query("select `ReceiptCode` from `fees_receipt_code` where `ReceiptNo`='$receiptno'");
