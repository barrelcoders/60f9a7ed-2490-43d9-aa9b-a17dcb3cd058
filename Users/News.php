  ...
  <div class="navbar-container container-fluid">
    <div class="collapse navbar-collapse" id="app-navbar-collapse">
      <ul class="nav navbar-toolbar navbar-toolbar-left navbar-left">
        ...
        <li>
          <h5 class="page-title hidden-menubar-top hidden-float">News</h5>
        </li>
      </ul>
    </div>
				...
				<div class="table-responsive">
					<table class="table mail-list">
						<tr>
							...
							?>
								<!-- a single mail -->
								<div class="mail-item" onclick="showNews(<?php echo $item['srno']; ?>);">
									<table class="mail-container">
										<tr>
											<td class="mail-left">
												<div class="avatar avatar-sm avatar-circle">
													<a href="#"><img src="<?php echo  $item['imageurl']; ?>" alt="Image"></a>
												</div>
											</td>
											<td class="mail-center">
												<div class="mail-item-header">
													<h4 class="mail-item-title"><a href="javascript:void(0);" class="title-color"><?php echo  $item['newstitle']; ?></a></h4>
												</div>
												<p class="mail-item-excerpt"><?php echo  $item['news']; ?></p>
											</td>
											<td class="mail-right">
												<p class="mail-item-date"><?php echo date('d-m-Y', strtotime($item['date'])); ?></p>
