...
//$ssql="SELECT b.`sclass` , b.`subject` , b.`classwork`, b.`classworkdate` FROM `classwork_master` b where b.classworkdate=curdate() -1 and b.`sclass`='$class'";
$ssql="SELECT b.`sclass` , b.`subject` , b.`classwork`, b.`classworkdate`,(select `homework` from `homework_master` where `subject`=b.`subject` and homeworkdate=curdate()-1 and `sclass`='$class') as `homework` FROM `classwork_master` b where b.classworkdate=curdate()-1 and b.`sclass`='$class'";
$rs= mysql_query($ssql);
$num_rows=0;
?>
...
<div class="wrapper col2">
  <div id="breadcrumb">
    <ul>
      ...
      <li>»</li>
		<li class="current"><a href="#">Yesterday Homework</a></li>
    </ul>
  </div>
</div>
...
<div>
  <div>
	...
	<tr>
		...
		<table border="1" width="1010" id="table5" style="border-width:0px; border-collapse: collapse; " bordercolor="#000000">
			...
			<tr>
				...
				<td  bgcolor="#FFFFFF" align="center" width="336">



				<font color="#CD222B" face="Cambria">
				...
				<a href="SearchClassWork.php" class="style1">

				<span class="auto-style1">Search Previous</span></a></font></td>
		...
		<table border="1" width="100%" style="border-collapse: collapse" bordercolor="#000000" id="table6">
			...
			<tr>
				...
				<td height="35" bgcolor="#FFFFFF" align="center" style="width: 90px">
				...
				<td height="35" bgcolor="#FFFFFF" align="center" style="width: 91px">
			...
			<tr>
				...
				<td height="35" align="center" style="width: 91px">
			...
			<tr>
				...
				<td height="35" align="center" style="width: 90px">&nbsp;</td>



				<td height="35" align="center" style="width: 91px">&nbsp;</td>
