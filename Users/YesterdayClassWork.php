<?php 
	...
	$homeworks = $db->rawQuery($manager->query['YesterdayClassworkHomeworkByClass'], array($class));
?>
	  ...
	  <div class="navbar-container container-fluid">
		<div class="collapse navbar-collapse" id="app-navbar-collapse">
		  <ul class="nav navbar-toolbar navbar-toolbar-left navbar-left">
			...
			<li>
			  <h5 class="page-title hidden-menubar-top hidden-float">Yesterday's Homework</h5>
			</li>
		  </ul>
		</div>
