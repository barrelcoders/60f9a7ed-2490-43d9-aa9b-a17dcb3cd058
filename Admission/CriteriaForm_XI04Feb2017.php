...
<div align="center" class="h h11"><b><font >Enter your grades in Class X Term-I Exam</font></b></div>
  <div class="row">
  <div class="col-xs-6 xs" style="text-align:center; font-size:16px;"><strong>CBSE</strong></div>
  <div class="col-xs-6 xs" style="text-align:center; font-size:16px;"><strong>NON - CBSE</strong></div>
  </div>
  <hr class="hr">
  <div class="row">
...
<div align="center" class="h h11" style="text-transform:capitalize;"><b>SPECIAL ACHIEVEMENTS (Sports, Cultural, Public Speaking, Olympiads, Exhibition/ Model Making etc)</b></div>
 ...
 <div id="div1" style="display:none">
  <div class="row"> 
   ...
   <div class="col-xs-3"><input type="text" name="cbosciiencesubject2" id="cbosciiencesubject2" class="text-box" required="true"></div>
  </div>
  <div class="row"> 
   <div class="col-xs-3">Subject 3</div>
   <div class="col-xs-3"><input type="text" name="cbosciiencesubject3" id="cbosciiencesubject3" class="text-box" required="true"></div>
   <div class="col-xs-3">Subject 4</div>
   <div class="col-xs-3"><input type="text" name="cbosciiencesubject4" id="cbosciiencesubject4" class="text-box" required="true"></div>
  </div>
  <div class="row">
   <div class="col-xs-3">Subject 5</div>
   <div class="col-xs-3"><input type="text" name="cbosciiencesubject5" id="cbosciiencesubject5" class="text-box" required="true"></div>
   <div class="col-xs-6">&nbsp;</div>
    </div>
 </div>
 <div id="div2" style="display:none;">
  <div class="row"> 
   ...
   <div class="col-xs-3">Subject 2</div>
   <div class="col-xs-3"><input type="text" name="cbocommercesubject2" id="cbocommercesubject2" class="text-box" required="true"></div>
  </div>
  <div class="row"> 
   <div class="col-xs-3">Subject 3</div>
   <div class="col-xs-3"><input type="text" name="cbocommercesubject3" id="cbocommercesubject3" class="text-box" required="true"></div>
   <div class="col-xs-3">Subject 4</div>
   <div class="col-xs-3"><input type="text" name="cbocommercesubject4" id="cbocommercesubject4" class="text-box" required="true"></div>
  </div>
  <div class="row">
   <div class="col-xs-3">Subject 5</div>
   <div class="col-xs-3"><input type="text" name="cbocommercesubject5" id="cbocommercesubject5" class="text-box" required="true"></div>
   <div class="col-xs-6">&nbsp;</div>
  </div>
 </div>
 <div id="div3" style="display:none;">
  <div class="row"> 
   ...
   <div class="col-xs-3">Subject 2</div>
   <div class="col-xs-3"><input type="text" name="cbohuminitiessubject2" id="cbohuminitiessubject2" class="text-box" required="true"></div>
  </div>
  <div class="row"> 
   <div class="col-xs-3">Subject 3</div>
   <div class="col-xs-3"><input type="text" name="cbohuminitiessubject3" id="cbohuminitiessubject3" class="text-box" required="true"></div>
   <div class="col-xs-3">Subject 4</div>
   <div class="col-xs-3"><input type="text" name="cbohuminitiessubject4" id="cbohuminitiessubject4" class="text-box" required="true"></div>
  </div>
  <div class="row"> 
   <div class="col-xs-3">Subject 5</div>
   <div class="col-xs-3"><input type="text" name="cbohuminitiessubject5" id="cbohuminitiessubject5" class="text-box" required="true"></div>
   <div class="col-xs-6">&nbsp;</div>
  </div>
 </div>
</div>
<div>&nbsp;</div>
<div class="tableOne">
<div align="center" class="h h11"><b><font>SUBJECT OPTION FOR COURSE OF STUDY IN CLASS XI & XII (2017 - 2019)</font></b></div>
<div>&nbsp;</div>
...
<li>Human Rights & Gender Studies</li>
 ...
 <div>&nbsp;</div>
  <div class="col-xs-12" align="center"> <input name="submit" type="submit" value="submit" /></div>
