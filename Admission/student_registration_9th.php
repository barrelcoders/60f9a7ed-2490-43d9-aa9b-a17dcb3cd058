...
$result=mysql_query("INSERT INTO `CriteriaForm9th`(`FirstName`,`MiddleName`,`LastName`,`PlaceofBirth`,`DOB`,`Age`,`Gender`,`MotherTongue`,`Nationality`,`Class`,`LastSchool`,`SecondLanguage`,`PermanentAddress`,`PermanentPhone`,`ResidentialAddress`,`ResidentialPhone`,`EnglishGrade`,`MathGrade`,`GeneralScienceGrade`,`SocialScienceGrade`"
...
?>
<?php
$sqlInq = "SELECT MAX(CAST(`RegistrationNo` AS SIGNED INTEGER)) as `srno` FROM  `NewStudentRegistration_temp_9th`";
...
<div id="container">
 ...
 <div class="row">
  ...
  <div class="col-xs-3 xs1"> <input name="txtAge" id="txtAge" type="text" class="text-box" onClick="javascript:CalculateAgeInQC();" placeholder="31-Mar-2017" required value="<?php echo $Age; ?>" readonly/></div>
 </div>
 <div class="row">
 ...
 <div>&nbsp;</div>
 <div class="h" align="center">Details of Father / Mother, if Alumni of <font style="text-transform:uppercase">DELHI PUBLIC SCHOOL</font></div>
 <div>&nbsp;</div>
 ...
 <div class="row">
  ...
  <div class="col-xs-3">
   <select size="1" name="cbocatagory" id="cbocatagory" class="text-box tbs" required  onchange="Javascript:fnlChkCatagory();">
		<option value="">Select One</option>
 ...
 <div class="row">
  <div class="col-xs-12" style="padding:0 1%;"><strong>Undertaking:</strong>
	...
	<p><b>1.</b> I understand that the registration fee of <span style="font-weight: 400">INR 25</span>/- 
                    ( as applicable ) is towards the processing fee for the IX admission process. It is 
                    non-refundable and registration does not guarantee admission.</p>
