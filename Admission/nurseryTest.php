...
<div id="container">
 <div class="row ">
  <div class="Header" align="center" ><img src="<?php echo $SchoolLogo; ?>" class="img-responsive"><br />
    ...
    <form name="frmNewStudent" id="frmNewStudent" method="post" action="nurseryPaymentTest.php" enctype="multipart/form-data">
 ...
 <div class="check check1" >
  <table>
   <tr> <td><input name="chkSibling" id="chkSibling" type="checkbox" value="10" onClick="javascript:fnlChkCategory('chkSibling');"></td> 
   		...
   		<tr><td><input name="otherdpsstaff" id="chkOtherdpsCategory" type="checkbox" value="" onClick="javascript:fnlChkCategory('chkOtherdpsCategory');"></td>
  ...
  <table>
   <tr> <td><input name="chkFatherAlumni" id="chkFatherAlumni" type="checkbox" value="" onClick="javascript:fnlChkCategory('chkFatherAlumni');"></td> 
   		<td class="col1"><strong>Father DPS Alumni</strong></td> </tr>
   
   
  </table>
  <table> 
   <tr> <td><input name="chkMotherAlumni" id="chkMotherAlumni" type="checkbox" value="" onClick="javascript:fnlChkCategory('chkMotherAlumni');"></td>
   		<td class="col1"><strong>Mother DPS Alumni</strong></td>  </tr>
   
  
  </table>
  <table>
  <!-- <tr> <td><input name="chkSingleParent" id="chkSingleParent" type="checkbox" value="" onClick="javascript:fnlChkCategory('chkSingleParent');"></td>
   		<td class="col1"><strong>Single  Parent</strong></td> </tr>-->
   <tr> <td><input name="chkDPSStaff" id="chkDPSStaff" type="checkbox" value="" onClick="javascript:fnlChkCategory('chkDPSStaff');"></td>
