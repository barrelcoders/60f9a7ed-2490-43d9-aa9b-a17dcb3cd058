...
.outer .inner .text2 table{width:50%; margin-left:25%;} 

.outer .inner .text2 table tr td{font-size:17px; color:#000; padding:1%; border:1px solid #063;}
...
<div id="container">
 ...
 <div class="outer">
  ...
  <div class="inner">
   ...
   <div class="head">Revised Instructions for Admission to Nursery / Pre School - Session (2017 – 2018)</div>
  ...
  <div class="text8">
   ...
   <table>
    ...
    <tr> <td><b>TOTAL</b></td> <td><b>100 points</b></td> </tr>
  ...
  <h3>IMPORTANT – FOR THOSE FALLING UNDER THE SINGLE PARENT OR FIRST BORN CATEGORY</h3>
