...
<head>
 ...
 <meta charset='utf-8'>
   ...
   <title>DPS</title>
    ...
    .outer .inner{border:4px double #097b4d; border-radius:7px; padding:2%; height:620px;}
    .outer{padding:2%;}
    ...
    .outer .inner .head{font-size:18px; text-align:center; text-decoration:underline; font-weight:600; margin-top:2.5%;}
	.outer .inner .notice{font-size:14px; text-align:center; font-weight:600; margin-top:2%; width:58%; margin-left:13%;}
	.outer .inner .notice a:hover{color:#0b462d;} .outer .inner .notice a{color: rgba(11, 70, 45, 0.75);}
         .outer .inner .notice {margin-top:2%;}
.outer .inner .notice1 a{font-size:14px; text-align:center; font-weight:600; margin-left:6%; color: rgba(11, 70, 45, 0.75);}
	.outer .inner .notice1 a:hover{color:#0b462d;}
       .outer .inner .notice1 {margin-top:2%;}
	   
	   .outer .inner .noticeVERIFICATION a{font-size:14px; text-align:center; font-weight:600; margin-left:32%; color: rgba(11, 70, 45, 0.75);}
	.outer .inner ..noticeVERIFICATION a:hover{color:#0b462d;}
       .outer .inner .noticeVERIFICATION {margin-top:2%;}
	   
	.outer .inner .notice11 a{font-size:14px; text-align:center; font-weight:600; margin-left:3%; color: rgba(11, 70, 45, 0.75);}
	.outer .inner .notice11 a:hover{color:#0b462d;}
       .outer .inner .notice11 {margin-top:2%;}
.noticeNew{color: rgba(11, 70, 45, 0.75); margin-left:3.5%; font-weight:600; text-transform:uppercase; margin-top:2%; font-size:14px;}
    .outer .inner .link{text-align:center; margin-top:1%;}
    .outer .inner .link a .btnmanu{background:#097b4d; color:#fff; width:40%; height:45px; font-size:16px; font-weight:bold; border:1px solid transparent; border-radius:5px;}
    ...
    <div id="container">
     ...
     <div class="outer">
      ...
      <div class="head">NURSERY / PRE-SCHOOL ADMISSIONS (SESSION 2017 - 2018)</div>
	   ...
	   <div class="notice" align="center"><a href="AdmissionToNurseryFeb.php"><img src="../Admin/images/new.gif"><strong>IMPORTANT - 15 FEBRUARY 2017</strong></a></div>
 	   <div class="notice11" align="center"><a href="AdmissionToNurseryFeb1.php"><img src="../Admin/images/new.gif"><strong>REVISED POINT SYSTEM FOR NURSERY / PRE-SCHOOL ADMISSION </strong></a></div>
       <div class="noticeNew" align="center"><img src="../Admin/images/new.gif"><strong>The last date for accepting Affidavit for Single Parent /<br> First Born has been extended till 12 Noon, 20 February 2017 (Monday).</strong></div>
