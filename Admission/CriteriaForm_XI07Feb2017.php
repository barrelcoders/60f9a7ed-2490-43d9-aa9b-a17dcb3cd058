...
<div align="center" class="h h11"><b><font >Enter your grades in Class X Term-I Exam</font></b></div>
  ...
  <div class="row">
      ...
      <div class="col-xs-6 xs" style="text-align:center; font-size:16px;"><strong><input type="radio" name="boardSelection" value="CBSE" class="boardSelection">CBSE</strong></div>

  <div class="col-xs-6 xs" style="text-align:center; font-size:16px;"><strong><input type="radio" name="boardSelection" value="NONCBSE" class="boardSelection">NON - CBSE</strong></div>
 ...
 <div class="col-xs-3 xs1"><input name="otherSecondLanguage" id="otherSecondLanguage" type="text" class="text-box" required></div>
...
<li>Human Rights & Gender Studies</li>
</ul>
</td>
</tr>
</table>
