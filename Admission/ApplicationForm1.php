	...
	.outer .inner .notice{font-size:16px; text-align:center; font-weight:600; margin-top:5%; width:58%; margin-left:20%;}
    ...
    <div id="container">
     <div class="outer">
      <div class="inner">
       ...
       <div class="head">APPLICATION FORM (SESSION 2017 <strong>-</strong> 2018)</div>
