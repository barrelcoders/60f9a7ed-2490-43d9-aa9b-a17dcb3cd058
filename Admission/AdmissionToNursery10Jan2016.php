...
.outer .inner .text2 table tr:nth-child(odd) td, 
.outer .inner .text7 table tr:nth-child(even) td,
.outer .inner .text8 table tr:nth-child(odd) td{color:#fff;}
...
<div id="container">
 <div class="outer">
  <div class="inner">
   ...
   <div class="text4">1.  Age : 3+ as on 31<sup>st</sup> March 2017 (Children born between 1<sup>st</sup> April 2013 and 31<sup>st</sup> March 2014 will be considered)</div>
    ...
    <li> Documents required (Scanned copy) :
     <ul>
	  ...
	  <li>Girl Child/ First Born (Format in the given link to be filled, scanned and uploaded)</li>
          <a href="UNDERTAKING.pdf" download>CLICK HERE TO DOWNLOAD THE FORMAT</a>
  ...
  <div class="text13"> <font>Online Registration will begin on Tuesday, 10 January 2017</font> </div>
