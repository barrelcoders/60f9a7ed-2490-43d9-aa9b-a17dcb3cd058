...
.outer .inner .marque{font-size:18px; font-weight:bold; color:#F00; background:#a9f7f4; padding:0.5%; text-align:center;}
...
<div id="container">
 <div class="outer">
  <div class="inner">
   ...
   <div class="marque"> 
    <marquee scrollamount="7">No change/resubmission will be entertained by the school in case of an incorrect entry.<br></marquee>
   </div>
   <div class="head">ADMISSSION TO CLASS IX [Session : 2017 - 2018]</div>
   <div class="text1">Delhi Public School, Rohini welcomes you to Class IX Admission process for the academic session 2017 - 2018.<br>
...
<li>Proof of Any Other Category (If applicable)</li>
	  ...
	  <li>Proof of Parent being DPS Alumni (If applicable)</li>
	  <li>Mark Sheet of Term I Exam of Class VIII</li>
      <li>Mark Sheet of Final Term of Class VII</li>
   ...
   <div>
   <strong>Date of Admission Test will be uploaded on the School portal shortly.</strong>
  <form method="post" action="CriteriaForm_9th.php">
