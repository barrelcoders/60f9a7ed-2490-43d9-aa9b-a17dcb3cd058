...
if($_POST['TxStatus']){ 
    ...
    $updateStatus=  mysql_query("UPDATE NewStudentRegistration_temp SET TxnStatus='".$TxnStatus."',pgTxnNo='".$pgTxnNo."',TxRefNo='".$TxRefNo."',TxMsg='".$TxMsg."'  WHERE RegistrationNo='".$finalRegistrationNO."'");
  ...
  <div class="inner">
    ...
    <div class="text1"><i>You have successfully registered for <b>Class <?php echo  $_SESSION['class']; ?></b> admission.</i><br> Your Application Number is <b><?php echo $_POST['TxId']; ?>.</b> </div>
      ...
      <?php }else{ ?>
       ...
       <div class="text1"><i>Your Payment Process is not completed for <b>Class <?php echo $class; ?></b> admission.</i><br> Your Application Number is <b><?php echo $RegistrationNo; ?>.</b><br /><b> Please try Again!!!</b></div>
