...
.outer .inner .marque{font-size:18px; font-weight:bold; color:#F00; background:#99ffab; padding:0.5%; text-align:center;}
...
.btnmanu{background:#0b462d; color:#fff; border:1px solid Transparent; border-radius:3px;}
.btnmanu:hover{background:#097b4d;}
...
<div id="container">
 <div class="outer">
  <div class="inner">
   ...
   <div class="head">ADMISSSION TO CLASS III, IV, V, VI, VII, VIII [Session : 2017 - 2018]</div>
   <div class="text1">Delhi Public School, Rohini welcomes you to Admission process for the academic session 2017 - 2018.<br>
   				  	  The registration and admission details will be available on the school website. 
                      Kindly visit the school website regularly.
   </div>
   ...
   <ol>
	...
	<li>The Registration process consists of three steps :
	 ...
	 <li><font><b>Step 1:</b>  Filling up the Application form (fields marked * are mandatory)</font></li>
     <li><font><b>Step 2:</b>Registration Fee Payment </font></li>
	 </ul>
</li>
...
<li>ST/SC/OBC Certificate (If applicable) </li>
  	  <li>Report Card of Term I Exam of academic session 2016-17</li>
      <li>Report Card of Final Term Exam of academic session 2015-16</li>
	  <li>Residence Proof (Ration Card issued in the name of parents (mother/father having name of the child), Domicile Certificate of child or his/her parents, Voter Identity Card / EPIC of any of the parents or child. Aadhar Card / Unique Identity Card of Mother / Father / Child issued by the Government of India / Electricity Bill / MTNL telephone bill / Water bill / Passport in the name of any of the Parents or child.)</li>
	       </ul>
    </li>
    ...
    <li>Applications for admission to Classes III, IV, V, VI, VII and VIII will be accepted.</li>
	...
	<li> Please keep your credit card, debit card and other banking details handy while filling the application form. The payment on this website is
    ...
    <li> Immediately after payment, an application number will be generated and an acknowledgement mail will reach your Email Id mentioned by you in the Application Form.</li>
	<li> Please keep the copy of the filled application form and acknowledgement slip for  future reference. </li>
   ...
   <div>
  <form method="post" action="student_registration_others.php">
