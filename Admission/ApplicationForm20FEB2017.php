...
<head>
 ...
 <meta charset='utf-8'>
   ...
   <title>DPS</title>
	...
	.outer .inner .notice{font-size:17px; text-align:center; font-weight:600; margin-top:2%; width:58%; margin-left:11%;}

	.outer .inner .notice a:hover{color:#0b462d;} .outer .inner .notice a{color: rgba(11, 70, 45, 0.75);}

         .outer .inner .notice {margin-top:2.5%;}
	...
	.outer .inner .notice11 a{font-size:17px; text-align:center; font-weight:600; margin-left:3%; color: rgba(11, 70, 45, 0.75);}
...
.noticeNew{color: rgba(11, 70, 45, 0.75); margin-left:3.5%; font-weight:600; text-transform:uppercase; margin-top:2%; font-size:17px;}
