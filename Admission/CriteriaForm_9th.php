...
<div id="container">
 ...
 <form name="criteriaform" id="criteriaform" method="post" action="student_registration_9th.php">
		
 
  <div>&nbsp;</div>
  <div style="background-color: #0b462d; padding:2px 0; color:#FFFFFF;">
    <h4 align="center">ACADEMIC PROFILE - IX (Session 2017 - 18)</h4>
  </div>
 <!-- <div class="info">
 ...
 <div class="row" >
  ...
  <div class="col-xs-3"><input type="text" name="cboClass" id="cboClass" class="text-box" value="Class IX" onChange="Javascript:GetFeeDetail();" required="true" readonly>
  </div>
...
<div align="center" class="h h11" style="text-transform:capitalize;"><b>SPECIAL ACHIEVEMENTS (Sports, Cultural, Public Speaking, Olympiads, Exhibition/ Model Making etc)</b></div>
 ...
 <div>&nbsp;</div>
  <div class="col-xs-12" align="center"> <input name="BtnSubmitCreteria" type="submit" id="submitBtn" value="Submit" /></div>
 </form>
 </div>
 </body>
 </html>
 ...
 $(document).ready(function(){
     ...
     $("#submitBtn").click(function(){
         var secondLang=$("#cboselectthirdlanguage").val();
          ...
          if((secondLang == cbosecondlanguage) || cbosecondlanguage=="Hindi B" || secondLang=="Others"){
