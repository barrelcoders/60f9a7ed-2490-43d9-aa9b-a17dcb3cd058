 ...
 <script type="text/javascript">
    $(document).ready(function(){
	 $("#CBSE").hide();
        ...
        $("#div2").hide();
        $("#div3").hide();
        $("#cbostreamFinal").change(function(){

          var value=  $("#cbostreamFinal").val();
          if(value=="Science"){
             $("#div1").show();
             $("#div2").hide();
             $("#div3").hide();
             $('#cbosciiencesubject2').attr('required', 'required');
             $('#cbosciiencesubject3').attr('required', 'required');
             $('#cbosciiencesubject4').attr('required', 'required');
             $('#cbosciiencesubject5').attr('required', 'required');

             $('#cbocommercesubject2').removeAttr('required');
             $('#cbocommercesubject3').removeAttr('required');
             $('#cbocommercesubject4').removeAttr('required');
             $('#cbocommercesubject5').removeAttr('required');

             $('#cbohuminitiessubject2').removeAttr('required');
             $('#cbohuminitiessubject3').removeAttr('required');
             $('#cbohuminitiessubject4').removeAttr('required');
             $('#cbohuminitiessubject5').removeAttr('required');

          }else if(value=="Commerce"){
               $("#div2").show();
               $("#div3").hide();
               $("#div1").hide();
             $('#cbocommercesubject2').attr('required', 'required');
             $('#cbocommercesubject3').attr('required', 'required');
             $('#cbocommercesubject4').attr('required', 'required');
             $('#cbocommercesubject5').attr('required', 'required');

             $('#cbosciiencesubject2').removeAttr('required');
             $('#cbosciiencesubject3').removeAttr('required');
             $('#cbosciiencesubject4').removeAttr('required');
             $('#cbosciiencesubject5').removeAttr('required');
             ...
             $('#cbohuminitiessubject5').removeAttr('required');
               ...
               $("#div1").hide();
               $("#div2").hide();
             $('#cbohuminitiessubject2').attr('required', 'required');
             $('#cbohuminitiessubject3').attr('required', 'required');
             $('#cbohuminitiessubject4').attr('required', 'required');
             $('#cbohuminitiessubject5').attr('required', 'required');
         ...
         $("input[name='boardSelection']").click(function() {

        var board = $(this).val();
        if(board=="CBSE"){
            $("#NONCBSE").hide();
            $("#CBSE").show();
            $('#otherEnglish').removeAttr('required');
            $('#otherScience').removeAttr('required');
            $('#otherMaths').removeAttr('required');
            $('#otherSsc').removeAttr('required');
            $('#otherSecondLanguage').removeAttr('required');
         
        }
        if(board=="NONCBSE"){
            $("#CBSE").hide();
	   $("#NONCBSE").show();
            $('#cboenglish').removeAttr('required');
            $('#cbogeneralscience').removeAttr('required');
            $('#cbomath').removeAttr('required');
            $('#cbosocialscience').removeAttr('required');
            $('#cbosecondlanguage').removeAttr('required');
...
<div id="container">
 ...
 <div class="row">
  ...
  <div class="col-xs-3"><input type="text" name="cboClass" id="cboClass" class="text-box" value="Class XI" onChange="Javascript:GetFeeDetail();" required readonly>
 ...
 <div class="row" >
  ...
  <div class="col-xs-3"> <input name="txtfirstName" id="txtfirstName" type="text" class="text-box" required> </div>
 ...
 <div class="row">
  ...
  <div class="col-xs-3"> <input name="txtDOB" id="txtDOB" type="date" class="text-box" placeholder="mm/dd/yyyy" required></div>

  <div class="col-xs-3 xs"> Age as on*:<!--<br><font class="f"> (01.04.2016)</font>--></div>

  <div class="col-xs-3 xs1"> <input name="txtAge" id="txtAge" type="text" class="text-box" onClick="javascript:CalculateAgeInQC();" readonly placeholder="31-Mar-2017" required></div>
 ...
 <div class="row">
  ...
  <div class="col-xs-3"> <input name="txtMotherTounge" id="txtMotherTounge" class="text-box" type="text" required></div>
 ...
 <div class="row">
  ...
  <div class="col-xs-3"> <input name="txtLastSchool" id="txtLastSchool" type="text" class="text-box" required></div>
 ...
 <div class="row">
  ...
  <div class="col-xs-3 xs1"> <textarea name="txtAddress" id="txtAddress" class="text-box-address text-box tba" rows="2" required></textarea></div>
...
<div>&nbsp;</div>
<div class="row">
  <span style="font-size:18px; text-align:center; margin-left:5%;"><strong><input type="radio" name="boardSelection" value="CBSE" class="boardSelection">CBSE</strong></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:18px; text-align:center; margin-left:5%;"><strong><input type="radio" name="boardSelection" value="NONCBSE" class="boardSelection">NON - CBSE (Percentage of each subject above 70 is only accepted)</strong></span></div>
  <div class="row" id="CBSE">
  <hr class="hr">
  <div class="row">
...
<div class="row" id="NONCBSE">
<hr class="hr">
 <div class="row">
<div class="col-xs-3 xs"> English</div>
 <div class="col-xs-3 xs1"><input name="otherEnglish" id="otherEnglish" type="text" class="text-box" required></div>
    <div class="col-xs-3 xs"> Science</div>
 <div class="col-xs-3 xs1"><input name="otherScience" id="otherScience" type="text" class="text-box" required></div>
 </div>
<div class="row">
     <div class="col-xs-3 xs"> Mathematics</div>
 <div class="col-xs-3 xs1"><input name="otherMaths" id="otherMaths" type="text" class="text-box" required></div>
    <div class="col-xs-3 xs"> Social Science</div>
 <div class="col-xs-3 xs1"><input name="otherSsc" id="otherSsc" type="text" class="text-box" required></div>
  </div>
 <div class="row">
  <div class="col-xs-3 xs"> IInd Language</div>
  <div class="col-xs-3 xs1"><input name="otherSecondLanguage" id="otherSecondLanguage" type="text" class="text-box" ></div>
</div>
</div>
 <div>&nbsp;</div>
...
<div align="center" class="h h11" style="text-transform:capitalize;"><b>SPECIAL ACHIEVEMENTS (Sports, Cultural, Public Speaking, Olympiads, Exhibition/ Model Making etc)</b></div>
 ...
 <div class="subject" id="frmMyform">
  ...
  <div class="row">
   ...
   <div class="col-xs-3"><strong><select name="cbostream" id="cbostreamFinal" class="text-box" required="true"  >
 ...
 <div id="div1">
  ...
  <div class="row"> 
   ...
   <div class="col-xs-3"><input type="text" name="cbosciiencesubject2" id="cbosciiencesubject2" class="text-box" ></div>
  ...
  <div class="row"> 
   ...
   <div class="col-xs-3"><input type="text" name="cbosciiencesubject3" id="cbosciiencesubject3" class="text-box" ></div>

   <div class="col-xs-3">Subject 4</div>

   <div class="col-xs-3"><input type="text" name="cbosciiencesubject4" id="cbosciiencesubject4" class="text-box"   ></div>
  ...
  <div class="row">
   ...
   <div class="col-xs-3"><input type="text" name="cbosciiencesubject5" id="cbosciiencesubject5" class="text-box" >
 ...
 <div id="div2">
  ...
  <div class="row"> 
   ...
   <div class="col-xs-3"><input type="text" name="cbocommercesubject2" id="cbocommercesubject2" class="text-box"  ></div>
  ...
  <div class="row"> 
   ...
   <div class="col-xs-3"><input type="text" name="cbocommercesubject3" id="cbocommercesubject3" class="text-box" ></div>

   <div class="col-xs-3">Subject 4</div>

   <div class="col-xs-3"><input type="text" name="cbocommercesubject4" id="cbocommercesubject4" class="text-box"  ></div>
  ...
  <div class="row">
   ...
   <div class="col-xs-3"><input type="text" name="cbocommercesubject5" id="cbocommercesubject5" class="text-box"  ></div>
 ...
 <div id="div3">
  ...
  <div class="row"> 
   ...
   <div class="col-xs-3"><input type="text" name="cbohuminitiessubject2" id="cbohuminitiessubject2" class="text-box" >
  ...
  <div class="row"> 
   ...
   <div class="col-xs-3"><input type="text" name="cbohuminitiessubject3" id="cbohuminitiessubject3" class="text-box"  >
      </div>

   <div class="col-xs-3">Subject 4</div>

   <div class="col-xs-3"><input type="text" name="cbohuminitiessubject4" id="cbohuminitiessubject4" class="text-box"  >
  ...
  <div class="row"> 
   ...
   <div class="col-xs-3"><input type="text" name="cbohuminitiessubject5" id="cbohuminitiessubject5" class="text-box"  >
...
<div>&nbsp;</div>
<table border="1" align="center" width="50%" class="table-responsive">
<tr>
<th style="background:#ccc; text-align:center;">SCIENCE</th>
<th style="background:#ccc; text-align:center;">COMMERCE</th>
<th style="background:#ccc; text-align:center;">HUMANITIES</th>
</tr>
<tr>
<td>
<ul>
