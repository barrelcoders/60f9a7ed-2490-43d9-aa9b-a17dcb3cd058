...
if($_POST['TxStatus']){ 
    ...
    $updateStatus=  mysql_query("UPDATE NewStudentRegistration_temp SET TxnStatus='".$TxnStatus."',TxnAmount='".$TxnAmount."',pgTxnNo='".$pgTxnNo."',TxRefNo='".$TxRefNo."',TxMsg='".$TxMsg."'  WHERE RegistrationNo='".$finalRegistrationNO."'");
...
<body>
 ...
 <div id="container">
  ...
  <div class="inner">
	...
	<div align="center"><a href="nursery_preview.php?ApplicationNo=<?php echo $finalRegistrationNO=$_POST['TxId']; ?>" target="_blank">Preview</a></div>
  </div>
