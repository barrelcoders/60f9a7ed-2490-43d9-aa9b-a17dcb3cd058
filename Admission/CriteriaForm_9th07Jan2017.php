...
<link rel="stylesheet" href="css/bootstrap.min.css" />
    <script src="js/bootstrap.min.js"></script>
		...
		<style> body{font-family:Arial, Helvetica, sans-serif!important;} .Header .img-responsive{width:40%; color:#000!important;}
		 ...
		 .btn{background:#0b462d; color:#fff; border:1px solid transparent; border-radius:5px;}
		 .btn:hover{background:#097b4d; color:#fff;}
		 #sp2{display:none;} .hr1{width:99%; border:1px solid #0b462d; margin-bottom:0px;}
		 ...
		 #sp1{display:none;} #sp2{display:block;} .sa{width:100%;} .sa1{margin-bottom:2%;}
		 } 
...
<div id="container">
 ...
 <form name="criteriaform" id="criteriaform" method="post" action="StudentRegistration_9thTest.php">
		
 
  <div>&nbsp;</div>
  <div style="background-color: #0b462d; padding:2px 0; color:#FFFFFF;">
    <h4 align="center">CRITERIA FORM - IX (Session 2017 - 18)</h4>
  </div>
 <!-- <div class="info">
 ...
 <div class="row" >
  ...
  <div class="col-xs-3"><input type="text" name="cboClass" id="cboClass" class="text-box" value="Class IX" onChange="Javascript:GetFeeDetail();" required readonly>
  </div>
...
<div>&nbsp;</div>
<div align="center" class="h h11"><b><font >Enter your grades in Class VIII Term-I Exam</font></b></div>
  <div class="row">
  ...
  <div class="col-xs-3">General Science</div>
 ...
 <div class="row">  
  <div class="col-xs-3 xs" style="font-weight: 600;"> Mathematics</div>
  ...
  <div class="col-xs-3"><select name="cbosocialscience" id="cbosocialscience" class="text-box" required="true">
   ...
   <div class="row">  
  <div class="col-xs-3">Select your IIIrd Language</div>
  <div class="col-xs-3"><select name="cboselectthirdlanguage" id="cboselectthirdlanguage" class="text-box" required="true">
  	<option value="">Select One</option>
  	<option value="Hindi">Hindi B</option>
...
<div align="center" class="h h11" style="text-transform:capitalize;"><b>SPECIAL ACHIEVEMENTS (Sports, Cultural, Public Speaking, Olympiads, Exhibition/ Model Making etc)</b></div>
 ...
 <div class="row" >
  <div class="col-xs-3" id="sp1"> Sr. No. </div>
  <div class="col-xs-3" id="sp1"> <b>Special Achievements</b> </div>
  <div class="col-xs-3" id="sp1"> Level</div>
  <div class="col-xs-3" id="sp1"><b> Position/Rank</b></div>  
  
    <div class="col-xs-3 sa"> 1.</div>
    <div class="col-xs-3" id="sp2"> <b>Special Achievements</b> </div>
    <div class="col-xs-3"><input type="text" name="SpecialAchievement1" id="SpecialAchievement1" class="text-box tba"></div>
    <div class="col-xs-3" id="sp2"> <b>Level</b></div>
    <div class="col-xs-3"> <input type="text" name="AchievementLevel1" id="AchievementLevel1" class="text-box tba"></div>
    <div class="col-xs-3" id="sp2"><b> Position/Rank</b></div>  
    <div class="col-xs-3 sa1"> <input type="text" name="AchievementRenk1" id="AchievementRenk1" class="text-box tba"></div>  
  <hr class="hr1" id="sp2">
    <div class="col-xs-3 sa"> 2.</div>
    <div class="col-xs-3" id="sp2"> <b>Special Achievements</b> </div>
    <div class="col-xs-3"><input type="text" name="SpecialAchievement2" id="SpecialAchievement2" class="text-box tba"></div>
    <div class="col-xs-3" id="sp2"> <b>Level</b></div>
    <div class="col-xs-3"> <input type="text" name="AchievementLevel2" id="AchievementLevel2" class="text-box tba"></div>
    <div class="col-xs-3" id="sp2"><b> Position/Rank</b></div>  
    <div class="col-xs-3 sa1"> <input type="text" name="AchievementRenk2" id="AchievementRenk2" class="text-box tba"></div>  
  <hr class="hr1" id="sp2">
    <div class="col-xs-3 sa"> 3.</div>
    <div class="col-xs-3" id="sp2"> <b>Special Achievements</b> </div>
    <div class="col-xs-3"><input type="text" name="SpecialAchievement3" id="SpecialAchievement3" class="text-box tba"></div>
    <div class="col-xs-3" id="sp2"> <b>Level</b></div>
    <div class="col-xs-3"> <input type="text" name="AchievementLevel3" id="AchievementLevel3" class="text-box tba"></div>
    <div class="col-xs-3" id="sp2"><b> Position/Rank</b></div>  
    <div class="col-xs-3 sa1"> <input type="text" name="AchievementRenk3" id="AchievementRenk3" class="text-box tba"></div>  
  <hr class="hr1" id="sp2">
    <div class="col-xs-3 sa"> 4.</div>
    <div class="col-xs-3" id="sp2"> <b>Special Achievements</b> </div>
    <div class="col-xs-3"><input type="text" name="SpecialAchievement4" id="SpecialAchievement4" class="text-box tba"></div>
    <div class="col-xs-3" id="sp2"> <b>Level</b></div>
    <div class="col-xs-3"> <input type="text" name="AchievementLevel4" id="AchievementLevel4" class="text-box tba"></div>
    <div class="col-xs-3" id="sp2"><b> Position/Rank</b></div>  
    <div class="col-xs-3 sa1"> <input type="text" name="AchievementRenk4" id="AchievementRenk4" class="text-box tba"></div>  
  <hr class="hr1" id="sp2">
    <div class="col-xs-3 sa"> 5.</div>
    <div class="col-xs-3" id="sp2"> <b>Special Achievements</b> </div>
    <div class="col-xs-3"><input type="text" name="SpecialAchievement5" id="SpecialAchievement5" class="text-box tba"></div>
    <div class="col-xs-3" id="sp2"> <b>Level</b></div>
    <div class="col-xs-3"> <input type="text" name="AchievementLevel5" id="AchievementLevel5" class="text-box tba"></div>
    <div class="col-xs-3" id="sp2"><b> Position/Rank</b></div>  
    <div class="col-xs-3 sa1"> <input type="text" name="AchievementRenk5" id="AchievementRenk5" class="text-box tba"></div>  
 </div>
 
  <div class="row" >
  <div class="col-xs-12" style="margin-top:1%;"><b> **To be supportedby documentary evidence if shortlisted for admission.</b></div>
  </div>
     <div class="row">
  <div class="col-xs-3">Select IInd language for class IX: </div>
  <div class="col-xs-3"> 
  	<select name="cbosecondlanguage" id="cbosecondlanguage" class="text-box">
  	<option value="">Select One</option>
  ...
  <div class="col-xs-6" id="langSelectErrorMessage" style="color:red;" ></div>
 </div>   
 <div>&nbsp;</div>
  <div class="col-xs-12" align="center" style="margin-bottom:1%;"> <input name="BtnSubmitCreteria" type="submit" id="submitBtn" value="Submit" class="btn" /></div>
 </form>
 </div>
 </body>
 </html>
 ...
 $(document).ready(function(){
     ...
     $("#submitBtn").click(function(){
         var secondLang=$("#cboselectthirdlanguage").val();
          var cbosecondlanguage=$("#cbosecondlanguage").val();
          if((secondLang == cbosecondlanguage) || cbosecondlanguage=="Hindi B" ){
              $("#langSelectErrorMessage").html("");
              return true;
          }else{
             $("#langSelectErrorMessage").html("Please select same language in your previous class or Select Hindi");
             return false;
          }
     });
