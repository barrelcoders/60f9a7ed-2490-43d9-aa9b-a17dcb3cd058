...
<div id="container">
 <div class="outer">
  <div class="inner">
   ...
   <div class="text1">
     <p>Delhi Public School, Rohini welcomes you to the Nursery / Pre-School Admission process for the academic session 2017 - 2018.<br>
   				  	  The registration and admission details are available on the school website. </p>
   </div>
   ...
   <div class="text2">
    ...
    <div class="text4">1.  Age : Minimum 3 Years as on 31 March 2017. </div>
   <div class="text5">2.   For General Category Candidates
    <ul>
     <li>Application forms will be available online between Tuesday, 10 January 2017 and Tuesday, 31 January 2017 at <a href="http://dpsrohini.com">www.dpsrohini.com.</a></li>
	 <li>The Application Form along with scanned copies of relevant documents and a non-refundable registration fee of INR 25 should be submitted online latest by Tuesday, 31 January 2017(mid-night).</li>   
     <li>Please keep the Application Number received after filling the Application Form for future reference. </li>
	 <li>Please go through the instructions and <a href="Nursery_Admissions_FAQs.pdf">FAQs (CLICK HERE)</a> carefully before filling the Application Form. </li>
    </ul>
   </div>
   ...
   <div class="text7">
    <table>
     ...
     <tr> <td>Last date of submission of application form in schools</td>	<td>Tuesday, 31 January 2017</td></tr>
     <tr> <td>Uploading details of children who applied to the school for admission under Open Seats</td> <td>Upto Friday, 10 February   2017</td></tr>
          <tr> <td>Uploading marks (as per point system) given to each of the children who applied for admission under open seats along  with distance range and sibling status</td> <td>Upto Monday, 20 February   2017</td></tr>
          <tr> <td>The date for displaying the first list of selected candidates (including Waiting List) (along with marks allotted under Point System)</td> <td>Tuesday, 28 February 2017</td></tr>
     <tr> <td>Resolution of queries of parents, if any, (by written/ email/ verbal interaction) regarding allotment of points to their ward in the first list</td> <td>01 March 2017 - 04 March 2017</td></tr>
     <tr> <td>The date for displaying the second list of selected candidates, if any, (including Waiting List) (along with marks allotted under Point System)</td> <td>Wednesday, 15 March 2017	</td></tr>
  ...
  <div class="text8">
   ...
   <table>
    <tr> <td><strong>Distance & Sibling Criteria</strong></td> <td><strong>Points</strong></td> </tr>
  ...
  <div class="text10">
   ...
   <ul>
	...
	<li>List of short listed candidates will be put up online.</li>
    <li>Kindly visit the school website regularly for any updates.</li>
   </ul>
  </div>
  <div class="text11">
   ...
   <ol>
    ...
    <li> Do not press <strong>ENTER KEY</strong> to move from one field to another. Use <strong>`TAB KEY`</strong> or mouse control for the same. </li>
    ...
    <li> Documents required (Scanned copy) :
     <ul>
      ...
      <li>Medical Document/Certificate (if belongs to Special Needs)</li>
	  <li>Residence Proof - (any one) - Ration Card issued in the name of parents (Mother/Father having name of the child), Domicile Certificate of child or of his/her parents, Voter Identity Card (EPIC) of any of the parents, Electricity Bill/ MTNL telephone bill/ Water bill/ Passport in the name of any of the parents or child, Aadhar Card / Unique Identity Card issued in the name of the parents. </li>
	  <li>Proof of Sibling(s) (Copy of last paid fee slip / ID Card of Sibling [2016-17])</li>
     </ul>
    </li>
    <li>Only <strong>JPEG</strong> format can be uploaded for scanned copy of photograph.</li>
   <li> After completing the Application Form, click on the `I Agree` button for online submission of non-refundable registration fee. 
       <u>The application shall be considered only after successful payment of non-refundable registration fee.</u></li>
    <li> Immediately an application number will be generated and an acknowledgement e-mail and sms will reach your Email Id and Mobile number mentioned by you in the Application Form.</li>
    <li> In case of any discrepancy of any form, kindly write an E-mail to <strong>nursery@dpsrohini.com</strong>. Mails regarding 
    ...
    <li> Please keep your credit card, debit card and other banking details handy while filling the application form. The payment on this website is secure and school does not store any banking related information. </li>
    <li> Please ensure that you have a stable internet connection while filling the application form.</li>
    <li> In case of a query, you can write an E-mail to <strong>nursery@dpsrohini.com</strong>.  Queries at any other E-mail ID will not be accepted.</li>
  ...
  <div class="text12">
   ...
   <font><b>Step 3:</b> Click on <strong>‘I Agree’</strong> button for Online payment of Application Fee.</font><br>
     <div style="margin:0 0 0 5%;"><font><b>[Note:   Kindly ensure that you enter correct email id and contact number during payment procedure so as to save payment details for future reference.]</b></font></div>
   <font><b>Step 4:</b> Generation of ‘Application Number’ after successful payment .</font><br>
