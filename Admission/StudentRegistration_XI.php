...
if(isset($_POST['BtnSubmitCreteria']))
{
	...
	$SecondLanguageGrade=$_POST['cbosecondlanguage'];
	...
	$SpecialAchievement1=$_POST['SpecialAchievement1'];
        ...
        $SelectStream=$_POST['cbostream'];
        
        $ScienceSubject1=$_POST['cbosciiencesubject1'];
	$ScienceSubject2=$_POST['cbosciiencesubject2'];
        $ScienceSubject3=$_POST['cbosciiencesubject3'];
        $ScienceSubject4=$_POST['cbosciiencesubject4'];
        $ScienceSubject5=$_POST['cbosciiencesubject5'];
        
        $CommerceSubject1=$_POST['cbocommercesubject1'];
        $CommerceSubject2=$_POST['cbocommercesubject2'];
        $CommerceSubject3=$_POST['cbocommercesubject3'];
        $CommerceSubject4=$_POST['cbocommercesubject4'];
        $CommerceSubject5=$_POST['cbocommercesubject5'];

        $HumanitiesSubject1=$_POST['cbohuminitiessubject1'];
        $HumanitiesSubject2=$_POST['cbohuminitiessubject2'];
        $HumanitiesSubject3=$_POST['cbohuminitiessubject3'];
        $HumanitiesSubject4=$_POST['cbohuminitiessubject4'];
        $HumanitiesSubject5=$_POST['cbohuminitiessubject5'];
        
         $otherEnglish=$_POST['otherEnglish'];
        $otherScience=$_POST['otherScience'];
        $otherMaths=$_POST['otherMaths'];
        $otherSsc=$_POST['otherSsc'];
        $otherSecondLanguage=$_POST['otherSecondLanguage'];
        $board_type=$_POST['boardSelection'];
        
        
        if($_POST['cbostream']=="Science"){
          $CommerceSubject1="";
        $CommerceSubject2="";
        $CommerceSubject3="";
        $CommerceSubject4="";
...
$result=mysql_query("INSERT INTO `CriteriaFormXIth`(`FirstName`,`MiddleName`,`LastName`,`PlaceofBirth`,`DOB`,`Age`,`Gender`,`MotherTongue`,`Nationality`,`Class`,`LastSchool`,`PermanentAddress`,`PermanentPhone`,`ResidentialAddress`,`ResidentialPhone`,`EnglishGrade`,`MathGrade`,`GeneralScienceGrade`,`SocialScienceGrade`,`SecondLanguageGrade`,`SpecialAchievement1`,`AchievementLevel1`,`AchievementRenk1`,`SpecialAchievement2`,`AchievementLevel2`,`AchievementRenk2`,`SpecialAchievement3`,`AchievementLevel3`,`AchievementRenk3`,`SpecialAchievement4`,`AchievementLevel4`,`AchievementRenk4`,`SpecialAchievement5`,`AchievementLevel5`,`AchievementRenk5`,`SelectStream`,`ScienceSubject1`,`ScienceSubject2`,`ScienceSubject3`,`ScienceSubject4`,`ScienceSubject5`,`CommerceSubject1`,`CommerceSubject2`,`CommerceSubject3`,`CommerceSubject4`,`CommerceSubject5`,`HumanitiesSubject1`,`HumanitiesSubject2`,`HumanitiesSubject3`,`HumanitiesSubject4`"
        . ",`HumanitiesSubject5`,`otherEnglish`,`otherScience`,`otherMaths`,`otherSsc`,`otherSecondLanguage`,`board_type`) VALUES ('$FirstName','$MiddleName','$LastName','$PlaceofBirth','$DOB','$Age','$Gender','$MotherTongue','$Nationality','$Class','$LastSchool','$PermanentAddress','$PermanentPhone','$ResidentialAddress','$ResidentialPhone','$EnglishGrade','$MathGrade','$GeneralScienceGrade','$SocialScienceGrade','$SecondLanguageGrade','$SpecialAchievement1','$AchievementLevel1','$AchievementRenk1','$SpecialAchievement2','$AchievementLevel2','$AchievementRenk2','$SpecialAchievement3','$AchievementLevel3','$AchievementRenk3','$SpecialAchievement4','$AchievementLevel4','$AchievementRenk4','$SpecialAchievement5','$AchievementLevel5','$AchievementRenk5','$SelectStream','$ScienceSubject1','$ScienceSubject2','$ScienceSubject3','$ScienceSubject4','$ScienceSubject5','$CommerceSubject1','$CommerceSubject2','$CommerceSubject3','$CommerceSubject4','$CommerceSubject5','$HumanitiesSubject1','$HumanitiesSubject2','$HumanitiesSubject3','$HumanitiesSubject4'"
        . ",'$HumanitiesSubject5','$otherEnglish','$otherScience','$otherMaths','$otherSsc','$otherSecondLanguage','$board_type')");

   
    
    
$lastInsertedIdSQLReg=mysql_query("SELECT srno FROM CriteriaFormXIth ORDER BY srno DESC  LIMIT 1");
    
    $lastInsertIdCreteriaNo= mysql_fetch_assoc($lastInsertedIdSQLReg);
    $_SESSION['finalCreteriaNO']=$lastInsertIdCreteriaNo['srno'];
...
<div id="container">
 ...
 <form name="frmNewStudent" id="frmNewStudent" method="post" action="class_XI_payment.php" enctype="multipart/form-data">
  ...
  <div style="background-color: #0b462d; padding:2px 0; color:#FFFFFF;">
    <h4 align="center">APPLICATION FORM - XI (Session 2017 - 2018)</h4>
  </div>
  <div class="info">
  ...
  <div align="center" class="h h11"><b><font >APPLICANT DETAILS</font></b></div>
  <div>&nbsp;</div>
  <div class="row">
 ...
 <div class="row">
  ...
  <div class="col-xs-3"> <input type="text" name="txtSex" id="txtSex" class="text-box" required value="<?php echo $Gender; ?> " readonly> </div>
 ...
 <div class="row">
  ...
  <div class="col-xs-3 xs1"> <textarea name="txtAddress" id="txtAddress" class="text-box-address text-box tba" rows="2" required readonly /><?php echo $ResidentialAddress; ?></textarea></div>
  <div class="col-xs-3">Residential Landline Number:</div>
  <div class="col-xs-3"><input type="number" name="residentialno" id="residentialno" class="text-box tba" value="<?php echo $ResidentialPhone; ?>" readonly></div>
 </div>
 <div class="row">
 <div class="col-xs-3 xs"> Permanent Address: </div>
  <div class="col-xs-3 xs1"> <textarea name="txtpermanentAddress" id="txtpermanentAddress" class="text-box-address text-box tba" rows="2" readonly/><?php echo $PermanentAddress; ?></textarea></div>
  <div class="col-xs-3">Permanent Landline Number:</div>
  <div class="col-xs-3"><input type="number" name="permanentno" id="permanentno" class="text-box tba" value="<?php echo $PermanentPhone; ?>" readonly></div>  
 </div>
 <div class="row">
 ...
 <div class="row">
  ...
  <div class="col-xs-3">
	...
	<div class="col-xs-3"><input type="text" class="text-box" name="FProfessionalQualification" id="FProfessionalQualification"></div>
	</div>
	<div class="row">
 ...
 <div class="row">
  <div class="col-xs-3 xs"> Email Id *:</div>
  <div class="col-xs-3 xs1"> <input name="txtFatherEmailId" id="txtFatherEmailId" class="text-box" type="email" required></div>
 ...
 <div class="row">
  <div class="col-xs-3">Highest Academic Qualification*:<!--<br><font class="f">(Select Highest Qualification)</font>--> </div>
  <div class="col-xs-3">
 <select size="1" name="txtMotherEducation" id="txtMotherEducation" class="text-box tbs" required="true">
  ...
  <div class="col-xs-3">Highest Professional Qualification: </div>
  <div class="col-xs-3"><input type="text" class="text-box" name="MProfessionalQualification" id="MProfessionalQualification"></div>
 </div>
 <div class="row">
  <div class="col-xs-3">Occupation</div>
 ...
 <div class="row">
  <div class="col-xs-3">Highest Academic Qualification:</div>
  <div class="col-xs-3">
	<select size="1" name="txtGuradinaEducation" id="txtGuradinaEducation" class="text-box tbs">
		<option selected="selected" value="">Select Highest Qualification</option>
		<?php
                $rsEducationGur=mysql_query("select distinct `Qualification` from `NewStudentRegistrationQualificationMaster` order by `Qualification`");
			while($rowEdugur = mysql_fetch_row($rsEducationGur))
			{
				$Qualification1=$rowEdugur[0];
		?>
		<option value="<?php echo $Qualification1;?>"><?php echo $Qualification1;?></option>
		<?php
			}
  ...
  <div class="col-xs-3"> <input name="GProfessionalQualification" id="GProfessionalQualification" type="text" class="text-box" ></div>
   </div>
 <div class="row">
 <div class="col-xs-3">Occupation:</div>
 ...
 <div class="row">
  ...
  <div class="col-xs-3 xs1"> <textarea name="txtGuradianAddress" id="txtMotherAddress0" class="text-box-address text-box" rows="2"></textarea> </div>
   </div>
 <div class="row">
 ...
 <div class="row">
  ...
  <div class="col-xs-3"> <input name="txtDPSSchoolName" id="txtDPSSchoolName" class="text-box" type="text" readonly></div>
 </div>
 <div class="row">
 ...
 <div class="row">
  ...
  <div class="col-xs-3">
   <select size="1" name="cbocatagory" id="cbocatagory" class="text-box tbs"  onchange="Javascript:fnlChkCatagory();" required>
		<option value="">Select One</option>
 ...
 <div>&nbsp;</div>
 <div class="row">
  <div class="col-xs-6 xss"><b> 1. Photograph of Applicant* :</b></div>
  <div class="col-xs-6 xss1"> <input type="file" name="F1" accept="image/gif, image/jpeg, image/png, image/tiff, image/bmp,image/tif,image/gif" required> </div>
 </div>
 <div class="row">
  <div class="col-xs-6 xss"><b> 2. Photograph of Father* :</b></div>
 ...
 <div class="row">
  <div class="col-xs-6 xss"><b> 3. Photograph of Mother* :</b></div>
 ...
 <div class="row">
  <div class="col-xs-6 xss"><b> 4. Photograph of Guardian (if applicable) :</b></div>
 ...
 <div class="row">
  <div class="col-xs-6 xss"><b> 5. Proof of Applicant's Aadhar card* :</b></div>
  <div class="col-xs-6 xss1"> <input type="file" name="F5" accept="image/gif, image/jpeg, image/png, image/tiff, image/bmp,image/tif,image/gif" required> </div>
 </div>
  <div class="row">
 ...
 <div class="row">
  <div class="col-xs-6 xss"><b> 8. Photocopy of registration card of class IX* :</b></div>
  <div class="col-xs-6 xss1"> <input type="file" name="F8" accept="image/gif, image/jpeg, image/png, image/tiff, image/bmp,image/tif,image/gif" required> </div>
 </div> 
 <div class="row">
  <div class="col-xs-6 xss"><b> 9. Photocopy of report card of class VIII* :</b></div>
  <div class="col-xs-6 xss1"> <input type="file" name="F9" accept="image/gif, image/jpeg, image/png, image/tiff, image/bmp,image/tif,image/gif" required> </div>
 </div>
 <div class="row">
  <div class="col-xs-6 xss"><b> 10. Photocopy of report card of class IX (Final-Term)* :</b></div>
  <div class="col-xs-6 xss1"> <input type="file" name="F10" accept="image/gif, image/jpeg, image/png, image/tiff, image/bmp,image/tif,image/gif" required> </div>
 </div>
 <div class="row">
  <div class="col-xs-6 xss"><b> 11. Photocopy of report card of class X (Term-I) :</b></div>
  <div class="col-xs-6 xss1"> <input type="file" name="F11" accept="image/gif, image/jpeg, image/png, image/tiff, image/bmp,image/tif,image/gif"> </div>
 </div>
  <div class="row">
  <div class="col-xs-6 xss"><b> 12. Fitness certificate from MBBS Doctor :</b></div>
  <div class="col-xs-6 xss1"> <input type="file" name="F12" accept="image/gif, image/jpeg, image/png, image/tiff, image/bmp,image/tif,image/gif"> </div>
 </div>
 <div class="row">
 ...
 <div>&nbsp;</div>
 <div class="row">
  <div class="col-xs-12" style="padding:0 1.5%;"><strong>Undertaking:</strong>
    <p><b>1.</b> I understand that the registration fee of <span style="font-weight: 400">INR 25</span>/- 
		( as applicable ) is towards the processing fee for the Class XI admission process. It is 
