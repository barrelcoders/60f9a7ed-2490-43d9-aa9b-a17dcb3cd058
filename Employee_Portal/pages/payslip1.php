...
<!--top-->
   <div align="center" >
	...
	<div align="center">MATHURA ROAD ,SECTOR-19 , FARIDABAD ,<br> FARIDABAD (HARYANA) - 121002</div>
    <div style="font-size:18px; font-weight:700; margin:0.8% 0; padding:0.2%; border:2px solid #0b462d; border-left:none; border-right:none;">Pay Slip for the month of September 2016</div>
   </div>
<!---Name--->
   <div style="width:100%">
    <table style="width:100%;">
     <tr>
      <td style="width:27%; padding:0 1%;"><strong>Employee Id</strong></td><td style="width:2%"><strong>:</strong></td> 
      <td style="width:21%">A425</td>
      <td style="width:27%; padding:0 1%;"><strong>Name</strong></td><td style="width:2%"><strong>:</strong></td>
      <td style="width:21%">Mohit Aggrawal</td>     
     </tr>
     <tr>
      <td style="width:27%; padding:0 1%;"><strong>Department</strong></td><td style="width:2%"><strong>:</strong></td> 
      <td style="width:21%">IT</td>
      <td style="width:27%; padding:0 1%;"><strong>Designation</strong></td><td style="width:2%"><strong>:</strong></td> 
      <td style="width:21%"></td> 
     </tr>
     <tr>
      <td style="width:27%; padding:0 1%;"><strong>Date Of Joining</strong></td><td style="width:2%"><strong>:</strong></td> 
      <td style="width:21%">05/05/2016</td>
      <td style="width:27%; padding:0 1%;"><strong>PF Account No.</strong></td><td style="width:2%"><strong>:</strong></td> 
      <td style="width:21%"></td> 
     </tr>
     <tr>
      <td style="width:27%; padding:0 1%;"><strong>Days Payable</strong></td><td style="width:2%"><strong>:</strong></td> 
      <td style="width:21%">20</td>
      <td style="width:27%; padding:0 1%;"><strong>ESI Account No.</strong></td><td style="width:2%"><strong>:</strong></td> 
      <td style="width:21%"></td> 
     </tr>
     <tr>
      <td style="width:27%; padding:0 1%;"><strong>Bank A/C No.</strong></td><td style="width:2%"><strong>:</strong></td> 
      <td style="width:21%">00125420</td>
      <td style="width:27%; padding:0 1%;"><strong>PAN No.</strong></td><td style="width:2%"><strong>:</strong></td> 
      <td style="width:21%">AD4988S51</td> 
     </tr>
     <tr>
      <td style="width:27%; padding:0 1%;"><strong>UAN NO.</strong></td><td style="width:2%"><strong>:</strong></td> 
      <td style="width:21%">N/A</td>
      <td style="width:27%; padding:0 1%;"><strong>Location</strong></td><td style="width:2%"><strong>:</strong></td> 
...
<!---Signature-->   
   <div>
    <table style="width:100%; padding:6% 0 2% 0;">
    <tr>
     <td style="padding-left:1%">
      <hr style="border:1px solid #0b462d; width:250px; float:left"><br>
		<b>Employer's Signature</b>
     </td>	
     <td style="padding-Right:1%; text-align:right;">
      <hr style="border:1px solid #0b462d; width:250px; float:right"><br>
 ...
 <!---End outer---->
 <div align="center"><a href="#" onclick="myFunction()">Print</a></div>
</div>
<!----end printer--->
<script>
function myFunction() {
