...
.hr{border:1px solid #eaeaea; padding:0; width:100%;}
.fixed-header{position:fixed; width:100%; top:0; background:#fff!important; z-index:100; padding:1% 0 2% 1%; }
.fixed-header .img-responsive{width:80%;}
.fixed-header .col-md-8{padding-top:3%; color:#0b462d;}
.form{padding:0 8%; width:100%; margin-top:10%;}
.form .table1, .form .table2{width:100%;} .form .table1 table, .form .table2 table{width:100%;}
.text-box{border:1px solid rgba(11,70,45,0.4); border-radius:3px; width:80%; padding:1% 1%; font-size:13px!important; height:30px;}
input:focus, button:focus, textarea:focus{box-shadow:none; outline:none;}
.col-xs-3, .col-xs-6{margin:0.5% 0;} .col-xs-2, .col-xs-7, .col-xs-5{margin:1% 0; font-size:13px; text-align:justify;}
table td{padding:0.5% 1%;} b{color:#060;}
.head{color:#060; font-size:15px; font-weight:600;} .head1{color:#090; font-size:14px; font-weight:600;}
.table2 table td{width:25%; text-align:justify; font-size:13px; padding:0.5% 1.2%;} 
.table2 table td .text-box{font-size:14px!important; padding:2% 2%; height:30px; width:100%;}
.table1 table td{text-align:justify; font-size:13px; padding:1% 1.5%;} .table1 table td:first-child{width:10%;} 
.table1 table td .text-box{font-size:14px!important; padding:2% 2%; height:30px; width:100%;} .table1 table td:nth-child(3n+3){width:25%;} 
.col-xs-5 .tb23{padding:2%; height:30px; font-size:14px;} .col-xs-6 .tbta{height:35px; min-width:80%; padding:2%;}
.table3 table td:first-child{width:8%;}  .col-xs-5 .text-box{height:30px;}
.table3 table td{width:33%; padding:1% 1%; font-size:13px;}.table3 table td .text-box{width:80%; padding:2%; height:30px;}
.table4 table{width:100%;} .table4 table td{font-size:13px; padding:0.7% 0.5%;} .table4 table .col td{  background:#6aec6a; } 
.table4 table td .text-box{width:100%; padding:2%; height:30px;} .table4 table tr{border-bottom:1px solid #ccc;}
.btns{text-align:center;} .tba3{height:30px;}
.btns .submit-btn{border:1px solid #4cae4c; background:#5cb85c; color:#fff; padding:0.5% 1.5%; border-radius:3px;} 
.btns .submit-btn:hover{background:#690;} .btns .clear-btn:hover{background:#690;}
.btns .clear-btn{border:1px solid #eea236; background:#f0ad4e; color:#fff; padding:0.5% 1.5%; border-radius:3px;} 
.last p{font-size:13px; line-height:3;} .last p b{margin-right:1.5%;}
#scroll {position:fixed; right:10px; bottom:10px; cursor:pointer; width:50px; height:50px; background-color:#0b462d; text-indent:-9999px; display:none;    -webkit-border-radius:60px;  -moz-border-radius:60px;  border-radius:60px }
#scroll span{position:absolute; top:50%; left:50%; margin-left:-8px; margin-top:-12px; height:0; width:0; border:8px solid transparent;    border-bottom-color:#ffffff }
#scroll:hover {  background-color:#5cb85c;  opacity:1;filter:"alpha(opacity=100)";  -ms-filter:"alpha(opacity=100)"; }
input[type=radio]{margin-right:3%; zoom: 1.3;} input[type=checkbox] {zoom: 1.5;}  
</style>
<body>
<div id="container">
<!---header--->
 <div class="row fixed-header">
  ...
  <div class="col-md-8"><font size="+3">Investment Declaration Form</font></div>
 </div>
<!--End Header--->
<!----form---->
 <div class="form">
