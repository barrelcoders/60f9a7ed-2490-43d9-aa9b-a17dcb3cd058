...
<div id="container">
 ...
 <form name="criteriaform" id="criteriaform" method="post" action="StudentRegistration_XIth.php">
		
 
  <div>&nbsp;</div>
  <div style="background-color: #0b462d; padding:2px 0; color:#FFFFFF;">
    <h4 align="center">CRITERIA FORM (Session 2017 - 18)</h4>
  </div>
 <!-- <div class="info">
 ...
 <div class="row">
  ...
  <div class="col-xs-3"> <input type="text" name="cboClass" id="cboClass" class="text-box" value="Class_IX" required="true" readonly> </div>
 ...
 <div class="row">
  ...
  <div class="col-xs-3 xs1"> <textarea name="txtpermanentAddress" id="txtpermanentAddress" class="text-box-address text-box tba" rows="2" required></textarea></div>
...
<div align="center" class="h h11"><b><font >Select Stream and Subject to apply for</font></b></div>
 ...
 <div id="div1" style="display:none">
  <div class="row"> 
   <div class="col-xs-3">Select Subject 1</div>
   <div class="col-xs-3"><input type="text" name="cbosciiencesubject1" id="cbosciiencesubject1" class="text-box" value="English" required="true" readonly></div>
   <div class="col-xs-3">Select Subject 2</div>
   <div class="col-xs-3"><select name="cbosciiencesubject2" id="cbosciiencesubject2" class="text-box" required="true" disabled>
  	<option value="">Select One</option>
  	<option value="Physics" selected>Physics</option>
  	</select></div>
  </div>
  <div class="row"> 
   <div class="col-xs-3">Select Subject 3</div>
   <div class="col-xs-3"><select name="cbosciiencesubject3" id="cbosciiencesubject3" class="text-box" required="true">
  	<option value="">Select One</option>
    <option value="Chemistry" selected>Chemistry</option>
  	</select></div>
   <div class="col-xs-3">Select Subject 4</div>
   <div class="col-xs-3"><select name="cbosciiencesubject4" id="cbosciiencesubject4" class="text-box" required="true">
  	<option value="">Select One</option>
  ...
  <div class="row">
   <div class="col-xs-3">Select Subject 5</div>
   <div class="col-xs-3"><select name="cbosciiencesubject5" id="cbosciiencesubject5" class="text-box" required="true">
  	<option value="">Select One</option>
    <option value="Computer Science" >Computer Science</option>
    <option value="Physical Education" >Physical Education</option>
    <option value="Bio" >Eco</option>
    <option value="Math" >Math</option>
  	</select></div>
   <div class="col-xs-3">Additional Subject</div>
   <div class="col-xs-3"><select name="cbosciiencesubject6" id="cbosciiencesubject6" class="text-box" required="true">
  	<option value="">Select One</option>
    </select></div>
  </div>
 </div>
 <div id="div2" style="display:none;">
  <div class="row"> 
   <div class="col-xs-3">Select Subject 1</div>
   <div class="col-xs-3"><input type="text" name="cbocommercesubject1" id="cbocommercesubject1" class="text-box" required="true">
  	<option value="">Select One</option>
  	<option value="English" selected>English</option>
  	</select></div>
   <div class="col-xs-3">Select Subject 2</div>
   <div class="col-xs-3"><select name="cbocommercesubject2" id="cbocommercesubject2" class="text-box" required="true">
  	<option value="">Select One</option>
  ...
  <div class="row"> 
   <div class="col-xs-3">Select Subject 3</div>
   <div class="col-xs-3"><select name="cbocommercesubject3" id="cbocommercesubject3" class="text-box" required="true">
  	<option value="">Select One</option>
    <option value="B.St" selected>B.St</option>
  	</select></div>
   <div class="col-xs-3">Select Subject 4</div>
   <div class="col-xs-3"><select name="cbocommercesubject4" id="cbocommercesubject4" class="text-box" required="true">
  	<option value="">Select One</option>
  ...
  <div class="row">
   <div class="col-xs-3">Select Subject 5</div>
   <div class="col-xs-3"><select name="cbocommercesubject5" id="cbocommercesubject5" class="text-box" required="true">
  	<option value="">Select One</option>
    <option value="Eco" selected>Eco</option>
  	</select></div>
   <div class="col-xs-3">Additional Subject</div>
   <div class="col-xs-3"><select name="cbocommercesubject6" id="cbocommercesubject6" class="text-box" required="true">
  	<option value="">Select One</option>
    </select></div>
  </div>
 </div>
 <div id="div3" style="display:none;">
  <div class="row"> 
   <div class="col-xs-3">Select Subject 1</div>
   <div class="col-xs-3"><select name="cbohuminitiessubject1" id="cbohuminitiessubject1" class="text-box" required="true">
  	<option value="">Select One</option>
  	<option value="English" selected>English</option>
  	</select></div>
   <div class="col-xs-6">&nbsp;</div>
...
<div align="center" class="h h11"><b><font >Enter your grades in Class X Term-I Exam</font></b></div>
 ...
 <div class="row">
  <div class="col-xs-3 xs"> Hindi </div>
  <div class="col-xs-3 xs1"><select name="cbohindi" id="cbohindi" class="text-box" required="true">
  	<option value="">Select One</option>
  	<option value="A1">A1</option>
  	<option value="A2">A2</option>
  	<option value="B1">B1</option>
  ...
  <div class="col-xs-3"><select name="cbothirdlanguage" id="cbothirdlanguage" class="text-box" required="true">
  	<option value="">Select One</option>
  	<option value="A1">A1</option>
  	<option value="A2">A2</option>
  	<option value="B1">B1</option>
 ...
 <div class="row">
  <div class="col-xs-3 xs"> Enter Grade Point</div>
  <div class="col-xs-3 xs1"><input type="text" name="cbogradepoint" id="cbogradepoint" class="text-box" required="true"></div>
  <div class="col-xs-3">Select your IInd Language</div>
