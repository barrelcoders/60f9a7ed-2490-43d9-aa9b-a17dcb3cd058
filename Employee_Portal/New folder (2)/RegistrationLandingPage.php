...
<link rel="stylesheet" href="css/bootstrap.min.css" />
 ...
 .top div{margin:0.5% 0; font-size:15px; font-weight:600;}
 ...
 .last{text-align:center; font-size:15px; font-weight:600; margin:1% 0 3% 0;}
  @media only screen and (min-width:580px) and (max-width: 720px){.manu .col-xs-4 .btnmanu{height:auto;}}
  @media only screen and (min-width:200px) and (max-width: 580px){.manu .col-xs-4{width:100%;}.manu .col-xs-4 .btnmanu{height:auto;} .head{font-size:18px;}}
 </style>
</head>
<body>
<div id="container">
 ...
 <div class="manu">
  <div class="row">
   <div class="col-xs-4" ><a href="#"><button class="btnmanu">CLASS : NURSERY (OPEN) - Click Here To Proceed</button></a></div>
   <div class="col-xs-4"><a href="#"><button class="btnmanu">CLASS : IXth (OPEN) - Click Here To Proceed</button></a></div>
   <div class="col-xs-4"><a href="#"><button class="btnmanu">CLASS : XIth (OPEN) - Click Here To Proceed</button></a></div>
  </div>
 </div>
 <div class="document">
