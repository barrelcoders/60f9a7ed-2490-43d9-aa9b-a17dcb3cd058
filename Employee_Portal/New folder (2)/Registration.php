...
<div id="container">
 <div class="top">
  <div align="center"><img src="../Admin/images/logo.png" class="img-responsive" ></div>
 ...
 <div class="manu">
  <div class="row">
   ...
   <div class="col-xs-4"><a href="CriteriaForm_9th.php"><button class="btnmanu">CLASS : IXth (OPEN) - Click Here To Proceed</button></a></div>
   <div class="col-xs-4"><a href="CriteriaForm_XIth.php"><button class="btnmanu">CLASS : XIth (OPEN) - Click Here To Proceed</button></a></div>
  </div>
 </div>
 <div class="document">
...
</html> <div><?php include 'footer.php'; ?></div>