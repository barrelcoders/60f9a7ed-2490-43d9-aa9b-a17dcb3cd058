...
<link rel="stylesheet" href="bootstrap/bootstrap.min.css" />
    <script src="bootstrap/bootstrap.min.js"></script>
		...
		<style> body{font-family:Arial, Helvetica, sans-serif!important;} .Header .img-responsive{width:40%}
...
#popup {width: 300px; height:200px; background: #FFFFFF; border: 5px solid #000; border-radius: 25px; -moz-border-radius: 25px; -webkit-border-radius: 25px; box-shadow: #64686e 0px 0px 3px 3px; -moz-box-shadow: #64686e 0px 0px 3px 3px; -webkit-box-shadow: #64686e 0px 0px 3px 3px; position: relative; 
...
#ac-wrapper { position: fixed; top: 0; left: 0%; width: 100%; height: 100%; background: rgba(255, 255, 255, .6); z-index: 1001;}
#popup {width: 300px; height: 300px; background: #FFFFFF; border: 5px solid #000; border-radius: 25px; -moz-border-radius: 25px; -webkit-border-radius: 25px; box-shadow: #64686e 0px 0px 3px 3px; -moz-box-shadow: #64686e 0px 0px 3px 3px; -webkit-box-shadow: #64686e 0px 0px 3px 3px; position: relative; 
top:150px; left: 30px;}
		 } 
...
#ac-wrapper { position: fixed; top: 0; left: 0%; width: 100%; height: 100%; background: rgba(255, 255, 255, .6); z-index: 1001;}
#popup {width: 350px; height: 300px; background: #FFFFFF; border: 5px solid #000; border-radius: 25px; -moz-border-radius: 25px; -webkit-border-radius: 25px; box-shadow: #64686e 0px 0px 3px 3px; -moz-box-shadow: #64686e 0px 0px 3px 3px; -webkit-box-shadow: #64686e 0px 0px 3px 3px; position: relative; 
top:150px; left: 10px;}
...
<div id="ac-wrapper" style='display:none'>
  <div id="popup">
    <center>
      <h2></h2>
	  <div class="row">
       <div><img src="<?php echo $SchoolLogo; ?>" class="img-responsive"></div>
       <div ><strong>Enter Your Admission No.*:</strong></div> <div>&nbsp;</div>
       <div ><input type="text" name="adnissionno" id="adnissionno" class="text-box" style="width:50%;"></div>
      </div>
      <div style="margin-top:5%"><input type="submit" name="submit" value="Submit" onClick="PopUp('hide')" /></div>
    </center>
  </div>
</div>
<div>
...
<div id="container">
 ...
 <form name="frmNewStudent" id="frmNewStudent" method="post" action="Admin/StudentManagement/RegistrationFeePaymentCounter.php" enctype="multipart/form-data">
  ...
  <div style="background-color: #0b462d; padding:2px 0; color:#FFFFFF;">
    <h4 align="center">INFORMATION UPDATE FORM</h4>
  </div>
  <div class="info">
  	<h4><B>Parents are requested to note :</B> </h4>
	<p><font size="+2">&raquo;</font>  This form is designed for all classes for updating the latest information to school.</p>
	<p><font size="+2">&raquo;</font>  Original / Photocopied documents can be used for uploading. </p>
    <p><font size="+2">&raquo;</font>  In case there is any change in the name of the student, father or mother, kindly send an application to the school.</p> 
    <p><font size="+2">&raquo;</font>  Kindly fill the form <strong>carefully</strong> as the form once submitted cannot be opened again for editing. </p>
  </div>
  <div align="center" class="h h11"><b><font >Student Detail</font></b></div>
  <div>&nbsp;</div>
  <div align="center"><img src="" width="100px" height="100px" class="img-responsive" > </div>
 <div class="row" >
  <div class="col-xs-3"> Admission No.*: </div>
  <div class="col-xs-3"> <input name="txtName" id="txtName" type="text" class="text-box"> </div>
  <div class="col-xs-3 xs"> Date Of Admission*:</div>
  <div class="col-xs-3 xs1"> <input name="doa" id="doa" type="date" class="text-box tba" ></div>  
 </div>
 <div class="row" >
  <div class="col-xs-3"> Name of Student*: </div>
  <div class="col-xs-3"> <input name="txtName" id="txtName" type="text" class="text-box"> </div>
  <div class="col-xs-3 xs"> House:</div>
  <div class="col-xs-3 xs1"> 
  		<select name="house" class="text-box tbs" id="house" >
 ...
 <div class="row">
  ...
  <div class="col-xs-3 xs1"> <input name="txtAge" id="txtAge" type="text" class="text-box" onClick="javascript:CalculateAgeInQC();" readonly placeholder="30-Sept-2017"></div>
 </div>
 <div class="row">
 ...
 <div class="row">
  <div class="col-xs-3"> Class Currently Studying in*:</div>
  <div class="col-xs-3"> 
  ...
  <div class="col-xs-3"> 
    <select name="bloodgroup" id="bloodgroup" class="text-box tbs" onChange="Javascript:GetFeeDetail();" size="1">
		<option selected="" value="Select One">Select One</option>
 ...
 <div class="row">
  ...
  <div class="col-xs-3"> 
  	<select name="category" id="category" class="text-box tbs" onChange="Javascript:GetFeeDetail();" size="1">
		<option selected="" value="Select One">Select One</option>
  ...
  <div class="col-xs-3"> Staff Child: </div>
  <div class="col-xs-3"> 
    <select name="staffchild" id="staffchild" class="text-box tbs" onChange="Javascript:GetFeeDetail();" size="1">
		<option selected="" value="Select One">Select One</option>
 ...
 <div class="row">
  <div class="col-xs-3"> Stream (for XI/XII):</div>
  <div class="col-xs-3"> 
  	<select name="stream" id="stream" class="text-box tbs" onChange="Javascript:GetFeeDetail();" size="1">
		<option selected="" value="Select One">Select One</option>
		<option value="Sciencemath">Science (math)</option>
		<option value="Sciencebio">Science (Bio)</option>
     	<option value="Art">Art</option>
        <option value="Commerce">Commerce</option>
	</select>
  </div>

  <div class="col-xs-3"> Single Child: </div>
  <div class="col-xs-3"> 
    <select name="singlechild" id="singlechild" class="text-box tbs" onChange="Javascript:GetFeeDetail();" size="1">
		<option selected="" value="">Select One</option>
		<option value="Yes">Yes</option>
		<option value="No">No</option>
	</select>
 ...
 <div class="row">
  <div class="col-xs-3"> Caste / Community:</div>
  <div class="col-xs-3"> 
  	<select name="caste" id="caste" class="text-box tbs" onChange="Javascript:GetFeeDetail();" size="1">
		<option selected="" value="">Select One</option>
  ...
  <div class="col-xs-3"> Aadhar Card Number*: </div>
  <div class="col-xs-3"> 
    <input type="text" name="aadharcardno" id="aadharcardno" class="text-box tbs" value="" >
  </div>
 </div>
 <div class="row">
  <div class="col-xs-3 xs"> Residential Address*:<br><font class="f">(As On Date)</font> </div>
  <div class="col-xs-3 xs1"> <textarea name="txtAddress" id="txtAddress" class="text-box-address text-box tba" rows="2" ></textarea></div>
  <div class="col-xs-3"> Registered Mobile No.*: </div>
  <div class="col-xs-3"> <input type="number" name="registeredmobileno" id="registeredmobileno" class="text-box" > </div>
 </div>
 <div> &nbsp;</div>
 ...
 <div class="row">
  ...
  <div class="col-xs-3 xs"> Highest Qualification*: </div>
  <div class="col-xs-3 xs1"> 
    <select name="cboDuration" id="cboDuration" class="text-box tbs">
 ...
 <div class="row">
  <div class="col-xs-3"> Aadhar Card No.*:</div>
  <div class="col-xs-3"> <input type="text" name="fatheraadharcard" id="fatheraadharcard" class="text-box" ></div>
 ...
 <div class="row">
  ...
  <div class="col-xs-3"> <input name="txtFatherMobileNo" id="txtFatherMobileNo" class="text-box" type="number" min="0"></div>
  <div class="col-xs-3"> Residence Landline no: </div>
  <div class="col-xs-3"> <input name="txtFatherOfficialPhNo" id="txtFatherOfficialPhNo" class="text-box" type="number" min="0"></div>
 </div>
 <div class="row">
  <div class="col-xs-3"> Office Address: </div>
 ...
 <div class="row">
  ...
  <div class="col-xs-3 xs"> Highest Qualification*: </div>
  <div class="col-xs-3 xs1"> 
  	<select name="cboMotherQualificationDuration" id="cboMotherQualificationDuration" class="text-box tbs">
		<option selected="selected" value="">Select One</option>
		<option value="Certificate">Certificate</option>
		<option value="Diploma">Diploma</option>
        <option value="Degree">Degree</option>
 ...
 <div class="row">
  <div class="col-xs-3">Aadhar Card No.:</div>
  <div class="col-xs-3"><input type="text" name="motheraadharcard" id="motheraadharcard" class="text-box"></div>
 ...
 <div class="row">
  <div class="col-xs-3"> Mobile No.:</div>
  <div class="col-xs-3"> <input name="txtMotherMobileNo" id="txtFatherOfficialPhNo1" class="text-box" type="number" ></div>
  <div class="col-xs-3"> Residence Landline. No:</div>
  <div class="col-xs-3"> <input name="txtMotherOfficialPhNo" id="txtMotherOfficialPhNo" class="text-box" type="number"></div>
 </div>
 <div class="row">
  ...
  <div class="col-xs-3"> Email id*:</div>
  <div class="col-xs-3"> <input name="txtMotherEmailId" id="txtFatherOfficialPhNo2" class="text-box" type="text" ></div>
 </div>
 ...
 <div class="row">
  ...
  <div class="col-xs-3 xs"> Relation With Student:</div>
  <div class="col-xs-3 xs1"> <input name="relationwirhstudent" id="relationwirhstudent" class="text-box" type="text" ></div>
 </div>
 <div class="row">
  <div class="col-xs-3"> Organization Name:<br><font class="f">(If employed)</font></div>
  <div class="col-xs-3"> <input name="txtGuradianCompanyName" id="txtMotherCompanyName0" type="text" class="text-box" ></div>
  <div class="col-xs-3 xs"> Residence Landline. No: </div>
  <div class="col-xs-3 xs1"> <input name="txtGuradianOfficialPhNo" id="txtMotherOfficialPhNo0" class="text-box" type="number" ></div>
 </div>
 <div class="row">
  ...
  <div class="col-xs-3"> Mobile No.:</div>
  <div class="col-xs-3"> <input name="txtGuradianMobileNo" id="txtFatherOfficialPhNo4" class="text-box" type="number" ></div>
 </div>
  <div>&nbsp;</div>
 <div align="center"><strong><u>School</u></strong></div>
 <div>&nbsp;</div>
 
 <div class="row">
  <div class="col-xs-3"> Mode Of Transport:</div>
  <div class="col-xs-3"> 
    	<select name="modeoftranspost" id="modeoftranspost" class="text-box tbs">
           <option value="">Select One</option>
           <option value="Schoolbus">School Bus</option>
           <option value="personalvehicle">Personal Vehicle</option>
           <option value="other">Other Vehicle</option>
        </select>
  </div>
  <div class="col-xs-3"> Route No.:<br><font class="f"> (If School Bus)</font></div>
  <div class="col-xs-3"> 
    	<select name="routeno" id="routeno" class="text-box tbs">
           <option value="">Select One</option>
           <option value=""></option>
        </select>
  </div>
 ...
 <div class="row">
  <div class="col-xs-3"> Bus Stop:</div>
  <div class="col-xs-3">
   		<select name="busstop" id="busstop" class="text-box tbs">
        	<option value="">Select One</option>
            <option value=""></option>
        </select>
  </div>
 ...
 <div class="h" align="center"><strong>CATEGORY</strong>*
		...
		If you do not fall into any category, please select Others.)</i>
 </div>
 <div>&nbsp;</div>
 <div class="check check1" >
  <table>
   ...
   <tr> <td><input name="chkEWSCategory" id="chkEWSCategory" type="checkbox" value="1" onClick="javascript:fnlChkCategory('chkEWSCategory');"></td>
   		<td><strong>EWS/DG</strong></td> </tr>
  </table>
  <table>
   ...
   <tr> <td><input name="chkDPSStaff" id="chkDPSStaff" type="checkbox" value="1" onClick="javascript:fnlChkCategory('chkDPSStaff');"></td>
   		<td class="col1"><strong>DPS Staff</strong></td> </tr>
  </table>
  <table> 
   <tr> <td><input name="chkMotherAlumni" id="chkMotherAlumni" type="checkbox" value="1" onClick="javascript:fnlChkCategory('chkMotherAlumni');"></td>
    ...
    <tr> <td><input name="chkotherDPSStaff" id="chkotherDPSStaff" type="checkbox" value="1" onClick="javascript:fnlChkCategory('chkotherDPSStaff');"></td>
   		<td class="col1"><strong>Other DPS Staff Wards Category</strong></td> </tr>
  </table>
  <table>
   ...
   <tr><td><input name="chkOtherCategory" id="chkOtherCategory" type="checkbox" value="1" onClick="javascript:fnlChkCategory('chkOtherCategory');"></td>
        <td class="col1"><strong>Others </strong></td> </tr>
  </table>
  <table>
   <tr> <td><input name="chkcwsn" id="chkcwsn" type="checkbox" value="1" onClick="javascript:fnlChkCategory('chkcwsn');"></td>
   		<td class="col1"><strong>CWSN</strong></td> </tr>
  </table> 
 </div> 
 ...
 <div class="study">
 <div align="center">
        <strong>Details of Sibling(s) studying in , 
		 <p>(If there is more than one sibling, mention any one)</p></strong>
 </div>
 <div>&nbsp;</div>
 <div class="row">
  ...
  <div class="col-xs-3"> <input name="txtRealBroSisClass" id="txtRealBroSisClass" class="text-box" type="text" readonly></div>
 ...
 <div class="row">
  ...
  <div class="col-xs-3"> Brother / Sister's Class:</div>
  <div class="col-xs-3"> <input name="txtRealBroSisClass2" id="txtRealBroSisClass2" class="text-box" type="text" readonly></div>
  <div class="col-xs-3"> Brother / Sister's Admission No:</div>
 ...
 <div class="row">
  <div class="col-xs-3"> Brother / Sister's Name: </div>
  <div class="col-xs-3"> <input name="txtRealBroSisName3" id="txtRealBroSisName3" class="text-box" type="text" readonly> </div>
  <div class="col-xs-3"> Brother / Sister's Class:</div>
  <div class="col-xs-3"> <input name="txtRealBroSisClass3" id="txtRealBroSisClass3" class="text-box" type="text" readonly></div>
  <div class="col-xs-3"> Brother / Sister's Admission No:</div>
  <div class="col-xs-3"> <input name="txtRealBroSisSchoolName3" id="txtRealBroSisSchoolName3" class="text-box" type="text" readonly></div>
  <div class="col-xs-6"> &nbsp;</div>
 </div>
 </div>
 <hr class="hr">
 <div align="center"><strong><u>DPS Staff Details</u></strong></div>
 <div>&nbsp;</div>
 <div class="row">
  <div class="col-xs-3"> Name Of Staff:</div>
  <div class="col-xs-3"><input type="text" name="nameofstaff" id="nameofstaff" class="text-box" readonly></div>
  <div class="col-xs-3"> Relation:</div>
  <div class="col-xs-3"><input type="text" name="staffstudentrelation" id="staffstudentrelation" class="text-box" readonly ></div>
 </div>
 <div class="row">
  <div class="col-xs-3"> Designation:</div>
  <div class="col-xs-3"><input type="text" name="staffdesignation" id="staffdesignation" class="text-box" readonly></div>
  <div class="col-xs-3"> Name Of Work Place:</div>
  <div class="col-xs-3"><input type="text" name="staffworkplace" id="staffworkplace" class="text-box" readonly></div>
 </div>
 <div class="row">
  <div class="col-xs-3">Status:</div>
  <div class="col-xs-3">
  		<select name="staffstatus" id="staffstatus" class="text-box tbs" readonly>
        	<option value="">Select One</option>
            <option value=""></option>
        </select>
  </div>
 ...
 <div>&nbsp;</div>
 <div class="h h11" align="center"><strong>Emergency Contact Details</strong> </div>
 <div>&nbsp;</div>
 <div class="row">
  <div class="col-xs-3"> Name*:</div>
 ...
 <div>&nbsp;</div>
 <div class="h h11" align="center"><strong> Documents to be Uploaded</strong></div>
 <div>&nbsp;</div>
 <div class="row">
  <div class="col-xs-6 xss"> 1. Copy of Birth Certificate issued by Municipal Corporation* :</div>
 ...
 <div class="row">
  <div class="col-xs-6 xss"> 2. Photograph of Student* :</div>
 ...
 <div class="row">
  <div class="col-xs-6 xss"> 3. Photograph of Father* :</div>
 ...
 <div class="row">
  <div class="col-xs-6 xss"> 4. Photograph of Mother* :</div>
 ...
 <div class="row">
  <div class="col-xs-6 xss"> 5. Copy of latest Income Certificate (EWS)* :</div>
  <div class="col-xs-6 xss1"> <input type="file" name="F5" ></div>
 </div>
 <div class="row">
  <div class="col-xs-6 xss"> 6. Copy Of DG Category* :</div>
 ...
 <div class="row">
  <div class="col-xs-6 xss"> 7. Copy Of Coste Category* :</div>
 ...
 <div class="row">
  <div class="col-xs-12" style="padding:0 4%;"><strong>Declaration:</strong>
    <p><b>1.</b>I hereby declare that all the information given above by me is correct / true.</p>
	<p><b>2.</b> I understand that rendering false / incorrect / misleading 
		information may invoke disciplinary action against my ward as per school rules and regulations.</p>
  </div>
 </div>
 ...
 <div class="col-xs-12" align="center"> <input name="BtnSubmit" type="button" value="I Agree &amp; Submit" onClick="Validate();" ></div>
</div>
<div>&nbsp;</div>
