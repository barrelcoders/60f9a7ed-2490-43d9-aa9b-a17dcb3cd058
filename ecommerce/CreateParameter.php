...
if(isset($_POST['submit']))
{
  ...
  $SubCategoryParameter=$_POST['txtParameter'];
   ...
   mysql_query("INSERT INTO Commerce_Parameter(`Category`,`SubCategory`,`SubCategory_one`,`Parameter`)VALUES('$Category','$SubCategory','$SubCategoryone','$SubCategoryParameter')");
}
$rsCat=mysql_query("select `srno`,`Category`,`SubCategory`,`SubCategory_one`,`Parameter`,`Status` from `Commerce_Parameter`");
					...
					<div class="box-content">
						<form class="form-horizontal"  method=post>
						  ...
						  <div class="control-group">
                            ...
                            <div class="control-group">
							  <label class="control-label" for="typeahead">SubCategory</label>
							  <div class="controls">
							 ...
							 <div class="control-group">
							  <label class="control-label" for="typeahead">SubCategory-1</label>
							  <div class="controls">
							...
							<div class="control-group">
							  <label class="control-label" for="typeahead">Add 
								Parameter</label>
							  <div class="controls">
								<input  class="span6 typeahead" id="typeahead" name="txtParameter"  >
						...
						<table class="table table-bordered table-striped table-condensed">
							  ...
							  ?>
								<tr>
                                    ...
                                    <td class="center"><?php echo $SubCategoryone;?></td>
                                    <td class="center"><?php echo $Parameter;?></td>

									<td class="center">
										<span class="<?php echo $StyleClass;?>"><?php echo $Status;?></span>
									</td>                                       
								</tr>
								<?php
								}
