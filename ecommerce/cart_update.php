...
if($_POST["type"]=='add' && $_POST["product_qty"]>0)
{
    ...
    $statement = $mysqli->prepare("SELECT ProductName as product_name, UnitPrice as price FROM Commerce_Product WHERE ProductId=? LIMIT 1");
