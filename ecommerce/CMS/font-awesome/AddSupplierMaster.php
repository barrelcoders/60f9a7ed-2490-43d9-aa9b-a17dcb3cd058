						...
						<form class="form-horizontal">
							<fieldset>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <span class="input-xlarge uneditable-input"><input class="input-xlarge disabled" id="disabledInput" type="text" placeholder="Supplier PAN No." disabled="">Supplier Name...</span>
								</div>
							  </div>
							  <div class="control-group">
								<label class="control-label" for="disabledInput">Supplier PAN No.</label>
								<div class="controls">
								  <input class="input-xlarge disabled" id="disabledInput" type="text" placeholder="Supplier PAN No." disabled="">
								</div>
							  </div>
							  <div class="control-group">
