...
if(isset($_POST['submit']))
{
  ...
  $SubCategory=$_POST['txtSubCategory'];
   mysql_query("INSERT INTO Commerce_SubCategory(`Category`,`SubCategory`)VALUES('$Category','$SubCategory')");
}
$rsCat=mysql_query("select `srno`,`Category`,`SubCategory`,`Status` from `Commerce_SubCategory`");
					...
					<div class="box-content">
						<form class="form-horizontal"  method=post>
						  <fieldset>
							  ...
							  <label for="typeahead">Sub</label><label class="control-label" for="typeahead"> Category</label>
							  <div class="controls">
								<input  class="span6 typeahead" id="typeahead" name="txtSubCategory"  >
