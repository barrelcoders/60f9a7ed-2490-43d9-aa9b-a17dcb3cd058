...
<body>
		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				...
				<div class="widget blue span5" onTablet="span6" onDesktop="span5">
					...
					<h2><span class="glyphicons globe"><i></i></span> 
					Demographics</h2>
				...
				<div class="widget span3 red" onTablet="span6" onDesktop="span3">
					...
					<h2><span class="glyphicons pie_chart"><i></i></span> 
					Browsers</h2>
			...
			<div class="row-fluid">
				...
				<div class="box black span4" onTablet="span6" onDesktop="span4">
					<div class="box-header">
						<h2><i class="halflings-icon white list"></i><span class="break"></span>
						Weekly Stat</h2>
						<div class="box-icon">
				...
				<div class="box black span4" onTablet="span6" onDesktop="span4">
					<div class="box-header">
						<h2><i class="halflings-icon white user"></i><span class="break"></span>
						Last Users</h2>
						<div class="box-icon">
							<a href="#" class="btn-minimize"><i class="halflings-icon white chevron-up"></i></a>
							<a href="#" class="btn-close"><i class="halflings-icon white remove"></i></a>
				...
				<div class="box black span4 noMargin" onTablet="span12" onDesktop="span4">
					<div class="box-header">
						<h2><i class="halflings-icon white check"></i><span class="break"></span>
						To Do List</h2>
						<div class="box-icon">
	...
	<footer>
		...
		<p>
			<span style="text-align:left;float:left">© 2013 <a href="http://jiji262.github.io/Bootstrap_Metro_Dashboard/" alt="Bootstrap_Metro_Dashboard">
