...
if(isset($_POST['submit']))
{
   ...
   //echo "INSERT INTO Commerce_Category(`Category`)VALUES('$Category')";
   //exit();
   mysql_query("INSERT INTO Commerce_Category(`Category`)VALUES('$Category')");
}
$rsCat=mysql_query("select `srno`,`Category`,`Status` from `Commerce_Category`");
?>
<!DOCTYPE html>
<html lang="en">
<head>
						...
						<form class="form-horizontal"  method="post">
						  <fieldset>
							<div class="control-group">
							  ...
							  <div class="controls">
								<input  class="span6 typeahead" id="txtCategory" name="txtCategory"  >
