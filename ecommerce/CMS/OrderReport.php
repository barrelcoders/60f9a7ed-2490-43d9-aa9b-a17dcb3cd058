...
?>
<?php
	$ssql="SELECT `srno`, `OrderNo`, `InvoiceNo`, `CustId`, `Cust_Name`, `Cust_Address`, `Cust_Mobile`, `Cust_Email`, `Cust_Phone`, `DateOfPurchase`, `BillAmount`, `VAT`, `ServiceTax`, `ShippingCharges`, `FinalAmount`, `OrderStatus`, `DateOfDelivery`, `TxnId`, `TxnStatus`, `PGTxnId`, `PGTxnStatus`, `PaymentMode`, `ShippingAddress`, `BillingAddress`, `SystemDateandTime` FROM `Commerce_OrderFinal` where 1=1";
$rs= mysql_query($ssql);
?>
<!DOCTYPE html>
<html lang="en">
                          	...
                          	while($row = mysql_fetch_row($rs))
                          		{
		                             ...
		                             $Cust_Address=$row[5];
		                             $Cust_Mobile=$row[6];
		                             $DateOfPurchase=$row[9];
		                             $BillAmount=$row[10];
		                             $VAT=$row[11];
		                             $FinalAmount=$row[14];
		                             $OrderStatus=$row[15];
		                             $PaymentMode=$row[21];
		                             $DateOfDelivery=$row[16];
		                             $ShippingAddress=$row[22];
		                             
		                     ?>

							<tr>
								<td><?php echo $recno;?></td>
								<td class="center"><?php echo $OrderNo;?></td>
								<td class="center"><?php echo $InvoiceNo;?></td>
								<td class="center"><span class="label label-success"><?php echo $CustId;?></span></td>
								<td class="center"><?php echo $Cust_Name;?></td>

								
								<td class="center"><?php echo $Cust_Address;?></td>
								<td class="center"><?php echo $Cust_Mobile;?></td>
								<td class="center"><?php echo $DateOfPurchase;?></td>
								<td class="center"><?php echo $BillAmount;?></td>
								<td class="center"><?php echo $VAT;?></td>
								<td class="center"><?php echo $FinalAmount;?></td>
								<td class="center"><?php echo $OrderStatus;?></td>
								<td class="center"><?php echo $PaymentMode;?></td>
								<td class="center"><?php echo $DateOfDelivery;?></td>
								<td class="center"><?php echo $ShippingAddress;?></td>
								<td class="center">
