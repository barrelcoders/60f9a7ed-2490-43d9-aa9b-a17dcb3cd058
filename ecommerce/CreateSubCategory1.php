...
if(isset($_POST['submit']))
{
  ...
  $SubCategoryone=$_POST['txtSubCategoryone'];
   ...
   mysql_query("INSERT INTO Commerce_SubCategory_One(`Category`,`SubCategory`,`SubCategory_one`)VALUES('$Category','$SubCategory','$SubCategoryone')");
}
$rsCat=mysql_query("select `srno`,`Category`,`SubCategory`,`SubCategory_one`,`Status` from `Commerce_SubCategory_One`");
					...
					<div class="box-content">
						<form class="form-horizontal"  method=post>
						  ...
						  <div class="control-group">
							...
							<div class="control-group">
							  <label class="control-label" for="typeahead">Add Sub Category One</label>
							  <div class="controls">
								<input  class="span6 typeahead" id="typeahead" name="txtSubCategoryone"  >
