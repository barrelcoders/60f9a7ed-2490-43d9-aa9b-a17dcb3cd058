...
<form name="frmRpt" method="post" action="EmployeeAlumni.php">
...
<td style="width: 278px" class="style1"><font face="Cambria"><input name="Submit1" type="submit" value="Submit" style="font-weight: 700"  class="text-box"></font></td>
</tr>
</form>
</table>
<?php
...
<td style="width: 103px" font="Cambria">
	<input type="button" value="Move To Alumni " name="B3<?php echo $EmpId;?>" id="B3<?php echo $EmpId;?>" onclick="fnlMoveToAlumni('<?php echo $EmpId;?>');" style="font-weight: 700">
</td>
</tr>
<?php
	}
