...
if(isset($_POST['submit']))
{
   ...
   $Deputation=$_POST['txtDeputation'];
   ...
   $DateOfEntry=$_POST['txtDateOfEntry'];
	...
	mysql_query("INSERT INTO `EmployeeSB_Deputation`(`EmpID`, `EmpName`, `EmpDepartment`, `EmpDesignation`, `DeputationJob`, `FromDate`, `ToDate`, `NameOfOrganization`, `DateOfEntry`) VALUES('$EmpNo','$EmpName','$EmpType','$Designation','$Deputation','$PeriodFrom','$PeriodTo','$Organization','$DateOfEntry')");
...
<table width="100%">
  <tr>
    <td align="center">
	<p align="left"><b><font face="Cambria">Employee Services Book Deputation 
...
<table id="Table1" style="border-style:solid; border-width:1px; border-collapse:collapse" style="border-style: solid; border-width: 1px" width="100%" cellpadding="0">
			...
			<b><font face="Cambria">Deputation Job</font></b></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="167"><b><font face="Cambria">Period From</font></b></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="167">
...
<b>
			...
			<font face="Cambria">
			Period To</td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="167"><b>
...
<b>
			...
			<font face="Cambria">
			<input name="txtDeputation" id="txtDeputation"   style="float: center"/class="text-box"></font></td>
		  </td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="167">
...
<b>
			...
			<font face="Cambria">
			<input name="txtOrganization" id="txtOrganization"  style="float: center" class="text-box"/></font></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="197"><font face="Cambria">
			<p><b>
			<input name="txtDateOfEntry" id="txtDateOfEntry" type="date" style="float: center" class="text-box"/></td>
...
<?php
$result=mysql_query("select * from EmployeeSB_Deputation ");
