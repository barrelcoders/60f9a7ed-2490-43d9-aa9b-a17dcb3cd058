...
<table cellspacing="0" cellpadding="0" style="width: 100%;" class="style2">
	...
	<tr>
		...
		<input type="text" name="txtComonentValue<?php echo $rowcount;?>" id="txtComonentValue<?php echo $rowcount;?>" value="<?php echo $ComponentValue;?>">
		<?php
		}
		?>
	...
	<tr>
		<td align="center" colspan="6" style="width: 1072px" class="style3">
		<?php
