...
if(isset($_POST['submit']))
{
   ...
   $DateOfEntry=$_POST['DateOfEntry'];
	...
	mysql_query("INSERT INTO `EmployeeSB_LTC`(`EmpID`, `EmpName`, `EmpDepartment`, `EmpDesignation`, `FromDate`, `ToDate`, `Days`, `TypeofLTC`, `BlockofYears`, `Amount`, `ActualClaim`,  `Remarks`, `DateofEntry`) VALUES('$EmpNo','$EmpName','$EmpType','$Designation','$FromDate','$ToDate','$Days','$LTCType','$Period','$Amount','$AClaim','$Remarks','$DateOfEntry')");
}	
...
<table width="100%">
  <tr>
    <td align="center">
	<p align="left"><b><font face="Cambria">Employee L.T.C. Record</font><font size="3" face="Cambria"></p>
	<hr>
...
<table id="Table1" style="border-style:solid; border-width:1px; border-collapse:collapse" style="border-style: solid; border-width: 1px" width="1197" cellpadding="0">
			<p align="left">&nbsp;<tr>
		  <td align="center" style="border-style: solid; border-width: 1px"><b>
			<font face="Cambria">From</font></b></td>
		  <td align="center" style="border-style: solid; border-width: 1px"><b>
			<font face="Cambria">To</font></b></td>
		  <td align="center" style="border-style: solid; border-width: 1px"><b>
			<font face="Cambria">Days</font></b></td>
		  <td align="center" style="border-style: solid; border-width: 1px"><b>
			<font face="Cambria">Type of L.T.C.</font></b></td>
		  <td align="center" style="border-style: solid; border-width: 1px"><b>
			<font face="Cambria">Block of years</font></b></td>
		  <td align="center" style="border-style: solid; border-width: 1px"><b>
			<font face="Cambria">Amount</font></b></td>
		  <td align="center" style="border-style: solid; border-width: 1px"><b>
			<font face="Cambria">Actual Claim</font></b></td>
		  <td align="center" style="border-style: solid; border-width: 1px"><b>
			<font face="Cambria">Remarks</font></b></td>
		  <td align="center" style="border-style: solid; border-width: 1px"><b>
			<font face="Cambria">Date of Entry</font></b></td>
		  
 </tr>
 
			<td align="center" style="border-style: solid; border-width: 1px" width="132">
			<b>

			<font face="Cambria">
			<input name="FromDate" id="FromDate" type="date"  style="float: center"/class="text-box"></font></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="132">
			<b>

			<font face="Cambria">
			<input name="ToDate" id="ToDate" type="date"  style="float: center"/class="text-box"></font></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="133">
			<b>

			<font face="Cambria">
			<input name="Days" id="Days"   style="float: center"/class="text-box"></font></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="133">
			<b>

			<font face="Cambria">
			<input name="LTC" id="LTC"   style="float: center"/class="text-box"></font></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="133">
			<b>

			<font face="Cambria">
			<input name="Years" id="Years"   style="float: center"/class="text-box"></font></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="133">
			<b>

			<font face="Cambria">
			<input name="Amount" id="Amount"   style="float: center"/class="text-box"></font></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="133">
			<b>

			<font face="Cambria">
			<input name="AClaim" id="AClaim"   style="float: center"/class="text-box"></font></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="133">
			<b>

			<font face="Cambria">
			<input name="Remarks" id="Remarks"   style="float: center"/class="text-box"></font></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="133">
			<b>
...
<?php
$result=mysql_query("select * from EmployeeSB_LTC ");
