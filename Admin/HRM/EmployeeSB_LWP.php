...
if(isset($_POST['submit']))
{
   ...
   $ToDate=$_POST['ToDate'];
   $Days=$_POST['Days'];
   $TotalDaysLOP=$_POST['LOP'];
   $Remarks=$_POST['Remarks'];
   $DateOfEntry=$_POST['DateOfEntry'];

       
	mysql_query("INSERT INTO `EmployeeSB_LWP`(`EmpID`, `EmpName`, `EmpDepartment`, `EmpDesignation`, `FromDate`, `ToDate`, `Days`, `DaysofLossPay`, `Remarks`, `DateofEntry`) VALUES('$EmpNo','$EmpName','$EmpType','$Designation','$FromDate','$ToDate','$Days','$TotalDaysLOP','$Remarks','$DateOfEntry')");
}	
...
<table width="100%">
  <tr>
    <td align="center">
	<p align="left"><b><font face="Cambria">Employee L.W.P Record</font><font size="3" face="Cambria"></p>
	<hr>
...
<table id="Table1" style="border-style:solid; border-width:1px; border-collapse:collapse" style="border-style: solid; border-width: 1px" width="1197" cellpadding="0">
		  ...
		  <td align="center" style="border-style: solid; border-width: 1px"><b>
			<font face="Cambria">Total Days of Loss of Pay</font></b></td>
		  <td align="center" style="border-style: solid; border-width: 1px"><b>
		  ...
		  <td align="center" style="border-style: solid; border-width: 1px"><b>
			...
			<td align="center" style="border-style: solid; border-width: 1px" width="199">
			<b>
		  ...
		  <td align="center" style="border-style: solid; border-width: 1px" width="199">
			...
			<font face="Cambria">
			<input name="LOP" id="LOP"   style="float: center"/class="text-box"></font></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="199">
			<b>

			<font face="Cambria">
			<input name="Remarks" id="Remarks"   style="float: center"/class="text-box"></font></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="200">
			<b>
...
<?php
$result=mysql_query("select * from EmployeeSB_LWP ");
