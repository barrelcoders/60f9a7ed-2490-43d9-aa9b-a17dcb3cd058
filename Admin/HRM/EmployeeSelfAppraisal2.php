...
<font face="Cambria"><br>
		...
		&nbsp;<a href='ViewEmployeeACRHODTeaching.php?txtEmpId=<?php echo $EmpId;?>' target='_blank'><strong><input name="BtnSubmit" size="500" type=button value="Proceed to View HOD Assessment "  style="font-weight: 700"></strong></a></font></div>
