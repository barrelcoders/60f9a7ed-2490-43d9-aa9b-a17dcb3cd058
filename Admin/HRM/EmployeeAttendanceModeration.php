...
//                
	...
	if(SelectedMonthValue!='')
	{
	 $rs=mysql_query("select `EmpId`,(select `Name` from `employee_master` where `EmpId`=a.`EmpId`) as `EmpName`, `PunchDate`, `Month`, `Year`, `InTime`, `OutTime`,`Remarks`,`LOPValue`,`ReportingTime` from `Employee_Punching_Detail` as `a`"
                 . " WHERE PunchDate >= '$DateTo' AND PunchDate <= '$DateFrom'");
	}
...
<input type ="hidden" name ="isSubmit" id="isSubmit" value ="yes">
	<tr>
		<td width="332"><font face="Cambria"><b>Select Date To</b></font></td>
		<td width="332">
   	<font face="Cambria"> <input type="date" name="DateFrom" id="DateFrom" size="20" > </font> </td>
		<td width="83"><b><font face="Cambria">Select Date from</font></b></td>
		<td width="83">
   	<font face="Cambria"> <input type="date" name="DateTo" id="DateTo" size="20" ></font></td>
		<td width="83">&nbsp;</td>
		<td width="83"><font face="Cambria"><b>Select Department </b></font></td>
		<td width="332"> 	<font face="Cambria">
	    <select name="cboDepartment" id="cboDepartment" style="float: left" >
		<option selected="" value="">Select One</option>
			...
			<td width="332"><font face="Cambria"><b>&nbsp; </b></font></td>
			<td width="664">
			<p align="center"><b><font face="Cambria"><a href="SetReportingTime.php" target=_blank> Change Reporting Time</a></font></b></td>
...
<table border="1" width="100%" style="border-collapse: collapse" class="CSSTableGenerator">
	...
	<tr>
		...
		<td align="center" style="text-align: center"><b><font face="Cambria">Leave Applied</font></b></td>
		<td align="center" style="text-align: center"><b><font face="Cambria">Existing Remarks</font></b></td>
				<td align="center" style="text-align: center"><b><font face="Cambria">Existing LOP </font></b></td>
		
		<td align="center" style="text-align: center"><b><font face="Cambria">LOP</font></b></td>
		<td align="center" style="text-align: center"><b><font face="Cambria">
		Remarks</font></b></td>
		<td align="center" style="text-align: center"><b><font face="Cambria">
		Submit</font></b></td>
	...
	<tr>
		...
		<td><font face="Cambria"><?php echo $LeaveType;?></font></td>
		<td><font face="Cambria"><?php echo $ExistingRemark;?></font></td>
			<td><font face="Cambria"><?php echo $ExistingLOPValue;?></font></td>


		<td>
		<select size="1" name="cboLOPStatus<?php echo $srno;?>" id="cboLOPStatus<?php echo $srno;?>">
		...
		<input type="text" name="txtRemarks<?php echo $srno;?>" id="txtRemarks<?php echo $srno;?>" size="17"><?php //echo $srno;?></font></td>
		<td><font face="Cambria">
		<p align="center"><input type="button" value="Submit" name="btnSubmit<?php echo $srno;?>" id="btnSubmit<?php echo $srno;?>" onclick ="Javascript:fnlUpdate('<?php echo $srno;?>','<?php echo $EmpId;?>','<?php echo $Month;?>','<?php echo $PunchDate;?>');"><?php //echo $srno;?></font></td>
	</tr>
	<?php 
	}
	?>
...
<div class="footer" align="center">
    <div class="footer_contents" align="center">
		<font color="#FFFFFF" face="Cambria" size="3">Powered by Eduworld Technologies LLP</font></div>
</div>
</body>
