...
if(isset($_POST['submit']))
{
   ...
   $DateOfEntry=$_POST['txtDateOfEntry'];
	...
	mysql_query("INSERT INTO `EmployeeSB_FamilyDetails`(`EmpID`, `EmpName`, `EmpDepartment`, `EmpDesignation`, `FamilyMemberName`, `Gender`, `Age`, `Remarks`, `DateofEntry`) VALUES('$EmpNo','$EmpName','$EmpType','$Designation','$FMName','$Gender','$Age','$Remarks','$DateOfEntry')");  
}
...
<table width="100%">
  <tr>
    <td align="center">
	<p align="left"><b><font face="Cambria">Employee Family Details</font><font size="3" face="Cambria"></p>
	<hr>
...
<table id="Table1" style="border-style:solid; border-width:1px; border-collapse:collapse" style="border-style: solid; border-width: 1px" width="1194" cellpadding="0">
			<p align="left">&nbsp;<tr>
				<td align="center" style="border-style: solid; border-width: 1px" width="238">
			<b><font face="Cambria">Name Of Family Member</font></b></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="238">
			<b><font face="Cambria">Gender</font></b></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="238">

<b><font face="Cambria">Age Of Family Member</font></b></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="239">
...
<b>
			...
			<font face="Cambria">
			<input name="FMName" id="FMName"   style="float: center"/class="text-box"></font></td>
		  </td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="238">
...
<b>
			...
			<font face="Cambria">
			<input name="Gender" id="Gender"  style="float: center" class="text-box"/></font></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="238">
			<p>
...
<b>
		  ...
		  <td align="center" style="border-style: solid; border-width: 1px" width="239"><b><font face="Cambria">
...
<?php
$result=mysql_query("select * from EmployeeSB_FamilyDetails");
