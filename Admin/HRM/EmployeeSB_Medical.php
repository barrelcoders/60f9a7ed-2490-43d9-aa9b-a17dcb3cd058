...
if(isset($_POST['submit']))
{
   ...
   $DateOfEntry=$_POST['DateOfEntry'];
	...
	mysql_query("INSERT INTO `EmployeeSB_MedicalLeave`(`EmpID`, `EmpName`, `EmpDepartment`, `EmpDesignation`, `FromDate`, `ToDate`, `Days`, `TypeofAppointment`, `LengthofService`, `Remarks`, `DateofEntry`) VALUES('$EmpNo','$EmpName','$EmpType','$Designation','$FromDate','$ToDate','$Days','$Appointment','$Los','$Remarks','$DateOfEntry')");
}	
...
<table width="100%">
  <tr>
    <td align="center">
	<p align="left"><b><font face="Cambria">Employee Services Book Medical Leave History</font><font size="3" face="Cambria"></p>
	<hr>
...
<table id="Table1" style="border-style:solid; border-width:1px; border-collapse:collapse" style="border-style: solid; border-width: 1px" width="100%" cellpadding="0">
		  ...
		  <td align="center" style="border-style: solid; border-width: 1px"><b>
			<font face="Cambria">Type of Appointment held</font></b></td>
		  <td align="center" style="border-style: solid; border-width: 1px"><b>
			<font face="Cambria">Length of Service (years)</font></b></td>
		  <td align="center" style="border-style: solid; border-width: 1px"><b>
		  ...
		  <td align="center" style="border-style: solid; border-width: 1px"><b>
			...
			<td align="center" style="border-style: solid; border-width: 1px" width="155">
			<b>
		  ...
		  <td align="center" style="border-style: solid; border-width: 1px" width="155">
			...
			<font face="Cambria">
			<input name="Appointment" id="Appointment"   style="float: center"/class="text-box"></font></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="77">
			<b>

			<font face="Cambria">
			<input name="LOS" id="LOS"   style="float: center"/class="text-box"></font></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="77">
			<b>

			<font face="Cambria">
			<input name="Remarks" id="Remarks"   style="float: center"/class="text-box"></font></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="154">
			<b>
...
<table border=1  cellspacing="0" cellpadding="0"  class="CSSTableGenerator">
   <tr>
		...
		<td height="22" align="center" bgcolor="#95C23D" width=100><b>Service 
		Tenure</b></td>
		<td height="22" align="center" bgcolor="#95C23D" width=100><b>Service 
		Remarks</b></td>
...
<?php
$result=mysql_query("select * from EmployeeSB_MedicalLeave ");
