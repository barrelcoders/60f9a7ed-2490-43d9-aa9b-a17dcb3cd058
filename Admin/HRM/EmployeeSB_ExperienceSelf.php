...
if(isset($_POST['submit']))
{
   ...
   $PeriodFrom=$_POST['txtPeriodFrom'];
   $PeriodTo=$_POST['txtPeriodTo'];
   $ClassTaught=$_POST['txtClassTaught'];
   $SubjectTaught=$_POST['txtSubjectTaught'];
   $DateOfEntry=$_POST['txtDateOfEntry'];
   $Remarks=$_POST['txtRemarks'];  
    
	mysql_query("INSERT INTO `EmployeeSB_Experiecnce`(`EmpID`, `EmpName`, `EmpDepartment`, `EmpDesignation`, `NameOfInstitution`, `PeriodFrom`, `PeriodTo`, `ClassTaught`, `SubjectsTaught`, `DateOfEntry`, `Remarks`) VALUES ('$EmpNo','$EmpName','$EmpType','$Designation','$Institution','$PeriodFrom','$PeriodTo','$ClassTaught','$SubjectTaught','$DateOfEntry','$Remarks')");
...
<table width="100%">
  <tr>
    <td align="center">
	<p align="left"><b><font face="Cambria">Employee Services Book Experiecnce 
...
<table id="Table1" style="border-style:solid; border-width:1px; border-collapse:collapse" style="border-style: solid; border-width: 1px" width="100%" cellpadding="0">
			<tr>
		  <td align="center" style="border-style: solid; border-width: 1px" width="159"><b><font face="Cambria">Name Of Institution</font></b></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="160">
			<b><font face="Cambria">Period From</font></b></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="160">
...
<b>
			...
			<font face="Cambria">
			Period To</td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="160"><b><font face="Cambria">Class Taught</font></b></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="160"><b>
		<font face="Cambria">Subjects Taught</font></b></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="160">
		  ...
		  <td align="center" style="border-style: solid; border-width: 1px" width="159"><font face="Cambria">
			<input name="txtInstitution" id="txtInstitution"  style="float: center"/class="text-box"></font></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="160">
			<p>
...
<b>
			...
			<font face="Cambria">
			<input name="txtPeriodFrom" id="txtPeriodFrom" type="date" style="float: center" class="text-box"/></font></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="160">

<b>

			<font face="Cambria">
			<input name="txtPeriodTo" id="txtPeriodTo" type="date" style="float: center" class="text-box"/></font></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="160"><font face="Cambria">
			<p>

<b>

			<input name="txtClassTaught" id="txtClassTaught"  style="float: center" class="text-box"/></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="160"><b><font face="Cambria">
			<input name="txtSubjectTaught" id="txtSubjectTaught" style="float: center" class="text-box"/></font></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="160">
			<p><b><font face="Cambria">
			<input name="txtDateOfEntry" id="txtDateOfEntry" type="date" style="float: center" class="text-box"/></font></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="160"><b><font face="Cambria">
			<input name="txtRemarks" id="txtRemarks" style="float: center" class="text-box"/></font></td>
...
<?php
$result=mysql_query("select * from EmployeeSB_Experiecnce  where `EmpID`='$EmployeeId'");
