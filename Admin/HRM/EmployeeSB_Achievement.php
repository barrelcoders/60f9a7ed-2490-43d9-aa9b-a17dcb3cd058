...
if(isset($_POST['submit']))
{
   ...
   $AchArea=$_POST['Area'];
   $AchDate=$_POST['ADate'];
   $AchDetails=$_POST['ADetails'];
   $DateOfEntry=$_POST['txtDateOfEntry'];

       
	mysql_query("INSERT INTO `EmployeeSB_Achievement`(`EmpID`, `EmpName`, `EmpDepartment`, `EmpDesignation`, `AreaofAchievement`, `AchievementDate`, `AchievementDetails`, `DateofEntry`) VALUES('$EmpNo','$EmpName','$EmpType','$Designation','$AchArea','$AchDate','$AchDetails','$DateOfEntry')");  
}
...
<table width="100%">
  <tr>
    <td align="center">
	<p align="left"><b><font face="Cambria">Employee Achievement Details</font><font size="3" face="Cambria"></p>
	<hr>
...
<table id="Table1" style="border-style:solid; border-width:1px; border-collapse:collapse" style="border-style: solid; border-width: 1px" width="1194" cellpadding="0">
			<p align="left">&nbsp;<tr>
				<td align="center" style="border-style: solid; border-width: 1px" width="298">
			<b><font face="Cambria">Area of Achievement</font></b></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="298">
			<b><font face="Cambria">Achievement Date</font></b></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="298">
...
<b>
			...
			<font face="Cambria">
			<input name="Area" id="Area"   style="float: center"/class="text-box"></font></td>
		  </td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="298">
...
<b>
			...
			<font face="Cambria">
			<input name="ADate" id="ADate" type="date"  style="float: center" class="text-box"/></font></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="298">
			
<b>

			<font face="Cambria">
			<input name="ADetails" id="ADetails" style="float: center" class="text-box"/></font></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="298"><b><font face="Cambria">
...
<table border=1  cellspacing="0" cellpadding="0"  class="CSSTableGenerator">
   <tr>
		...
		<td height="22" align="center" bgcolor="#95C23D" width=250px><b>
		<font face="Cambria">Area of Achievement</font></b></td>
		<td height="22" align="center" bgcolor="#95C23D" width=250px><b>
		<font face="Cambria">Achievement Date</font></b></td>
		<td height="22" align="center" bgcolor="#95C23D" width=250px><b>
		<font face="Cambria">Achievement Details</font></b></td>
		
		<td height="22" align="center" bgcolor="#95C23D" width=65><b>Entry Date</b></td>
		
   	</tr>
<?php
$result=mysql_query("select * from EmployeeSB_Achievement");
