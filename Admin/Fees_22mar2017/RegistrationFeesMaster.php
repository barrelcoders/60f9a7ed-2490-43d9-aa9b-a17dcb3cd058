...
$ssql="SELECT `srno`,`class`,`feeshead`, `amount`,`quarter`,`financialyear`,`datetime` FROM `fees_master` where `feeshead`='registrationfees' order by srno";
...
<title>Registration Fees Master</title>
...
<table width="100%" cellspacing="0" bordercolor="#000000" id="table_10" class="auto-style25">
	...
	<tr>
		...
		<strong>Registration Fees Master</strong><hr class="auto-style3" style="height: 0px" noshade="noshade">
...
<table  cellspacing="1"  id="table1">
		...
		<td height="28" align="center" style="width: 188px" bgcolor="#95C23D">				
		<span style="font-family: Cambria; font-weight: 700; font-size: 15px; ">				
		Sr. No.</span></td>				
		<td height="28" align="center" style="width: 188px" class="style4" bgcolor="#95C23D">				
		Class</td>				
		<td height="28" align="center" style="width: 189px" class="style4" bgcolor="#95C23D">				
		Quarter</td>
		<td height="28" align="center" style="width: 189px" class="style4" bgcolor="#95C23D">				
		Fees Head</td>				
		...
		<td height="28" align="center" style="width: 189px" class="style4" bgcolor="#95C23D">				
		Fees Amount</td>						
		<td height="28" align="center" style="width: 189px" class="style4" bgcolor="#95C23D">						Financial Year</td>				
				
				<td height="28" align="center" style="width: 189px" bgcolor="#95C23D">
