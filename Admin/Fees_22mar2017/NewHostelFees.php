...
if ($_REQUEST["txtAdmissionNo"] != "")
{
		...
		$sqlStudentDetail= "SELECT `sname`,`sclass`,`srollno`,`FinancialYear`,`previous_sclass`,`Hostel`,`DiscontType` ,`sfathername`,`MotherName`,`routeno` FROM `student_master` where  `sadmission`='$sadmission'";
		...
		else
		{
			...
			$sqlStudentDtl = "SELECT `sname` , `sclass` , `srollno`,`FinancialYear` FROM `NewStudentAdmission` where  `sadmission`='$sadmission'";
...
//History***
$ssqlFeePaymentDetail="SELECT `srno`,`sadmission`, `sname`, `sclass`, `srollno`, `fees_amount`, `InstallmentAmount`, `ActualLateFee`, `AdjustedLateFee`, `cheque_bounce_amt`, `finalamount`, `amountpaid`, `BalanceAmt`, `quarter`, `FinancialYear`, `status`, `receipt`, `date`, `datetime`, `refundamount`, `refunddate`, `cancelamount`, `canceldate`, `ReceiptFileName`, `FeeReceiptCode`, `PaymentMode`, `chequeno`, `cheque_date`, `bankname`, `cheque_status`, `ActualDelayDays`, `AdjustedDelayDays`, `Remarks`, `FeesType`, `SendToBank`, `TxnAmount`, `TxnId`, `TxnStatus`, `PGTxnId` FROM `fees_hostel` WHERE `sadmission`='$sadmission' and `FinancialYear`='$CurrentFinancialYear'";
...
<table border="1" width="100%" style="border-collapse: collapse">
	<tr>
		...
		<td width="60"><font face="Cambria" style="font-size: 11pt"><?php echo $sadmission;?></font></td>
...
<table border="1" width="100%" style="border-collapse: collapse">
	...
	{
	?>
	<form name ="frm1" method ="post" action ="HostelFeesReceipt.php">
	<input type ="hidden" name ="txtAdmissionNo" value ="<?php echo $sadmission;?>">
	<input type ="hidden" name ="InstallmentName" value ="HOSTEL FIRST INSTALLMENT">
	...
	<tr>
		...
		<td <?php if ($Q1Bounce =="yes") { ?>bgcolor="#FF8888"<?php }?>><font face="Cambria">
		<input type="text" name="txtAmountPaid" id="txtAmountPaid" size="20" class="text-box" onkeyup="Javascript:fnlInstallmentAmount('Q1');"></font></td>
		<td <?php if ($Q1Bounce =="yes") { ?>bgcolor="#FF8888"<?php }?>><font face="Cambria">
	...
	{
	?>
	<form name ="frm2" method ="post" action ="HostelFeesReceipt.php">
	<input type ="hidden" name ="txtAdmissionNo" value ="<?php echo $sadmission;?>">
	<input type ="hidden" name ="InstallmentName" value ="HOSTEL SECOND INSTALLMENT">
	...
	<tr>
		...
		<td <?php if ($Q2Bounce =="yes") { ?>bgcolor="#FF8888"<?php }?>><font face="Cambria">
		<input type="text" name="txtAmountPaid" id="txtAmountPaid" size="20" class="text-box" onkeyup="Javascript:fnlInstallmentAmount('Q2');"></font></td>
		<td <?php if ($Q2Bounce =="yes") { ?>bgcolor="#FF8888"<?php }?>><font face="Cambria">
		<input type="text" name="txtFinalInstAmountPaid" id="txtFinalInstAmountPaid" size="20" class="text-box" readonly></font></td>
	...
	{
	?>
	<form name ="frm3" method ="post" action ="HostelFeesReceipt.php">
	<input type ="hidden" name ="txtAdmissionNo" value ="<?php echo $sadmission;?>">
	<input type ="hidden" name ="InstallmentName" value ="HOSTEL THIRD INSTALLMENT">
	...
	{
	?>
	<form name ="frm4" method ="post" action ="HostelFeesReceipt.php">
	<input type ="hidden" name ="txtAdmissionNo" value ="<?php echo $sadmission;?>">
	<input type ="hidden" name ="InstallmentName" value ="HOSTEL FOURTH INSTALLMENT">
...
<tr>			
		...
		<td style="height: 29px;" class="style13" colspan="16">
