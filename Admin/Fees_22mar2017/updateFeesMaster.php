...
<?php
$id=$_REQUEST['srno'];
$ssql="SELECT * FROM `fees_master` WHERE srno='$id'";
$rs= mysql_query($ssql);
...
if($_REQUEST["cboMasterClass"] !="")
{
  ...
  $status=$_POST["status"];
    ...
    $sqlUpdate=  mysql_query("UPDATE fees_master SET feeshead='".$FeesHead."',class='".$MasterClass."',amount='".$Amount."',financialyear='".$FYYear."',"
...
<td><font face="Cambria"><select name="cboMasterClass" id="cboMasterClass" style="float: left" ; required  class="text-box">
						 ...
						 <?php
							...
							while($row1 = mysql_fetch_row($rsName))
							{
									$Name=$row1[0];
							?>
						 <option value="<?php echo $Name; ?>" <?php if($Name==$resulrData['class']){ echo "selected"; } ?> ><?php echo $Name; ?></option>
...
<td><font face="Cambria"><select name="cboFeesHead" id="cboFeesHead" style="float: left"  required  class="text-box">
						 ...
						 <?php
							...
							while($row1 = mysql_fetch_row($rsName))
							{
									$Name=$row1[0];
							?>
                                                 <option value="<?php echo $Name; ?>" <?php if($Name==$resulrData['feeshead']){ echo "selected"; } ?> ><?php echo $Name; ?></option>
