...
$receiptno= $_REQUEST["receiptno"];
	...
	$ssql="SELECT  `srno` ,  `sadmission` ,  `sname` ,  `sclass` ,  `srollno` ,  `fees_amount` ,  `amountpaid` ,  `BalanceAmt` ,  `FinancialYear` ,  `receipt` ,  `date` ,  `refundamount` , `refunddate` ,  `cancelamount` ,  `canceldate` ,  `finalamount` ,  `chequeno` ,  `cheque_date` ,  `bankname` ,  `ActualLateFee` ,  `ActualDelayDays` ,  `AdjustedLateFee` , `AdjustedDelayDays` ,  `Remarks` , (SELECT  `ReceiptCode` FROM  `fees_receipt_code` WHERE  `sadmission` = a.`sadmission` AND  `ReceiptNo` = a.`receipt`) AS  `ReceiptCode` FROM  `fees` AS  `a` WHERE  `sadmission` !=  ''";
		$rs= mysql_query($ssql);
}
...
<script language="javascript">
	...
	function ShowAdmissionFeeReceipt()
	{
		ReceiptNo=document.getElementById("txtReceiptno").value;
		var myWindow = window.open("ShowAFReceipt.php?Receipt=" + ReceiptNo ,"","width=700,height=650");	
	}
</script>
...
<table style="width: 100%" class="style2">
	<form name="frmTransaction" id="frmTransaction" method="post" action="ShowRegularFeeReceipt.php">
	<input type="hidden" name="isSubmit" id="isSubmit" value="yes">
	<tr>
		<td style="width: 152px" class="style4"><strong>Enter Receipt No:</strong></td>
		<td style="width: 154px" class="style3">
		<input name="receiptno" id="receiptno" class="text-box" type="text"></td>
		<td style="width: 1003px" class="style3">
		<input name="Submit1" type="submit" value="Submit" class="text-box">
		<input name="Submit1" type="submit" value="Print AF Receipt" class="text-box" onclick="Javascript:ShowAdmissionFeeReceipt();">
		</td>
	</tr>
	</form>
</table>
...
{
?>
<table border="0" cellpadding="0" class="CSSTableGenerator">
	<colgroup>
	...
	<tr height="20" style="height:15.0pt">
		...
		<td style="color: black; font-size: 11.0pt; font-weight: 400; font-style: normal; text-decoration: none; font-family: Calibri, sans-serif; text-align: general; vertical-align: bottom; white-space: nowrap; border: 1px solid; padding-left: 1px; padding-right: 1px; padding-top: 1px"><?php echo $refundamount; ?></td>
	...
	?>
	<tr>
		<td height="20" style="height: 15.0pt; color: black; font-size: 11.0pt; font-weight: 400; font-style: normal; text-decoration: none; font-family: Calibri, sans-serif; text-align: general; vertical-align: bottom; white-space: nowrap; border: 1px solid; padding-left: 1px; padding-right: 1px; padding-top: 1px" colspan="32" class="style1">
		<input name="PrintQ1Receipt" style="height: 29px; width: 99px;" type="button" value="Print Reciept" class="auto-style1" onclick="Javascript:ShowReceipt('<?php echo $ReceiptNo; ?>');">
		</td>		
	</tr>
	</table>
<?php
