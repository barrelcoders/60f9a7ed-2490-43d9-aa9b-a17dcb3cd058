...
if($_REQUEST["submit"] !="")
{
 ...
 $rsFeeHead=mysql_query("INSERT INTO `tbl_discount_master`(`discountType`, `feesHead`, `amount`,`financialyear`,`status`) VALUES ('$discountType','$feesHead','$Amount','$FYYear',1)");
 echo "<br><br><center><b>Discount Type defined successfully!<b>";

 }
 $ssql="SELECT * FROM `tbl_discount_master` order by `srno` DESC";
...
<div class="admissionreport">
    <div class="admission_head">Discount Master <div style="float: right"><a href="AddDiscountMaster.php">Add New Discount Master</a></div></div>
										...
										<div class="table-responsive">
											<table id="datable_1" class="table table-hover display  pb-30" >
                                                    ...
                                                    <th style="border:1px solid #097b4d; background:#0b462d; color:#fff;">Sr.No.</th> 
                                                     <th style="border:1px solid #097b4d; background:#0b462d; color:#fff;">Discount Type</th>
                                                    <th style="border:1px solid #097b4d; background:#0b462d; color:#fff;">Fees Head</th>
                                                    <th style="border:1px solid #097b4d; background:#0b462d; color:#fff;">Discount&nbsp;(%)</th>
  ...
  <tr>
                                                 <td><?php echo $i; ?></td>
                                                  ...
                                                  <?php if($row['status']==1){$statusClass="active";}else{ $statusClass="inactive"; } ?>
                                                   ...
                                                   <td><a href="updateDiscountMaster.php?srno=<?php echo $row['srno']; ?>">Update</a></td>
