...
<table style="border-width:1px; width: 100%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<td style="border-top-style:solid; border-top-width:1px; border-bottom-style:none; border-bottom-width:medium" colspan="7">
	...
	<form name ="frmRpt" id="frmRpt" method ="post" action="NewFeeForecastReport.php">
