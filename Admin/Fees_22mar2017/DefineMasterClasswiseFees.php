...
?>
<?php
$SubmittedMasterClass=$_REQUEST["MasterClass"];

$rsClass=mysql_query("select distinct `class` from `class_master` where `MasterClass`='$SubmittedMasterClass'");
   ...
   while($row = mysql_fetch_row($rsStudent))
		{
					...
					{
						//$ssql="select `feeshead`,`amount`,`quarter`,`financialyear` from `fees_master` where `StudentType`= '$StudentType' and `class`='$MasterClass'";
				...
				while($row1 = mysql_fetch_row($rsFeeComponent))
					{
						...
						if($feeshead=="computerfees" || $feeshead=="COMPUTER FEES (OPTIONAL)")
						{
							if($Computer=="Yes")
							{
								mysql_query("INSERT INTO `fees_student1` (`sadmission`,`class`,`Name`,`feeshead`,`actualamount`,`discountamount`,`amount`,`financialyear`,`StudentType`,`FeesType`) VALUES ('$sadmission','$Class','$sname','$feeshead','$ActualFeeHeadAmount','$DiscountAmount','$amount','$financialyear','$StudentType','Regular')");
							}
						}
						else
						{
				...
				if($StudentType=="new")
				{
					...
					if($AdvanceHeadAmt !="")
						{
							if($AdmissionClass=="11")
							{
								mysql_query("INSERT INTO `fees_student1` (`sadmission`,`class`,`Name`,`feeshead`,`actualamount`,`discountamount`,`amount`,`financialyear`,`StudentType`,`FeesType`) VALUES ('$sadmission','$Class','$sname','PROVISIONAL AMOUT','25000','','25000','$financialyear','$StudentType','')");
								mysql_query("INSERT INTO `fees_student1` (`sadmission`,`class`,`Name`,`feeshead`,`actualamount`,`discountamount`,`amount`,`financialyear`,`StudentType`,`FeesType`) VALUES ('$sadmission','$Class','$sname','Advances','41000','','41000','$financialyear','$StudentType','')");
							}
							else
							{
								if($AdmissionDate>=$CompareDate)
									mysql_query("INSERT INTO `fees_student1` (`sadmission`,`class`,`Name`,`feeshead`,`actualamount`,`discountamount`,`amount`,`financialyear`,`StudentType`,`FeesType`) VALUES ('$sadmission','$Class','$sname','FEES FIRST INSTALLMENT','$AdvanceHeadAmt','','$AdvanceHeadAmt','$financialyear','$StudentType','')");
								else
									mysql_query("INSERT INTO `fees_student1` (`sadmission`,`class`,`Name`,`feeshead`,`actualamount`,`discountamount`,`amount`,`financialyear`,`StudentType`,`FeesType`) VALUES ('$sadmission','$Class','$sname','Advances','$AdvanceHeadAmt','','$AdvanceHeadAmt','$financialyear','$StudentType','')");
							}
						}
				}
				/*
				if($Hostel=="Yes")
				{
					...
					while($row2 = mysql_fetch_row($rsHostel))
					{
							...
							mysql_query("INSERT INTO `fees_student1` (`sadmission`,`class`,`Name`,`feeshead`,`actualamount`,`amount`,`financialyear`,`StudentType`,`FeesType`) VALUES ('$sadmission','$Class','$sname','$feeshead','$amount','$amount','$financialyear','$StudentType','Hostel')");
					}
				}
				*/
				if($routeno !="")					
				{
					...
					//$rsTransport=mysql_query("select `Route`,`Amount`,`financialyear`,`feeshead` from `fees_transportmaster` where `Route`='$routeno'");
					while($row2 = mysql_fetch_row($rsTransport))
					{
						...
						//$financialyear=$row2[2];
						$feeshead=$row2[0];
						mysql_query("INSERT INTO `fees_student1` (`sadmission`,`class`,`Name`,`feeshead`,`actualamount`,`amount`,`financialyear`,`StudentType`,`FeesType`) VALUES ('$sadmission','$Class','$sname','$feeshead','$amount','$amount','$financialyear','$StudentType','Regular')");
					}
				...
				while($rowC=mysql_fetch_row($rsCloseAmtCreditDebit))
				{
					$feeshead=$rowC[0];
					$amount=$rowC[1];
					mysql_query("INSERT INTO `fees_student1` (`sadmission`,`class`,`Name`,`feeshead`,`actualamount`,`amount`,`financialyear`,`StudentType`,`FeesType`) VALUES ('$sadmission','$Class','$sname','$feeshead','$amount','$amount','$financialyear','$StudentType','')");
				}
		}
}
