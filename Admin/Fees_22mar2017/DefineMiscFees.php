...
<img height="30" src="../images/BackButton.png" width="70" class="auto-style31" style="float: right"></font></a></p>
				...
				<table cellpadding="0" style="width: 100%; border-collapse:collapse" height="301" class="style1" border="1">
					...
					<tr>
						<td width="100" align="center" height="44" style="border-style: solid; border-width: 1px" class="style2">
					...
					<tr>
						...
						<td bgcolor="#95C23D" width="344" align="center" height="22" style="border-style: solid; border-width: 1px; width: 0;">
						&nbsp;</td>
						<td bgcolor="#95C23D" width="344" align="center" height="22" style="border-style: solid; border-width: 1px; width: 172px;">
		...
		<font face="Cambria">
		<select size="10" name="lstStudent2" id="lstStudent2" style="width: 210; height:215";" onclick="Javascript:fnlGetStudent();">
	
		</select></font></td>
						<td bgcolor="#FFFFFF" width="344" align="center" style="border-style: solid; border-width: 1px; width: 0;">
		<select size="10" name="lstStudent1" id="lstStudent1" style="width: 210; height:215";" multiple="multiple">
	
		</select>
		</td>
						<td bgcolor="#FFFFFF" width="344" align="center" style="border-style: solid; border-width: 1px; width: 172px;">
		<font face="Cambria">
		<input type="button" value="Add --&gt;" name="btnAdd" onclick="javascript:listbox_moveacross('lstStudent1', 'lstAddedStudent');" style="font-weight: 700"><br><br><input type="button" value="&lt;-- Delete" name="btnDeleteApprover" style="width: 83; height:25; font-weight:700" onclick="javascript:listbox_moveacross1('lstAddedStudent','lstStudent1');"></font></td>
