...
$FinancialYear = $_REQUEST["financialyear"];
		...
		$rsSecurity = mysql_query("select `amount` from `fees_master` where `class`='$Class' and `feeshead`='Security Fees'  and `financialyear`='$FinancialYear'");
		...
		$rsLab = mysql_query("select `amount` from `fees_master` where `class`='$Class' and `feeshead`='Lab Charges'  and `financialyear`='$FinancialYear'");
