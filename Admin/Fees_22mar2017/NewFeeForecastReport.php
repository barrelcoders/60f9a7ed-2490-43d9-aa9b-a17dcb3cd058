...
while($rowClass=mysql_fetch_row($rsClass))
{
	...
	$ssql="SELECT distinct `sadmission`,`Name`,`class`,(select `DiscontType` from `student_master` where `sadmission`=a.`sadmission`) as `DiscountType`,(select `routeno` from `student_master` where `sadmission`=a.`sadmission`) as `routeno`,(select IF(a.`DiscountType`='Staff Child',`amount`,`actualamount`) from `fees_student1` where `sadmission`=a.`sadmission` and `feeshead`='ADMISSION FEES'),(select IF(a.`DiscountType`='Staff Child',`amount`,`actualamount`) from `fees_student1` where `sadmission`=a.`sadmission` and `feeshead`='Advances' ),(select IF(a.`DiscountType`='Staff Child',`amount`,`actualamount`) from `fees_student1` where `sadmission`=a.`sadmission` and `feeshead`='ANNUAL CHARGES'),(select IF(a.`DiscountType`='Staff Child',`amount`,`actualamount`) from `fees_student1` where `sadmission`=a.`sadmission` and `feeshead`='CAUTION MONEY (REFUNDABLE)'),(select IF(a.`DiscountType`='Staff Child',`amount`,`actualamount`) from `fees_student1` where `sadmission`=a.`sadmission` and `feeshead`='CLOSE AMOUNT CREDIT'),(select IF(a.`DiscountType`='Staff Child',`amount`,`actualamount`) from `fees_student1` where `sadmission`=a.`sadmission` and `feeshead`='CLOSE AMOUNT DEBIT'),(select IF(a.`DiscountType`='Staff Child',`amount`,`actualamount`) from `fees_student1` where `sadmission`=a.`sadmission` and `feeshead`='COMPUTER FEES'),(select IF(a.`DiscountType`='Staff Child',`amount`,`actualamount`) from `fees_student1` where `sadmission`=a.`sadmission` and `feeshead`='MAINTENANCE FEE'),(select IF(a.`DiscountType`='Staff Child',`amount`,`actualamount`) from `fees_student1` where `sadmission`=a.`sadmission` and `feeshead`='MANAGEMENT FEES'),(select IF(a.`DiscountType`='Staff Child',`amount`,`actualamount`) from `fees_student1` where `sadmission`=a.`sadmission` and `feeshead`='SCIENCE FEES'),(select IF(a.`DiscountType`='Staff Child',`amount`,`actualamount`) from `fees_student1` where `sadmission`=a.`sadmission` and `feeshead`='SMART CLASS'),(select IF(a.`DiscountType`='Staff Child',`amount`,`actualamount`) from `fees_student1` where `sadmission`=a.`sadmission` and `feeshead`='TRANSPORT CHARGES'),(select IF(a.`DiscountType`='Staff Child',`amount`,`actualamount`) from `fees_student1` where `sadmission`=a.`sadmission` and `feeshead`='TUITION FEES'),(select sum(discountamount) from `fees_student1` where `sadmission`=a.`sadmission`),(select `amount` from `fees_student1` where `sadmission`=a.`sadmission` and `feeshead`='FEES FIRST INSTALLMENT' and `InstallmentDate`>='$DateFrom' and `InstallmentDate`<='$DateTo'),(select IF(a.`DiscountType`='Staff Child',`amount`,`actualamount`) from `fees_student1` where `sadmission`=a.`sadmission` and `feeshead`='COMPUTER FEES (OPTIONAL)'),(select `amount` from `fees_student1` where `sadmission`=a.`sadmission` and `feeshead`='FEES SECOND INSTALLMENT' and `InstallmentDate`>='$DateFrom' and `InstallmentDate`<='$DateTo'),(select `amount` from `fees_student1` where `sadmission`=a.`sadmission` and `feeshead`='FEES THIRD INSTALLMENT' and `InstallmentDate`>='$DateFrom' and `InstallmentDate`<='$DateTo'),(select `amount` from `fees_student1` where `sadmission`=a.`sadmission` and `feeshead`='FEES FOURTH INSTALLMENT' and `InstallmentDate`>='$DateFrom' and `InstallmentDate`<='$DateTo'),(select `amount` from `fees_student1` where `sadmission`=a.`sadmission` and `feeshead`='PROVISIONAL AMOUNT'),(select sum(`RefundAmount`) from `fees_student1` where `sadmission`=a.`sadmission`) from  `fees_student1` as `a` where `class`='$Class' and `sadmission` in (select distinct `sadmission` from `fees_student1`  where `feeshead` in ('FEES FIRST INSTALLMENT','FEES SECOND INSTALLMENT','FEES THIRD INSTALLMENT','FEES FOURTH INSTALLMENT') and `InstallmentDate`>='$DateFrom' and `InstallmentDate`<='$DateTo') order by `sadmission`";
