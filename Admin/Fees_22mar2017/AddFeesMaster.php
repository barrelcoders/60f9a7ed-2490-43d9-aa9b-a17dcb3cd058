...
<td><font face="Cambria"><select name="cboFinancialYear" id="cboFinancialYear" style="float: left" ; required  class="text-box">
						 <option selected="" value="Select One">Select One</option>
						 <?php
							$ssqlFinancialYear="SELECT distinct `financialyear` FROM `fymaster`";
							$ssqlFinancialYear= mysql_query($ssqlFinancialYear);
							
							while($row1 = mysql_fetch_row($ssqlFinancialYear))
							{
									$Name=$row1[0];
							?>
						 <option value="<?php echo $Name; ?>"><?php echo $Name; ?></option>
