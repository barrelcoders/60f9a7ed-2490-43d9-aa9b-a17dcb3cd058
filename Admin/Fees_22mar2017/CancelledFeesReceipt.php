...
if ($_REQUEST["txtTotalRefundAmt"] != "")
{
		...
		$ssql = "SELECT `sname`,`sadmission`,`sclass`,`srollno` FROM `fees` where `receipt`='$ReceiptNo'";
		...
		{
			$ssql="UPDATE `fees` SET `cancelamount`='$TotalRefundAmt',`finalamount`='$TotalRefundAmt',`canceldate`=CURDATE(),`status`='CANCEL' where `receipt`='$ReceiptNo'";

			mysql_query($ssql) or die(mysql_error());
						
			$Message1="<br><br><center><b>Quarter Fee Cancellation successfully completed!";
		}
		else
		{
...
<div id="MasterDiv" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
	...
	<p align="center" class="auto-style5"><font face="Calibri">Quarter Fee 
	Cancellation 
	Receipt</font></p>
	...
	<div align="center">
		<table border="1" cellspacing="0" cellpadding="0" style="width: 63%">
			...
			<tr>
				<td align="left" style="border-style: dotted; border-width: 1px; height: 24px; width: 292px;">
				<font face="Calibri">Fee payment for Quarter</font></td>
				<td align="center" style="border-style: dotted; border-width: 1px; height: 24px;">
				<?php echo $Quarter; ?></td>
			</tr>
			<tr>
				<td align="left" style="border-style: dotted; border-width: 1px; height: 24px; width: 292px;">
				<font face="Calibri">Tuition Fee + Annual Charges for Quarter</font></td>
				<td align="center" style="border-style: dotted; border-width: 1px; height: 24px;">
