...
<?php
...

		{
			...
			$IndClass=$arrSelectedClass[$j];
...

				{
					...
					$ssql = "UPDATE `classwork_master` SET `classwork`='$Classwork',`datetime`=now() WHERE `sclass`='$IndClass' and `subject`='$Subject' and `classworkdate`='$ClassworkDt'";						
...

				{
					...
					$ssql = "INSERT INTO `classwork_master` (`sclass`,`subject`,`classworkdate`,`classwork`) values ('$IndClass','$Subject','$ClassworkDt','$Classwork')";
...

				{
					...
					$ssqlHomeWork ="UPDATE `homework_master` SET `homework`='$Homework',`datetime`=NOW() WHERE `sclass`='$IndClass' AND `subject`='$Subject' AND `homeworkdate`='$ClassworkDt'";
...

				{
					...
					$ssqlHomeWork = "INSERT INTO `homework_master` (`sclass`,`subject`,`homeworkdate`,`homework`) values ('$IndClass','$Subject','$ClassworkDt','$Homework')";
	...
	$rsMsg= mysql_query($ssqlMsg);
...

		{
					...
					$strEmail=$strEmail . '<img border="0" src="'.$SchoolLogo.'"></td>';
