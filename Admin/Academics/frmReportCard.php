...
<img height="30" src="../images/BackButton.png" width="70" style="float: right"></a></p>
	...
	<tr>
		<td class="auto-style36" style="width =560px"50%"><strong>Upload Student Report Card Details</strong></td>
		<td class="auto-style4" width="561"><a href="UploadReportCard.php">
	...
	<tr>
		...
		<table width="100%" border="1" cellpadding="0" class="style6">
			...
			<tr>
				<td style="width: 196px; height: 36px;" class="auto-style33">Subject</td>
