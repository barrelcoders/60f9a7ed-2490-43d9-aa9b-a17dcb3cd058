...
<img height="30" src="../images/BackButton.png" width="70" style="float: right"></a></b></p>
	...
	<tr>
		<td class="auto-style36" style="text-align:left">
		<strong style="font-weight: 400">Upload Student Marks</strong></td>
	...
	<tr>
		...
		<input type="hidden" name="ASLMaxMarks<?php echo $Cnt; ?>" id="ASLMaxMarks<?php echo $Cnt; ?>" value="<?php echo $ASLMaxMarks;?>">/<?php echo $ASLMaxMarks;?>
				...
				<td style="width: 197px; height: 36px;" class="style8">
				<input name="txtTotalMarks<?php echo $Cnt; ?>" id="txtTotalMarks<?php echo $Cnt; ?>" type="text" class="auto-style40" style="width: 142px" readonly="readonly"></td>
				<td style="width: 197px; height: 36px;" class="style8">
