...
if ($_REQUEST["SubmitType"]=="ReloadWithSubject")
{
   ...
   while($row = mysql_fetch_assoc($rsMaxMarks))
	...
	$ssql="SELECT `sname`,`srollno` FROM `student_master` a  where  `sclass`='$SelectedClass' order by CAST(`srollno` AS UNSIGNED)";
	$rs= mysql_query($ssql);	
}   
	...
	for (i=1;i<totalSubject;i++)
	{
		...
		if (document.getElementById(varCtrlMarksName).value != "")
		{
			if (isNaN(document.getElementById(varCtrlMarksName).value)==true)
			{
				...
				//alert (SubjectName);
				alert("Please enter numeric data in for Student Name :" + StudentName);
				return;
			}
			else
			{
...
<img height="30" src="../images/BackButton.png" width="70" style="float: right"></a></p>
	...
	<tr>
		<td class="auto-style36" style="width ="50%"><strong>Upload Student Report Card Details</strong></td>
		<td class="auto-style4"><a href="UploadReportCard.php">
		<span class="auto-style6"><strong>View Previous Uploaded Report Card Details</strong></span></a></td>
	</tr>	</table>	<table class="auto-style29" style="width: 100%">
	<form name="frmClassWork" id="frmClassWork" method="post" action="frmBulkReportCard.php">	
	...
	<tr>
		...
		<td class="auto-style37" style="width: 273px; height: 29px;">Subject:</td>
		<td class="auto-style32" style="width: 319px; height: 29px;">
		<span class="auto-style40">
		<!--
	...
	<tr>
		<td class="auto-style25" style="width: 318px">Test Type:</td>
		...
		<td class="auto-style37" style="width: 273px">&nbsp;</td>
		<td class="auto-style32" style="width: 319px">
		&nbsp;</td>
	</tr>
	...
	<tr>
		...
		<input name="btnShow" type="button" value="Show Student" onclick="Javascript:ReloadWithSubject();"></td>
	</tr>
	<?php
	if ($_REQUEST["SubmitType"]=="ReloadWithSubject")
	{
	...
	<tr>
		...
		<table width="100%" cellpadding="0" class="style6">
			...
			<tr>
				...
				Marks</td>
				<td style="width: 197px; height: 36px;" class="auto-style39">Max. Marks</td>
				<td style="width: 197px; height: 36px;" class="auto-style39">
				Remarks</td>
				<td style="width: 197px; height: 36px;" class="auto-style39">
				Grade</td>
		...
		<input type="text" name="txtMarks<?php echo $Cnt; ?>" id="txtMarks<?php echo $Cnt; ?>" size="15" onkeyup="Javascript:GetGrade('txtMarks<?php echo $Cnt; ?>','txtMaxMarks<?php echo $Cnt; ?>','txtGrd<?php echo $Cnt; ?>','txtGradePoint<?php echo $Cnt; ?>');" class="auto-style40"></td>
				<td style="width: 197px; height: 36px;" class="style8">
				...
				<input name="txtGradePoint<?php echo $Cnt; ?>" id="txtGradePoint<?php echo $Cnt; ?>" type="text" readonly class="auto-style40" style="width: 138px"></td>
			</tr>
			<?php
				$Cnt = $Cnt+1;
			}
