...
$ssql="select `subject`,`class`,`remark`,`assignmentdate`,`assignmentcompletiondate`,`assignmentURL` from  `assignment` order by `assignmentdate` desc";
...
<table width="100%" cellspacing="1" bordercolor="#000000" id="table_1" class="style9">
	...
	<tr>
		...
		<font face="Cambria">
		<textarea name="txtRemark<?php echo $Cnt; ?>" id="txtRemark<?php echo $Cnt; ?>" rows="3" style="width: 313px" cols="20"><?php echo $EneteredClassWork; ?></textarea></font></td>

		<td style="height: 47px; " colspan="3">
		
			<font face="Cambria">		
			<input name="File<?php echo $Cnt; ?>" id="File<?php echo $Cnt; ?>" type="file" style="font-weight: 700"></font></td>
