...
$EmpId=$_SESSION['userid'];
   $sql = "SELECT distinct `class` FROM `class_master` where `class` in (select distinct `Class` from `teacher_class_mapping` where `EmpID`='$EmpId')";
...
function Validate()
{
	...
	*/
	...
	if (document.getElementById("txtSelectedClass").value=="Select One" || document.getElementById("txtSelectedClass").value=="")
	{
		alert("Please select Class !");
		return;
	}
...
<table style="border-width:1px; border-collapse:collapse" cellpadding="0" width="100%">		
<form name="frmClassWork" id="frmClassWork" method="post" action="frmDateSheet26sep2015.php">	
...
<input type="hidden" name="txtSelectedClass" id="txtSelectedClass" value="<?php echo $SelectedClasses; ?>" class="auto-style22">
	<tr>
		...
		<td class="style2" style="width: 311px">
			...
			<select name="cboClass" id="cboClass" multiple="multiple" size="7" style="width: 174px" onclick="Javascript:GetSelectedValue();">
		...
		<input name="btnShowSubject" type="button" value="Show Subject" onclick="ReloadWithSubject();"></td>
	</tr>
	...
	<tr>
		...
		<table width="1239" border="1" cellpadding="0" class="style6" style="border-width: 0px" height="91">
			...
			<tr>
				...
				<p style="text-align: center">
				<input name="txtName<?php echo $Cnt; ?>" id="txtName<?php echo $Cnt; ?>" type="text" style="width: 148px" value="<?php //echo $Subject; ?>"></td>
				<td style="height: 34px" class="style8" width="620">
		<input type="text" name="txtDate<?php echo $Cnt; ?>" id="txtDate<?php echo $Cnt; ?>" size="15" value="" class="tcal" style="font-family: Arial; color: #000000"></td>
			</tr>
			<?php
				$Cnt = $Cnt+1;
			}
	...
	<tr>
		<td class="style5" colspan="5" style="border-style: none; border-width: medium">
		&nbsp;</td>
	</tr>
	<tr>
		<td class="style5" colspan="5" style="border-style: none; border-width: medium">
