...
<div class="row c">
 <div class="col-md-2 hris1"> 
  <h4>SELF SERVICE</h4>
  <ul>
   <li><a href="SectionRoll_AllotSectionRoll.php"><button class="btnmanu">Allot Section & Roll No</button></a></li>
   <li class="active"><a href="AllotRollno_ExistingStudent.php"><button class="btnmanu">Allot Roll No to existing student</button></a></li>
  </ul>
 </div>
<!--------------Details------------------>
 <div class="col-md-10">
  <div class="studentwithdrawal">
    	<div class="studentwithdrawal_head">Allot Roll No to existing student</div>
  ...
  <!-- Row -->
				...
				<!-- /Row -->
                <div align="left" style="margin:1% 1.5%;"><input type="submit" name="ssubmit" id="ssubmit" class="btn"></div>
 			</form>
        </div>
    </div>
 </div>
