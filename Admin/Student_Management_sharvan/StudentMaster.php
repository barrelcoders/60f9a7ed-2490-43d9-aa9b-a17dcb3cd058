...
{
	$ssql="SELECT `srno` , `sname` , `DOB`,`Sex`,`Category`,`Nationality`,`sadmission` ,`sclass`,`srollno`,`LastSchool`,`sfathername`,`FatherEducation`,`FatherOccupation`,`MotherName`,`MotherEducation`,`Address`,`smobile`,`simei`,`suser`,`spassword`,`email`,`routeno`,`FeeSubmissionType`,`DiscontType`,`DocumentFileName`,`SchoolId`,`Remarks`,`LastUpdateDate`,DATE_FORMAT(`DateOfAdmission`,'%d-%c-%Y'),`house`,`F_OrganisationworkNature`,`M_OrganisationworkNature`,`FatherDesignation`,`MotherDesignation` FROM `student_master` where 1=1";
