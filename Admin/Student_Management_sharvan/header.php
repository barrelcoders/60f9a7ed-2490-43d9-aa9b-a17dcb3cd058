  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li class="active"><a href="StudentMgt_Landing.php">HOME</a></li>
        <li><a href="ExistingStudent_StudentMaster.php">EXISTING STUDENT TASKS</a></li>
        <li><a href="StudentWithdrawal_Deactivate.php">STUDENT WITHDRAWAL</a></li>
        <li><a href="AlumniStudent_SearchStudent.php" >ALUMNI STUDENTS</a></li>
        <li><a href="SectionRoll_AllotSectionRoll.php">SECTION & ROLL NO ALLOCATION</a></li>
        <li><a href="Report_DiscountWise.php">REPORTS</a></li>
      </ul>
