...
<div class="row c">
 <div class="col-md-2 hris1"> 
  <h4>SELF SERVICE</h4>
  <ul>
   <li class="active"><a href="StudentWithdrawal_Deactivate.php"><button class="btnmanu">Deactivate A Student</button></a></li>
...
<!--------------Details------------------>
 <div class="col-md-10">
 	<div class="studentwithdrawal">
    	<div class="studentwithdrawal_head">Deactivate A Student</div>
