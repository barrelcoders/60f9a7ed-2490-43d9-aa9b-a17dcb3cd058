 ...
 <div class="col-md-10">
  <div class="studentDA">
   ...
   <div class="studentDA_link">
    <div class="row">
     <div class="col-xs-6">
      <a href="Student_DossierL1.php" class="active">
       <button class="btnmanu">Student Dossier Approval Level 1 &nbsp;<font size="+2">&dArr;</font></button></a>
     </div>
     <div class="col-xs-6">
      <a href="Student_DossierL2.php"><button class="btnmanu">Student Dossier Approval Level 2</button></a>
     </div>
    </div>
   </div>
    ...
    <form action="#" method="post">
     <table class="table-responsive">
      <tr class="col">
       ...
       <td style="border:1px solid #097b4d">Name</td><td style="border:1px solid #097b4d">Class</td>
