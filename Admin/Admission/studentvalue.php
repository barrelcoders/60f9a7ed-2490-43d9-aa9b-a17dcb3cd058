...
if(isset($_POST['submit'])){
 ...
 $select = mysql_query("SELECT sname,middlename,slastname, RegistrationNo,DOB,Sex,sfathername,MotherName,EmergencyEmail,EmergencyContactNo FROM NewStudentRegistration_temp where RegistrationNo='".$registration_no."'");  
  ...
  $Gender   =$listFetch['Sex'];
    ...
    $result=mysql_query("INSERT INTO drawoflots(Applicant_name,Admission_no,Father_name,Mother_name,DOB,Email_id,Phone_no,Gender) value('".$Applicant_name." ".$Applicant_mname." ".$Applicant_lname."','".$Admission_no."','".$Father_name."','".$Mother_name."','".$DOB."','".$Email_id."','".$Phone_no."','".$Gender."')");
...
<html>
	...
	<body>
		...
		<div class="row" >
		     <div class="col-xs-4" style="text-align:right;font-size:16px;"> <strong>Enter Registration No:</strong></div>
		...
		<div class="col-xs-4"><input name="submit" type="submit" value="submit" class="btn" /></div>
			  ...
			  <div align="center" class="h h11"><b><font >Nursery Admission Draw List</font></b></div>
			  <div>&nbsp;</div>
