...
<body>
 ...
 <div class="btns">
  <div class="row">
   <div class="col-xs-6"><a href="ClassIX_complete_Registration_Report.php"><button class="btn">Complete Registration Report</button></a></div>
   <div class="col-xs-6"><a href="ClassIX_incomplete_Registration_Report.php"><button class="btn active">Incomplete Registration Report<font size="+1">&nbsp;&dArr;</font></button></a></div>
  </div>
 </div>
 <div id="MasterDiv">
 <!-- Row -->
