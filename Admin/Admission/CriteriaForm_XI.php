...
<div id="container">
 ...
 <div class="row">
  ...
  <div class="col-xs-3"> <input type="text" name="cboClass" id="cboClass" class="text-box" value="Class XI" required="true" readonly> </div>
...
<div align="center" class="h h11"><b><font >Enter your grades in Class X Term-I Exam</font></b></div>
 ...
 <div id="div1" style="display:none">
  <div class="row"> 
   ...
   <div class="col-xs-3"><select name="cbosciiencesubject2" id="cbosciiencesubject2" class="text-box" required="true" >
  	<option value="">Select One</option>
  ...
  <div class="row">
   ...
   <div class="col-xs-3"><select name="cbosciiencesubject6" id="cbosciiencesubject6" class="text-box"  >
  	<option value="">Select One</option>
    </select></div>
  </div>
 </div>
 <div id="div2" style="display:none;">
  <div class="row"> 
   <div class="col-xs-3">Select Subject 1</div>
   <div class="col-xs-3"><select name="cbocommercesubject1" id="cbocommercesubject1" class="text-box" required="true" >
  	<option value="">Select One</option>
  ...
  <div class="row">
   ...
   <div class="col-xs-3">Additional Subject</div>
   <div class="col-xs-3"><select name="cbocommercesubject6" id="cbocommercesubject6" class="text-box"  >
  	<option value="">Select One</option>
    </select></div>
  </div>
 </div>
 <div id="div3" style="display:none;">
  ...
  <div class="row"> 
   ...
   <div class="col-xs-3">Additional Subject</div>
   <div class="col-xs-3"><select name="cbohuminitiessubject6" id="cbohuminitiessubject6" class="text-box" >
  	<option value="">Select One</option>
  	<option value="English" selected>English</option>
  	</select></div>
  </div>
