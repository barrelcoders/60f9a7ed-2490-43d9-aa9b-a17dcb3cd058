...
<body>
 ...
 <div class="btns">
  <div class="row">
   <div class="col-xs-6"><a href="complete_registration_report.php"><button class="btn">Complete Registration Report</button></a></div>
   <div class="col-xs-6"><a href="incomplete_registration_report.php"><button class="btn active">Incomplete Registration Report<font size="+1">&nbsp;&dArr;</font></button></a></div>
  </div>
 </div>
 <div id="MasterDiv">
 <!-- Row -->
											...
											<table id="datable_1" class="table table-hover display  pb-30" >
												<thead>
													<tr>
                                                        ...
                                                        <th colspan="11" style="border:1px solid #0b462d;"><b>Attached Files</b></th>
