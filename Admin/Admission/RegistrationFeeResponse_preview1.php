...
?>
 <?php
  $Applicationno=$_REQUEST['ApplicationNo'];
   $sqlReport="SELECT `RegistrationNo`, `sclass`, `TxnAmount`, `TxnId`, `TxnStatus`, `PGTxnId`, `pgTxnNo`, `TxRefNo`, `TxMsg` FROM `NewStudentRegistration_temp` WHERE RegistrationNo =  ".$Applicationno."";
  // echo $sqlReport;die;
...
.text2{font-size:14px;} .text3{font-size:14px;} .xs{font-size:10px;} }	
  ...
  <div class="inner">
<div><h4><b>Congratulations !</b></h4></div>
       <div class="text1"><i>You have successfully registered for<b> Class <?php echo $reportData['sclass']; ?></b> admission.</i><br> Your Application Number is <b><?php echo $reportData['RegistrationNo']; ?>.</b></div>
