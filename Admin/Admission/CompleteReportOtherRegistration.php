...
<body>
 ...
 <div class="btns">
  <div class="row">
   <div class="col-xs-6"><a href="CompleteReportOtherRegistration.php"><button class="btn active">Complete Registration Report<font size="+1">&nbsp;&dArr;</font></button></a></div>
   <div class="col-xs-6"><a href="IncompleteReportOtherRegistration.php"><button class="btn">Incomplete Registration Report</button></a></div>
  </div>
 </div>
 <div id="MasterDiv">
 <!-- Row -->
...
<td style="border:1px solid #0b462d;"><a href="../../Admission/student_registration_others_preview.php?ApplicationNo=<?php echo $reportData['registration_no']; ?>" target="_blank"><?php echo $reportData['registration_no']; ?></a></td>
