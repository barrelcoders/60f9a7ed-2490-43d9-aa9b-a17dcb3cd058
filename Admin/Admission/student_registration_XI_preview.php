...
<?php } elseif($result['MotherOccupatoin']=="Political") { ?>
 ...
 <div class="row">
  ...
  <div class="col-xs-3"><a href="../../Admission/DocumentsXIth/<?php echo $result['ProfilePhoto']; ?>" target="_blank"><?php echo $result['ProfilePhoto']; ?></a></div>
  <div class="col-xs-3"><b> 2. Photograph of Father* :</b></div>
  <div class="col-xs-3"> <a href="../../Admission/DocumentsXIth/<?php echo $result['FatherPhoto']; ?>" target="_blank"><?php echo $result['FatherPhoto']; ?></a></div>
 </div>
 <div class="row">
  <div class="col-xs-3"><b> 3. Photograph of Mother* :</b></div>
  <div class="col-xs-3"> <a href="../../Admission/DocumentsXIth/<?php echo $result['MotherPhoto']; ?>" target="_blank"><?php echo $result['MotherPhoto']; ?></a></div>
  <div class="col-xs-3"><b> 4. Photograph of Guardian (if applicable) :</b></div>
  <div class="col-xs-3"><a href="../../Admission/DocumentsXIth/<?php echo $result['GuardianPhoto']; ?>" target="_blank"><?php echo $result['GuardianPhoto']; ?></a></div>
 </div> 
 <div class="row">
  <div class="col-xs-3"><b> 5. Proof of Applicant's Aadhar card* :</b></div>
  <div class="col-xs-3"><a href="../../Admission/DocumentsXIth/<?php echo $result['AadharNumber']; ?>" target="_blank"><?php echo $result['AadharNumber']; ?></a></div>
  <div class="col-xs-3"><b> 6. Copy Of ST/SC/OBC Certificate (if applicable) :</b></div>
  <div class="col-xs-3"><a href="../../Admission/DocumentsXIth/<?php echo $result['CatagoryCertificate']; ?>" target="_blank"><?php echo $result['CatagoryCertificate']; ?></a></div>
 </div>
 <div class="row">
  <div class="col-xs-3"><b> 7. Proof of Any Other Category (if applicable) :</b></div>
  <div class="col-xs-3"><a href="../../Admission/DocumentsXIth/<?php echo $result['OtherCatagoryCertificate']; ?>" target="_blank"><?php echo $result['OtherCatagoryCertificate']; ?></a></div>
  <div class="col-xs-3"><b> 8. Photocopy of registration card of class IX* :</b></div>
  <div class="col-xs-3"> <a href="../../Admission/DocumentsXIth/<?php echo $result['Regi_Crd_IX']; ?>" target="_blank"><?php echo $result['Regi_Crd_IX']; ?></a></div>
 </div> 
 <div class="row">
  <div class="col-xs-3"><b> 9. Photocopy of report card of class VIII :</b></div>
  <div class="col-xs-3"><a href="../../Admission/DocumentsXIth/<?php echo $result['Report_Crd_VIII']; ?>" target="_blank"><?php echo $result['Report_Crd_VIII']; ?></a></div>
  <div class="col-xs-3"><b> 10. Photocopy of report card of class IX (Final-Term)* :</b></div>
  <div class="col-xs-3"><a href="../../Admission/DocumentsXIth/<?php echo $result['Report_Crd_IX_FT']; ?>" target="_blank"><?php echo $result['Report_Crd_IX_FT']; ?></a></div>
 </div>
 <div class="row">
  <div class="col-xs-3"><b> 11. Photocopy of report card of class X (Term-I)* :</b></div>
  <div class="col-xs-3"><a href="../../Admission/DocumentsXIth/<?php echo $result['Report_Crd_X_T1']; ?>" target="_blank"><?php echo $result['Report_Crd_X_T1']; ?></a></div>
  <div class="col-xs-3"><b> 12. Fitness certificate from MBBS Doctor :</b></div>
  <div class="col-xs-3"><a href="../../Admission/DocumentsXIth/<?php echo $result['Fitness_Certi']; ?>" target="_blank"><?php echo $result['Fitness_Certi']; ?></a></div>
 </div>
 <div class="row">
  <div class="col-xs-3"> <b>13. Residence Proof* :</b></div>
  <div class="col-xs-3"><a href="../../Admission/DocumentsXIth/<?php echo $result['ResidenceProof']; ?>" target="_blank"><?php echo $result['ResidenceProof']; ?></a></div>
