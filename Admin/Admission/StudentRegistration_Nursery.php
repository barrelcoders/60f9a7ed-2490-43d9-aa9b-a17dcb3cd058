	...
	if(isset($_POST['BtnSubmit']))
{
	...
	$EmergencyEmail=$_POST['txtemergencyemail'];
        ...
        $BankName=$_POST['payorderbankname'];
        $BankBranch=$_POST['bankbranch'];
        $ChequeDate=$_POST['payorderdate'];
        $ChequeNo=$_POST['payordernumber'];
        $Amount=$_POST['payorderamount'];
  ...
  if(!empty($ChequeNo)){
     // echo "SELECT * FROM NewStudentRegistration_temp WHERE ChequeNo='".$ChequeNo."'";
      $checkPayOrderData=  mysql_query("SELECT * FROM NewStudentRegistration_temp WHERE ChequeNo='".$ChequeNo."'");
      $number_of_rows = mysql_num_rows($checkPayOrderData); 
     
      if($number_of_rows>0){ ?>
<span style="color: red; font-weight: bold;"><?php  echo "Pay Order Number already exist."; ?></span>
     ...
     <?php } else {
        ...
        . "`RegistrationPlace`,`ResidenceProofType`,`BankName`,`BankBranch`,`ChequeDate`,`ChequeNo`,`Amount`,`SibilingProof`,`GirlChild_FirstBorn`"
        ...
        . ",`motherothers`,`guardianbusiness`,`guardianpolitical`,`guardianministry`,`guardianprofssional`,`guardianservices`,`guardianothers`,`chkGirlChild_FirstBorn`,`Distance`) VALUES ('$RegistrationNo','$sname','$middlename','$slastname','$PlaceOfBirth','$DOB','$Age','$Sex','$MotherTongue','$Nationality','$sclass','$Location','$Twin_Triplet','$PermanentAddress','$PermanentPhoneNo','$ResidentialAddress','$ResidencePhoneNo','$sfathername','$sfatherage','$FatherEducation','$FatherDesignation','$FatherOccupation','$FatherCompanyName','$FatherMobileNo','$FatherEmailId','$FatherOfficeAddress','$FatherOfficePhoneNo','$MotherName','$MotherAge','$MotherEducation','$MotherDesignation','$MotherOccupatoin','$MotherCompanyName','$MotherMobile','$MotherEmail','$MotherOfficeAddress','$MotherOfficePhone','$GuradianName','$GuradianAge','$GuradinaEducation','$GuradianOccupation','$GuradianDesignation','$GuradianCompanyName','$GuradianMobileNo','$GuradianOfficialAddress','$GuradianOfficialPhNo','$GuardianEmailId','$Sibling','$Father_DPS_Alumni','$Mother_DPS_Alumni','$Single_Parent','$Special_Needs','$DPSRohiniStaff','$OtherDPSStaff','$RealBroSisName','$RealBroSisClass','$RealBroSisAdmissionNo','$RealBroSisName2','$RealBroSisClass2','$RealBroSisAdmissionNo2','$Single_Parent_Reason','$Other_single_parent','$AlumniFatherName','$AlumniSchoolName','$AlumniPassingYear','$AlumniFatherPassingClass','$AlumniMotherName','$AlumniMotherSchoolName','$AlumniMotherPassingYear','$AlumniMotherPassingClass','$SpecialNeedRequirment','$OtherSpecialNeed','$Category','$OtherCatagoryDetail','$EmergencyContactPersonName','$EmergencyContactNo','$EmergencyEmail','$BirthCertificate','$ProfilePhoto','$FatherPhoto','$MotherPhoto','$GuardianPhoto','$ParentDPSAlumni','$ParentDPSStaff','$CatagoryCertificate','$MedicalCertificate','$ResidenceProof','$RegistrationDate',"
        . "'$RegistrationPlace','$ResidenceProofType','$BankName','$BankBranch','$ChequeDate','$ChequeNo','$Amount','$SibilingProof','$GirlChild_FirstBorn'"
        . ",'$SingleParent','$fatherbusiness','$fatherpolitical','$fatherministry','$fatherprofssional','$fatherservices'"
        . ",'$fatherothers','$motherbusiness','$motherpolitical','$motherministry','$motherprofssional','$motherservices'"
        . ",'$motherothers','$guardianbusiness','$guardianpolitical','$guardianministry','$guardianprofssional','$guardianservices','$guardianothers','$chkGirlChild_FirstBorn','$Distance')");
...
$lastInsertedIdSQLReg=mysql_query("SELECT srno FROM NewStudentRegistration_temp ORDER BY srno DESC  LIMIT 1");
    ...
    $finalRegistrationNO="17000".$lastInsertSrnoReg;
...
<div id="container">
 <div class="row ">
  ...
  <div style="background-color: #0b462d; padding:2px 0; color:#FFFFFF;">
    <h4 align="center">APPLICATION FORM - Nursery (Session 2017 - 18)</h4>
  </div>
  <div class="info">
 ...
 <div class="col-xs-3 xs"> Enter Distance from school*: </div>
  <div class="col-xs-3 xs1"> <input type="number" name="txtLocality" id="txtLocality" class="text-box" required="true"  step="any"/></div>
  ...
  <div class="col-xs-3"><a href="https:www.freemaptools.com/how-far-is-it-between.htm" target="_blank">Click here to know the distance</a></div>
 ...
 <div class="row">
  ...
  <div class="col-xs-3"> <input name="txtFatherMobileNo" id="txtFatherMobileNo" class="text-box" type="tel"  pattern="[0-9]{10}" title="9999999999" ></div>
 </div>
 <div class="row">
 ...
 <div align="center"><strong><u>Father's Occupation</u></strong></div>
 <div class="row">
 ...
 <div align="center"><strong><u>Mother's Occupation</u></strong></div>
 <div class="row">
  <div class="col-xs-3">Business:</div>
 ...
 <div class="row">
  ...
  <div align="center"><strong><u>Guardian's Occupation</u></strong></div>
 <div class="row">
  <div class="col-xs-3">Business:</div>
 ...
 <div class="check check1" >
  <table>
   <tr> <td><input name="chkSibling" id="chkSibling" type="checkbox" value="30" onClick="javascript:fnlChkCategory('chkSibling');"></td> 
   		<td class="col1"><strong>Sibling(s) studying in DPS, Rohini</strong></td> </tr>
   <tr> <td><input name="chkgirlCategory" id="chkgirlCategory" type="checkbox" value="5" onClick="javascript:fnlChkCategory('chkgirlCategory');"></td>
   		<td><strong> Girl Child / First Born </strong></td> </tr>
   
  </table>
  <table>
   <tr> <td><input name="chkFatherAlumni" id="chkFatherAlumni" type="checkbox" value="10" onClick="javascript:fnlChkCategory('chkFatherAlumni');"></td> 
  ...
  <table> 
   <tr> <td><input name="chkMotherAlumni" id="chkMotherAlumni" type="checkbox" value="10" onClick="javascript:fnlChkCategory('chkMotherAlumni');"></td>
  ...
  <table>
   <tr> <td><input name="chkSpecialNeed" id="chkSpecialNeed" type="checkbox" value="1" onClick="javascript:fnlChkCategory('chkSpecialNeed');"></td>
 ...
 <div class="row">
  <div class="col-xs-6 xss"> <b>8. Copy Of ST/SC/OBC Certificate (if applicable) :</b></div>
  <div class="col-xs-6 xss1"> <input type="file" name="F9" > </div>
 </div>
  <div class="row">
  <div class="col-xs-6 xss"> <b>9. Copy of Medical Document/Certificate(if belongs to special need) (if applicable) :</b></div>
  <div class="col-xs-6 xss1"> <input type="file" name="F10" id="F10" disabled="true"> </div>
 </div>
 <div class="row">
  <div class="col-xs-6 xss"> <b>10. Residence Proof* :</b></div>
  <div class="col-xs-6 xss1"> <input type="file" name="F11" required="true"> </div> 
 </div>
 <div class="row">
  <div class="col-xs-1 xss">&nbsp;</div>
  <div class="col-xs-1 xss1"> <input type="radio" name="ResidenceProofType" value="Ration Card"> </div>
  <div class="col-xs-10 xss">Ration Card issued in the name of parents(mother / father having name of the child)</div> 
 </div>
 <div class="row">
  <div class="col-xs-1 xss">&nbsp;</div>
  <div class="col-xs-1 xss1"> <input type="radio" name="ResidenceProofType" value="Domicile"> </div>
  <div class="col-xs-10 xss">Domicile Certificate of child or his/her parents.</div> 
 </div>
  <div class="row">
  <div class="col-xs-1 xss">&nbsp;</div>
  <div class="col-xs-1 xss1"> <input type="radio" name="ResidenceProofType" value="Voter ID"> </div>
  <div class="col-xs-10 xss">Voter Identity Card / EPIC of any of the parents or child.</div> 
 </div>
  <div class="row">
  <div class="col-xs-1 xss">&nbsp;</div>
  <div class="col-xs-1 xss1"> <input type="radio" name="ResidenceProofType" value="Aadhar Card"> </div>
  <div class="col-xs-10 xss">Aadhar Card / Unique Identity Card of Mother / Father / Child issued by the Government of India.</div> 
 </div>
  <div class="row">
   <div class="col-xs-6 xss"><b> 11. Proof of Sibiling (Copy of last paid fee slip / ID Card of Sibiling (2016-17)) (if applicable):</b></div>
 ...
 <div class="row">
  ...
  <div> &nbsp;</div>
 <div class="h h11" align="center"><strong>PAY ORDER DETAILS</strong></div>
 <div>&nbsp;</div>
 <div class="row">
  <div class="col-xs-3"> Name of the Bank*:</div>
  <div class="col-xs-3"><select name="payorderbankname" id="payorderbankname" class="text-box tbs" required>
                            <option selected="" value="Select One">Select One</option>
		<?php
		while($row1 = mysql_fetch_row($rsBank))
		{
					$BankName=$row1[0];
		?>
  ...
  <div class="col-xs-3"><input type="text" name="bankbranch" id="bankbranch" class="text-box" required>
  <!--<select name="bankbranch" id="bankbranch" class="text-box tbs" required>
                            <option selected="" value="Select One">Select One</option>
 ...
 <div class="row">
  ...
  <div class="col-xs-3"><input type="Date" name="payorderdate" id="payorderdate" class="text-box" required>
	
  </div>
  <div class="col-xs-3 xs"> Pay Order Number*:</div>
  <div class="col-xs-3 xs1"> <input name="payordernumber" id="payordernumber" class="text-box" type="text" required></div>
 </div>
 <div class="row">
  <div class="col-xs-3"> Amount*: </div>
  <div class="col-xs-3"> <input name="payorderamount" id="payorderamount" type="text" value="25" class="text-box" readonly="true"></div>
  <div class="col-xs-6">&nbsp;</div>
 </div>
