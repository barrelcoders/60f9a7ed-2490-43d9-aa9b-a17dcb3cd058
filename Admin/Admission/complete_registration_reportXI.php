...
<body>
 ...
 <div class="btns">
  ...
  <div class="row">
   ...
   <div class="col-xs-6"><a href="complete_registration_reportXI.php"><button class="btn active">Complete Registration Report<font size="+1">&nbsp;&dArr;</font></button></a></div>

   <div class="col-xs-6"><a href="incomplete_registration_reportXI.php"><button class="btn">Incomplete Registration Report</button></a></div>
...
?>
							...
							<td style="border:1px solid #0b462d;"><a href="student_registration_XI_preview.php?ApplicationNo=<?php echo $reportData['RegistrationNo']; ?>" target="_blank"><?php echo $reportData['RegistrationNo']; ?></a></td>
