...
<div id="container">
 ...
 <form name="criteriaform" id="criteriaform" method="post" action="StudentRegistration_9th.php">
 ...
 <div class="row">
  ...
  <div class="col-xs-3 xs1"> <textarea name="txtpermanentAddress" id="txtpermanentAddress" class="text-box-address text-box tba" rows="2" required="true"></textarea></div>
...
<div align="center" class="h h11"><b><font >Enter your grades in Class VIII Term-I Exam</font></b></div>
 ...
 <div class="row">
  ...
  <div class="col-xs-3">IIIrd Language</div>
 ...
 <div class="row">
  <div class="col-xs-3 xs"> &nbsp; </div>
  <div class="col-xs-3 xs1">&nbsp;</div>
