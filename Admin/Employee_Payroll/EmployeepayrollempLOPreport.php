...
<div class="row c">
 <div class="col-md-2 hris1"> 
  ...
  <ul>
   ...
   <li class="active"><a href="EmployeepayrollempLOPreport.php"><button class="btnmanu">Employee LOP Days Report</button></a></li>
...
<!--------------Details------------------>
 <div class="col-md-10"> 
  <div class="empl-top">Employee LOP Report</div>
  ...
  <form action="" method="post" id="form" >
   <div class="row">
    ...
    <div class="col-xs-3"> <select name="emplopemptype" id="emplopemptype" class="text-box tbs">
    					   	<option value="">Select One</option>
                            <option value=""></option>
                           </select>
    </div>
   ...
   <!------------------Table------------------------->
    ...
    <style>
     ...
     <div align="center" style="font-size:16px; font-weight:600; margin-bottom:1%; ">LOP Details for Teaching Staff  for the month of Jun  </div>
     <div class="tableem">
     <table>
      <tr class="col">
       <td width="10px;">S.No.</td> <td width="150px;">Employee Id.</td> <td width="250px;">Employee Name</td> <td>Month</td> <td>Total No Of Days</td> <td>LOP Day</td> <td>Previous Month Arrear</td> <td>Total Payable Days</td>
      </tr>
      <tr> <td width="10px;">S.No.</td> <td>Employee Code</td> <td width="250px;">Name</td> <td>Month</td> <td>ESI Amount</td><td>ABC</td><td>DDD</td><td>SSS</td> </tr>
      <tr> <td width="10px;">S.No.</td> <td>Employee Code</td> <td width="250px;">Name</td> <td>Month</td> <td>ESI Amount</td><td>ABC</td><td>DDD</td><td>SSS</td> </tr>
     </table>
     </div>
