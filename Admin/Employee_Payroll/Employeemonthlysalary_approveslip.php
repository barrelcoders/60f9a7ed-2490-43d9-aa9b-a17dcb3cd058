...
<div class="row c">
 <div class="col-md-2 hris1"> 
  ...
  <ul>
   ...
   <li class="active"><a href="Employeemonthlysalary_approveslip.php"><button class="btnmanu">Approve Salary Slip</button></a></li>
  ...
  <form action="" method="post" id="form" >
   ...
   <!------------------Table------------------------->
    ...
    <style>
     ...
     <table id="table1">
      <tr class="col">
       <td>S.No.</td><td>Emp.Id</td> <td>Name</td><td>Deptt.</td><td>Desg.</td><td>Grade Pay</td><td>Pay Band</td><td>Gross Salary</td><td>DA</td><td>PF</td><td>ESI</td><td>TDS</td><td>Total Days</td><td>Days Present</td><td>Days Leave</td><td>Days(LOP)</td><td>Net Salary</td><td>LOP</td><td>Net Payout</td><td>Remarks</td><td>Approval</td><td>Reject</td>
      </tr>
      <tr>
