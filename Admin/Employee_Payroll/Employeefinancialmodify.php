...
<div class="row c">
 <div class="col-md-2 hris1"> 
  <h4>SELF SERVICE</h4>
  <ul>
   <li><a href="Employeefinancial.php"><button class="btnmanu">Define Employee Salary</button></a></li>
   <li class="active"><a href="Employeefinancialmodify.php"><button class="btnmanu">Modify Employee Salary</button></a></li>
  </ul>
 </div>
<!--------------Details------------------>
 <div class="col-md-10">
