...
<head>
 <meta charset='utf-8'>
   ...
   <title> </title><link rel="icon" href="../Hris/l.png" type="image/x-icon">
...
<div class="row c">
 ...
 <!----------table1------------->
  <div class="investment1">Chapter Via - Section 80D To 80U
  			<div class="active" style="text-align:right; margin-top:-2%; margin-right:1%">
            	<input type="checkbox" name="active" id="active">&nbsp;&nbsp;&nbsp;Active</div>
  </div>
