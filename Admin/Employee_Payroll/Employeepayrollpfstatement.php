...
<div class="row c">
 <div class="col-md-2 hris1"> 
  ...
  <ul>
   ...
   <li class="active"><a href="Employeepayrollpfstatement.php"><button class="btnmanu">PF Statement</button></a></li>
...
<!--------------Details------------------>
 <div class="col-md-10"> 
  <div class="empl-top">Provident Fund Statement</div>
  ...
  <form action="" method="post" id="form" >
   ...
   <!------------------Table------------------------->
    ...
    <style>
     ...
     <table>
      <tr class="col">
       <td width="10px;">S.No.</td> <td width="150px;">Employee Code</td> <td width="250px;">Name</td> <td>Month</td> <td width="450px;">Provident Fund Amount - Employee Contributio</td>
      </tr>
      <tr> <td width="10px;">S.No.</td> <td>Employee Code</td> <td width="250px;">Name</td> <td>Month</td> <td>PF Amount</td> </tr>
      <tr> <td width="10px;">S.No.</td> <td>Employee Code</td> <td width="250px;">Name</td> <td>Month</td> <td>PF Amount</td> </tr>
