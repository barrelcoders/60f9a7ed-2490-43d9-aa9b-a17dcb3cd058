...
$ssqlDiscount="SELECT distinct `discounttype` FROM `discounttable`";
...
function ValidateTransport()
{
	...
	{	
		...
		document.getElementById("cboRoute").value="";
	}
}
...
<img height="30" src="images/BackButton.png" width="70" class="auto-style31" style="float: right"></font></a></p>
	...
	<tr>
		...
		<select name="cboClass" id="cboClass" style="height: 22px" class="auto-style25">
		...
		<option value="LKG" <?php if ($sclass=="LKG") {?>selected="selected" <?php } ?> >
		LKG</option>

		<option value="UKG" <?php if ($sclass=="UKG") {?>selected="selected" <?php } ?> >
		U.K.G</option>
