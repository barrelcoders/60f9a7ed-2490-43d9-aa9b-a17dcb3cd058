...
<title>Student Aadhar Certificate</title>
...
<body>
<form name="frmCertificate" id="frmCertificate" method="post" action="SubmitStudentAadharCertificate.php">
<p>&nbsp;</p>
<p><b><font face="Cambria" size=3>Issue Aadhar Certificate</font></b></p>
<hr>
<p>&nbsp;</p>
...
<font face="Cambria" size="3"><u> Aadhar Certificate</u></font></h3>
...
resident of <?php if(isset($_POST['FillDetail'])) {   echo $rs['Address']; } ?> is / has been a bonafide student of our school during the session .</font></p>

<p>
<font face="Cambria">As per School records his / her details are as follows:</font></p>
<table border="1" width="433" cellspacing="0" cellpadding="0" style="border-collapse: collapse">
	<tr>
		<td width="203"><b><font face="Cambria">Admission No</font></b></td>
		<td width="227"><?php if(isset($_POST['FillDetail'])) {   echo $rs['sadmission']; } ?></td>
	</tr>
	<tr>
		<td width="203"><b><font face="Cambria">Father&#39;s Name</font></b></td>
		<td width="227"><?php if(isset($_POST['FillDetail'])) {   echo $rs['sfathername']; } ?></td>
	</tr>
	<tr>
		<td width="203"><b><font face="Cambria">Mother&#39;s Name</font></b></td>
		<td width="227"><?php if(isset($_POST['FillDetail'])) {   echo $rs['MotherName']; } ?></td>
	</tr>
	<tr>
		<td width="203"><b><font face="Cambria">Address</font></b></td>
		<td width="227"><?php if(isset($_POST['FillDetail'])) {   echo $rs['Address']; } ?></td>
	</tr>
	<tr>
		<td width="203"><b><font face="Cambria">Date Of Birth</font></b></td>
		<td width="227"><?php if(isset($_POST['FillDetail'])) {   echo $rs['DOB']; } ?></td>
	</tr>
</table>


<font face="Cambria">
<br /></font><b><font face="Cambria" size="3">Sd/-</font></b><p><b><font face="Cambria" size="3">Principal</font></b></p>
