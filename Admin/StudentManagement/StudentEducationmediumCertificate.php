...
<title>Student Education Medium Certificate</title>
...
<body>
<form name="frmCertificate" id="frmCertificate" method="post" action="SubmitStudentEducationmediumCertificate.php">
<p>&nbsp;</p>
<p><b><font face="Cambria" size=3>Issue Student Education Medium Certificate</font></b></p>
<hr>
<p>&nbsp;</p>
...
&nbsp;S/D/O Mr. / Mrs.<b>
<?php if(isset($_POST['FillDetail'])) {   echo $rs['sfathername']; } ?>,</b> has been a bonifide student of this school since <?php if(isset($_POST['FillDetail'])) {   echo $rs['DateOfAdmission']; } ?> 
and is presently studying in class <?php if(isset($_POST['FillDetail'])) {   echo $rs['sclass']; } ?> As per the school records her school her date of birth 
<?php if(isset($_POST['FillDetail'])) {   echo $rs['DOB']; } ?> and her present residential address is as under:<?php if(isset($_POST['FillDetail'])) {   echo $rs['Address']; } ?></font></p>




<font face="Cambria">
<br /></font><b><font face="Cambria" size="3"></font></b><p><b><font face="Cambria" size="3">Vice Principal</font></b></p>
