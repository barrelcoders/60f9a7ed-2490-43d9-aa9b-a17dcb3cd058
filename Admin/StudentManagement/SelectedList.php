...
?>
<?php
$rs=mysql_query("select `RegistrationNo`,CONCAT(`sname`,' ',`slastname`) as `student_name`,`sfathername`,`MotherName`,`ProfilePhoto`,`Sex`,`sclass` from `NewStudentRegistration` where `DrawOfLots`='Selected' order by `SystemDateTime` asc ");
...
<table style="width: 70%" class="style1" align="center">
	...
	<table>
	<tr>
		<td class="style3" colspan="3" style="border-style: none; border-width: medium"><strong>
		Draw of Lots - List of selected candidates</strong></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="style5" style="width: 621px; border-left-style:solid; border-left-width:1px; border-right-style:none; border-right-width:medium; border-top-style:solid; border-top-width:1px; border-bottom-style:solid; border-bottom-width:1px"><strong>
		Enter Registration No.</strong></td>
