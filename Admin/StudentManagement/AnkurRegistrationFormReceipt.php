...
$currentdate=date("Y-m-d");
		...
		$sqlRcpt = "SELECT MAX(`srno`) FROM  `RegistrationFees`";
		...
		$PDFFileName=$NewReciptNo . ".pdf";
			...
			$ssql="INSERT INTO `RegistrationFees` (`FormNo` ,`sname`, `sclass`,`FatherName`,`ContactNo`,`EmailId`,`Address`,`RegistrationFeePayable`,`Discount`,`RegistrationFeePaid`,`date`,`DateOfExam`,`TimeOfExam`) VALUES ('$FormNo','$StudentName','$Class','$FatherName','$ContactNo','$EmailId','$Address','$AdmissionFees','$RegistrationFeesDiscount','$TotalAmtPaying','$currentdate','$DateofExam','$TimeofExam')";
...
<div id="MasterDiv" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px" >
	...
	<p align=center> <b><font face="Cambria" style="font-size: 15pt"> <?php echo $SchoolAddress ; ?></font><font face="Cambria" style="font-size: 20pt">Ankur</font></b><p align=center> 
	<font face="Cambria" style="font-size: 15pt"><b>(A Nursery Wing of Jain 
	Public School)</b></font><br><p align=center> Phone No: <?php echo $SchoolPhoneNo; ?><br></p><p align="center" ><b><font face="Cambria">Registration Fees 
