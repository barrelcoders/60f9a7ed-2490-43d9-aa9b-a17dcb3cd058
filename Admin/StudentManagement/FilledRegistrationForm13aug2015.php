...
<ul>
	...
	Registration is 19th Aug, 2015.</strong></p>
		...
		<input name="txtName" id="txtName" type="text" class="text-box" value="<?php echo $sname;?>"></font></td>
		...
		<input name="txtDOB" id="txtDOB" type="text" class="tcal" value="<?php echo $DOB;?>" ></font></td>
				...
				<input name="txtPlaceOfBirth" id="txtPlaceOfBirth" class="text-box" type="text" value="<?php echo $PlaceOfBirth;?>"></font></td>
		...
		<input name="txtLastName" id="txtLastName" type="text" class="text-box" size="20" value="<?php echo $slastname;?>"></font></td>
		...
		&nbsp;</td>
			...
			<tr>
				...
				<input name="txtAge" id="txtAge" type="text" class="text-box" value="<?php $Age;?>"  readonly="readonly"></font></td>
				<td style="width: 3%" class="auto-style11">
				&nbsp;</td>
				<td style="width: 159px" class="auto-style11" colspan="2">
		...
		<input name="txtSex" id="txtAge" type="text" class="text-box" value="<?php echo $Sex;?>"  readonly="readonly"></td>
				...
				<input name="txtMotherTounge" id="txtMotherTounge" class="text-box" value="<?php echo $MotherTongue;?>" type="text"></font></td>
		...
		<input name="txtNationality" id="txtNationality" type="text" class="text-box" value="<?php echo $Nationality;?>"></font></td>
		...
		<font face="Cambria">8. Class
				...
				<input name="cboClass" id="txtNationality" type="text" class="text-box" value="<?php echo $sclass;?>"></td>
		...
		<input name="txtLastSchool" id="txtLastSchool" type="text" class="text-box" value="<?php echo $LastSchool;?>"></font></td>
		...
		<input name="cboLocation" id="txtLastSchool" type="text" class="text-box" value="<?php echo $Location;?>"></font></td>
		...
		<input name="txtFatherName" id="txtFatherName" type="text" value="<?php echo $sfathername;?>"  class="text-box"></font></td>
		...
		<font face="Cambria">
		<input name="txtFatherAge" id="txtFatherAge" class="text-box" value="<?php echo $sfatherage;?>" type="text"></font></td>
			</tr>
		...
		<font face="Cambria">
		<input   class="text-box" value="<?php echo $FatherEducation;?>" type="text"></font></td>
		...
		<font face="Cambria">
		<input   class="text-box" value="<?php echo $FatherQualificationDuration;?>" type="text" ></font></td>
					</tr>
				</table>
				</td>
		...
		<input name="txtFatherOccupation" id="txtFatherOccupation" type="text" value="<?php echo $FatherOccupation;?>" class="text-box"></font></td>
		...
		<input name="txtFatherDesignation" id="txtFatherDesignation" value="<?php echo $FatherDesignation;?>" class="text-box" type="text"></font></td>
				<td style="width: 157px" class="auto-style11">
				&nbsp;</td>
				<td style="width: 28px" class="auto-style11">
				&nbsp;</td>
		...
		<font face="Cambria">
		<input id="" value="<?php echo $FatherAnnualIncome;?>" class="text-box" type="text"></font></td>
			</tr>
			<tr>
				<td style="width: 212px" class="auto-style11">
		&nbsp;</td>
		...
		<span class="auto-style25"><font face="Cambria">Father's Company Name :</font></span></td>
				<td style="width: 172px" class="auto-style11">
		<font face="Cambria">
		<input name="txtFatherCompanyName" id="txtFatherCompanyName" value="<?php echo $FatherCompanyName;?>" class="text-box" type="text"></font></td>
				<td style="width: 157px" class="auto-style11">
				&nbsp;</td>
				<td style="width: 28px" class="auto-style11">
				&nbsp;</td>
		...
		Address :</font></span></td>
				<td style="width: 158px" class="auto-style11">
		<font face="Cambria">
		<textarea name="txtFatherOfficialAddress" id="txtFatherOfficialAddress" value="<?php echo $FatherOfficeAddress;?>" class="text-box-address" cols="16" rows="2"></textarea></font></td>
			</tr>
			<tr>
			<td style="width: 212px" class="auto-style11">
		&nbsp;</td>
		...
		no :</font></span></td>
				<td style="width: 172px" class="auto-style11">
		<font face="Cambria">
		<input name="txtFatherOfficialPhNo" value="<?php echo $FatherOfficePhoneNo;?>" id="txtFatherOfficialPhNo" class="text-box" type="text"></font></td>
				<td style="width: 157px" class="auto-style11">
				&nbsp;</td>
				<td style="width: 28px" class="auto-style11">
		...
		<font face="Cambria">Father's Mobile No *:</font></td>
				<td style="width: 158px" class="auto-style11">
		<font face="Cambria">
		<input name="txtFatherMobileNo" id="txtFatherMobileNo" value="<?php echo $FatherMobileNo;?>" class="text-box" type="text" size="20"></font></td>
			</tr>
			<tr>
				<td style="width: 212px" class="auto-style11">
		&nbsp;</td>
		...
		<font face="Cambria">Father's Email Id *:</font></td>
				<td style="width: 172px" class="auto-style11">
		<font face="Cambria">
		<input name="txtFatherEmailId" id="txtFatherEmailId" value="<?php echo $FatherEmailId;?>" class="text-box" type="text" size="20"></font></td>
...
<p style="page-break-before: always">
		...
		<input name="txtMotherName" id="txtMotherName" type="text" value="<?php echo $MotherName;?>" class="text-box"></font></td>
		...
		<input name="txtMotherAge" id="txtMotherAge" class="text-box" value="<?php echo $MotherAge;?>" type="text"></font></td>
		...
		<input name="" id="" type="text" value="<?php echo $MotherEducation;?>" class="text-box"></font>
		...
		<input name="" id="" class="text-box" value="<?php echo $MotherQualificationDuration;?>" type="text"></font></td>
					</tr>
				</table>
				</td>
		...
		<input name="txtMotherOccupation" id="txtMotherOccupation" class="text-box" value="<?php echo $MotherOccupatoin;?>" type="text"></font></td>
		...
		<input name="txtMotherDesignation" id="txtMotherDesignation" value="<?php echo $MotherDesignation;?>" class="text-box" type="text"></font></td>
		...
		<input name="" id="" value="<?php echo $MontherAnnualIncome;?>" class="text-box" type="text"></font></td>
			</tr>
			<tr>
				<td style="width: 212px" class="auto-style11">
	</td>
...
&nbsp;&nbsp;</td>
		...
		<input name="txtMotherCompanyName" id="txtMotherCompanyName" value="<?php echo $MotherCompanyName;?>" type="text" class="text-box"></font></td>
		...
		<textarea name="txtMotherOfficialAddress" id="txtMotherOfficialAddress" class="text-box-address" value="<?php echo $MotherOfficeAddress;?>" cols="16" rows="2"></textarea></font></td>
		...
		<input name="txtMotherOfficialPhNo" id="txtMotherOfficialPhNo" value="<?php echo $MotherOfficePhone;?>" class="text-box" type="text"></font></td>
		...
		<input name="txtMotherMobileNo" id="txtFatherOfficialPhNo1" class="text-box" value="<?php echo $MotherMobile;?>" type="text" size="20"></font></td>
		...
		<input name="txtMotherEmailId" id="txtFatherOfficialPhNo2" class="text-box" value="<?php echo $MotherEmail;?>"  type="text" size="20"></font></td>
...
<p style="page-break-before: always">
		...
		<input name="txtGuradianName" id="txtGuradianName" type="text" value="<?php echo $GuradianName;?>" class="text-box" size="20"></font></td>
		...
		<input name="txtGuradianAge" id="txtGuradianAge" class="text-box" type="text" value="<?php echo $GuradianAge;?>" size="20"></font></td>
		...
		<input name="txtGuradinaEducation" id="txtGuradinaEducation" type="text" value="<?php echo $GuradinaEducation;?>" class="text-box" size="20"></font></td>
		...
		<input name="txtGuradianOccupation" id="txtGuradianOccupation" class="text-box" value="<?php echo $GuradianOccupation;?>" type="text" size="20"></font></td>
		...
		<input name="txtGuradianDesignation" id="txtMotherDesignation0" class="text-box" value="<?php echo $GuradianDesignation;?>" type="text" size="20"></font></td>
		...
		<input name="txtGuradianAnnualIncome" id="txtMotherAnnualIncome0" class="text-box" value="<?php echo $GuradianAnnualIncome;?>" type="text" size="20"></font></td>
		...
		<input name="txtGuradianCompanyName" id="txtMotherCompanyName0" value="<?php echo $GuradianCompanyName;?>" type="text" class="text-box" size="20"></font></td>
		...
		<textarea name="txtGuradianOfficialAddress" id="txtMotherOfficialAddress0" value="<?php echo $GuradianOfficialAddress;?>" class="text-box-address" class="text-box-address" cols="20" rows="2"></textarea></font></td>
		...
		<input name="txtGuradianOfficialPhNo" id="txtMotherOfficialPhNo0" value="<?php echo $GuradianOfficialPhNo;?>" class="text-box" type="text" size="20"></font></td>
		...
		<input name="txtGuradianMobileNo" id="txtFatherOfficialPhNo4" class="text-box" value="<?php echo $GuradianMobileNo;?>" type="text" size="20"></font></td>
		...
		<input name="" id="" class="text-box" value="<?php echo $TransportAvail;?>" type="text" size="20"></font></td>
		...
		<input name="" id="" class="text-box" value="<?php echo $SafeTransport;?>" type="text" size="20"></font></td>
			</tr>
			<tr>
				<td style="width: 212px; border-bottom-style:solid; border-bottom-width:1px" class="auto-style11">
		&nbsp;</td>
		...
		<table style="width: 100%" cellpadding="0" class="style15">
			...
			<tr>
				...
				<input name="chkSibling" id="chkSibling" type="checkbox" value="<?php echo $Sibling;?>" <?php if($Sibling=="Yes") { ?>checked="checked" <?php }?>></td>
				<td style="border-style:solid; border-width:1px; width: 178px" class="style23">
				<input name="chkFatherAlumni" id="chkFatherAlumni" type="checkbox" value="<?php echo $Father_DPS_Alumni;?>" <?php if($Father_DPS_Alumni=="Yes") { ?>checked="checked" <?php }?>></td>
				<td style="border-style:solid; border-width:1px; width: 178px" class="style23">
				<input name="chkMotherAlumni" id="chkMotherAlumni" type="checkbox" value="<?php echo $Mother_DPS_Alumni;?>" <?php if($Mother_DPS_Alumni=="Yes") { ?>checked="checked" <?php }?>></td>
				<td style="border-style:solid; border-width:1px; width: 179px" class="style23">
				<input name="chkSingleParent" id="chkSingleParent" type="checkbox" value="<?php echo $Single_Parent;?>" <?php if($Single_Parent=="Yes") { ?>checked="checked" <?php }?>></td>
				<td style="border-style:solid; border-width:1px; width: 179px" class="style23">
				<input name="chkSpecialNeed" id="chkSpecialNeed" type="checkbox" value="<?php echo $Special_Needs;?>" <?php if($Special_Needs=="Yes") { ?>checked="checked" <?php }?>></td>
				<td style="border-style:solid; border-width:1px; width: 179px" class="style23">
				<input name="chkDPSStaff" id="chkDPSStaff" type="checkbox" value="<?php echo $Staff;?>" <?php if($Staff=="Yes") { ?>checked="checked" <?php }?>></td>
				<td style="border-style:solid; border-width:1px; width: 179px" class="style23">
				<input name="chkOtherCategory" id="chkOtherCategory" type="checkbox" value="<?php echo $OtherCategory;?>" <?php if($OtherCategory=="Yes") { ?>checked="checked" <?php }?>></td>
			</tr>
		</table>
		</td>
		...
		<input name="txtRealBroSisName" id="txtRealBroSisName" class="text-box" type="text" value="<?php echo $RealBroSisName;?>" readonly="readonly"></font></td>
		...
		<input name="txtRealBroSisClass" id="txtRealBroSisClass" class="text-box" type="text" value="<?php echo $RealBroSisClass;?>" readonly="readonly"></font></td>
		...
		<input name="txtRealBroSisSchoolName" id="txtRealBroSisSchoolName" class="text-box" value="<?php echo $RealBroSisAdmissionNo;?>" type="text" readonly="readonly"></font></td>
		...
		<input name="txtFatherAlumniName" id="txtFatherAlumniName" class="text-box" type="text" value="<?php echo $AlumniFatherName;?>" size="20" readonly="readonly"></font></td>
		...
		<input name="" id="" class="text-box" type="text" value="<?php echo $AlumniSchoolName;?>" size="20" readonly="readonly"></font></td>
...
<tr>			
		...
		<input name="txtEmergencyNo" id="txtEmergencyNo"  class="text-box" value="<?php echo $EmergencyContactNo;?>" onKeyPress="return isNumberKey(event)"  pattern="[0-9]{10}" type="text"></font></td>
		...
		<input name="txtMobile" id="txtMobile" type="text" class="text-box" value="<?php echo $RegistrationFormNo;?>" onKeyPress="return isNumberKey(event)"  pattern="[0-9]{10}" style="width: 143px"></font></td>
		...
		<input name="txtemail" id="txtemail" type="text" value="<?php echo $email;?>" class="text-box"></font></td>
		...
		<img src="../../StudentRegistrationPhotos/<?php echo $BirthCertificate;?>" width="100" height="100">
		<p>
		<font face="Cambria">
		<p style="page-break-before: always">
		2. Child Photograph :<br>
		</font>
		<img src="../../StudentRegistrationPhotos/<?php echo $ProfilePhoto;?>" width="400" height="400">
		<p>
		...
		{
		?>
		<img src="../../StudentRegistrationPhotos/<?php echo $ScoreCard;?>" width="400" height="400">
		<?php
		}
		?>
		</td>
		...
		<input type="text" name="T1" value="<?php echo $routeno;?>" size="20"><p><b><font face="Cambria">
