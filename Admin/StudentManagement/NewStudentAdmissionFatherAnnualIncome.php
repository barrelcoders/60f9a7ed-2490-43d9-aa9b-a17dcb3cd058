	        ...
	        `EmergencyContactNo`, `RegistrationFormNo`, `email`, `routeno`, `ProfilePhoto`, `status`, `Remarks`, `quarter`, `FinancialYear`, `SchoolId`,
	         `TxnAmount`, `TxnId`, `TxnStatus`, `PGTxnId`, `BirthCertificate`, `ScoreCard`, `SystemDateTime`, `L1Remarks`, `L1ApprovalStatus`, `L2Remarks`,
	          `L2ApprovalStatus`, `L3Remarks`, `L3ApprovalStatus`, `FatherPhoto`, `MotherPhoto`, `AddressProofPhoto`, `MedicalCertificatePhoto`
	           FROM `NewStudentAdmission` WHERE `FatherAnnualIncome`<='1 Lakh to 2 Lakhs'";
...
<form name="frmRpt" method="post" action="NewStudentAdmissionFatherAnnualIncome.php">
...
<td style="width: 31px" font="Cambria"><a href="http://dpsfsis.com/StudentRegistrationPhotos/<?php echo $row[84];?>" target="_blank">
Show Photo.</a></td>
<td style="width: 31px" font="Cambria"><a href="http://dpsfsis.com/StudentRegistrationPhotos/<?php echo $row[103];?>" target="_blank">
Show Photo.</a></td>
<td style="width: 31px" font="Cambria"><a href="http://dpsfsis.com/StudentRegistrationPhotos/<?php echo $row[104];?>" target="_blank">
Show Photo.</a></td>
<td style="width: 31px" font="Cambria"><a href="http://dpsfsis.com/StudentRegistrationPhotos/<?php echo $row[94];?>" target="_blank">
Show Doc.</a></td>
<td style="width: 31px" font="Cambria"><a href="http://dpsfsis.com/StudentRegistrationPhotos/<?php echo $row[106];?>" target="_blank">
Show Doc.</a></td>
<td style="width: 31px" font="Cambria"><a href="http://dpsfsis.com/StudentRegistrationPhotos/<?php echo $row[105];?>" target="_blank">
Show Doc.</a></td>
<td style="width: 31px" font="Cambria"><a href="FilledAdmissionForm.php?sadmission=<?php echo $row[4];?>" target="_blank"><?php echo $row[4];?></a></td>
...
<td style="width: 48px" font="Cambria"><a href="http://dpsfsis.com/StudentRegistrationPhotos/<?php echo $row[89];?>" target="_blank"><?php echo $row[95];?></a></td>
