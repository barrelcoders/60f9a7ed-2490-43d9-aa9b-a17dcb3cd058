...
?>
<?php
$rs=mysql_query("SELECT CONCAT(`sname`,' ',`slastname`) as `ApplicantName`,`sfathername`,`RegistrationNo`,`Sex` FROM `NewStudentRegistration` where `FatherAnnualIncome` IN ('1 Lakh to 2 Lakhs','Less than 1 Lakh') and `sclass`='NURSERY' and `Sex`='Female' ORDER BY `srno` DESC ");
