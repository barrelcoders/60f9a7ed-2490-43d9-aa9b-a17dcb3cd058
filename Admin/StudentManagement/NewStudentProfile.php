...
<table style="width: 100%; " class="style8" cellpadding="0" height="31">
	<tr>
		...
		<span class="style1">
		<font face="Cambria" style="font-size: 11pt"><strong>Student Details</strong></font></span></a></td>
		...
		<span style="font-size: 11pt">Student Remarks</span></font></a></b></font></td>
		...
		<font face="Cambria" style="font-size: 11pt"><span class="style12">Fees 
		Details</span> </font>
		</a>
		</b>
		</td>
		...
		<a href="../CCE/FinalReportcardTerm1Class6toClass10.php" ><span >
		<font face="Cambria" style="font-size: 11pt; font-weight:700"><span class="style12">
		Report Card</span></font></span></a></td>
	...
	<tr>
		<td>
					...
					<tr>
						...
						<font face="Cambria">(If you have changed your address, 
						please update)</font></td>
				...
				<tr>
						...
						<font face="Cambria">(Please update - If required)</font></span></td>
				...
				<tr>
						...
						<font face="Cambria">(If you change your current 
						password then your password will be reset)</font></span></td>
				...
				<tr>
					...
					<table border="1" width="100%" style="border-collapse: collapse" bordercolor="#000000">
						...
						<tr>
							...
							<td height="35" align="center" style="width: 242px">
							&nbsp;</td>
			
			
			
							<td height="35" align="center" style="width: 1571px">
							&nbsp;</td>
			
			
			
							<td height="35" align="center" style="width: 631px">
							&nbsp;</td>
...
<?php
	...
	$ssql="SELECT `sadmisson`, `sname`, `sclass`, `srollno`, `sfathername`, `smothername`, `FYear`, `CGPASem1`, `CGPASem2`, `CGPAOverall`, `ConceptWorkHabits`, `AttitudeBehaviour`, `ExtraCurricular`, `SpecialTalent`, `LongLeaveReason`, `SpecialIncident`, `EmpId`, `DateOfEntry`, `SystemDateTime` FROM `StudentDossier` WHERE `sadmisson`='$sadmission'";
	$rs = mysql_query($ssql);
	?>
			...
			<tr>
				...
				<?php
					...
					<tr>
						<td height="35" width="314" align="left">
						<span style="font-family: Cambria; font-size: 15px; font-weight: normal; font-style: normal; text-decoration: none; color: #000000">
						Extra Curricular Activities</span></td>
						<td height="35" width="956" align="center">
						<span style="font-family: Cambria; font-size: 15px; font-weight: normal; font-style: normal; text-decoration: none; color: #000000">
					...
					<tr>
						...
						<td height="35" width="314" align="left">
						<span style="font-family: Cambria; font-size: 15px; font-weight: normal; font-style: normal; text-decoration: none; color: #000000">
						Any special incident and measures takes</span></td>
						<td height="35" width="956" align="center">
