...
$ssql="select `sadmission`,`sname`,`sclass`,`srollno` from `student_master` where `sadmission`='$sadmission'";
$rs= mysql_query($ssql);
	while($row1 = mysql_fetch_row($rs))
		...
		$ssql="insert into `student_certificate` (`sadmission`,`sname`,`sclass`,`srollno`,`certificate_type`,`generation_date`,`financial_year`,`html_code`) values ('$sadmission','$sname','$sclass','$srollno','Bonafide','$currentdate','$CurrentFY','$varhtml')";
		//echo $ssql;
		//exit();
