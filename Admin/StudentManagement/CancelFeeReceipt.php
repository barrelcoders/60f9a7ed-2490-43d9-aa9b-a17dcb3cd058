...

{
		...
		$TotalAmt= $_REQUEST["txtTotalRefundAmt"];
		...
		if ($_REQUEST["txtRefundSecurityFee"] != "")

		{

			$SecurityFeeAmt = $_REQUEST["txtRefundSecurityFee"];
		...
		if ($_REQUEST["txtRefundDiscount"] != "")

		{

			$Discount = $_REQUEST["txtRefundDiscount"];
		...
		//$TotalAmt = $AdmissionFee + $SecurityFeeAmt - $Discount - $RefundAdmissionFee;
...

		{
			...
			$ssql="UPDATE `AdmissionFees` SET `cancelamount`='$TotalRefundAmt',`$canceldate`=CURDATE(),`status`='CANCEL' where `receipt`='$ReceiptNo'";
			...
			$Message1="<br><br><center><b>Admission Fee Cancellation successfully completed!";
...
<div id="MasterDiv" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px">
	...
	<img border="0" src="../images/emerald_logo.png" class="auto-style4"></p>

	<p align="center" class="auto-style3"><? php echo $SchoolAddress ?>&nbsp;</p>
	...
	<div align="center">
		...
		<table border="1" cellspacing="0" cellpadding="0" style="width: 39%">
			...
			<tr>
				...
				<b><font face="Calibri">Security Amount</font></b></td>
