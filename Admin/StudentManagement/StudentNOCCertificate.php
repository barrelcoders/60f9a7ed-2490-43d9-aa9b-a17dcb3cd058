...
<body>
<form name="frmCertificate" id="frmCertificate" method="post" action="SubmitStudentNOCCertificate.php">
<p>&nbsp;</p>
...
been a bonifide student of this school 
and is presently studying in class <?php if(isset($_POST['FillDetail'])) {   echo $rs['sclass']; } ?> 
It is futher certified that the school has no object to her going abroad
during the period from <font size="3" face="Cambria"> <font size="3" face="Cambria"> <input type="text" name="txtSession" id="txtSession"></font></font> to <font size="3" face="Cambria"> <font size="3" face="Cambria"> <input type="text" name="txtSession1" id="txtSession1"></font></font></font></p>
