...
if($_REQUEST["txtUserId"] !="")
{
	...
	$Pwd=$_REQUEST["txtPwd"];
	//echo "select `Password4AdmissionFee` from `NewStudentRegistration` where `RegistrationNo`='$UserId'";
	//exit();
	...
	if (mysql_num_rows($rsUser) > 0)
	{
		...
		//echo $DatabasePwd."/".$Pwd;
		//exit();
		if($DatabasePwd != $Pwd)
		{
			$msg="<br><br><center><b>User Id / Password does not match, Please try again!";
			echo $msg;
			exit();
		}
		else
...
{
	echo "<br><center><b>Direct Access! <br>Please click <a href='RegistrationLogin.php'>here</a> to login";
	exit();
}

	//$SelectedRegistrationNo=$_REQUEST["RegNo"];
	$SelectedRegistrationNo=$UserId;
	/*
	if($_SESSION['userid'] =="")
	{
		echo "<br><center><b>Direct Access! <br>Please click <a href='RegistrationLogin.php'>here</a> to login";
...
<script language="javascript">
	function Validate()
	{
		if(document.frmAdmission.F1.value =="")
		{
			alert("Father's Photo is mandatory!");
			return;
		}
		if(document.frmAdmission.F2.value =="")
		{
			alert("Mother's Photo is mandatory!");
			return;
		}
		if(document.frmAdmission.F3.value =="")
		{
			alert("Address proof photo is mandatory!");
			return;
		}
		document.getElementById("frmAdmission").submit();
	}
	function printDiv() 
	{
...
<font face="cambria"><b><?php echo $SchoolAddress; ?></b></font>
	...
	<font face="cambria"><b>Email Id: <?php echo $SchoolEmailId; ?></b></font>
		...
		<tr>
		<td style="height: 10; " class="style28">
<strong><font face="Cambria" style="font-size: 14pt">Admission</font></strong><font face="Cambria" style="font-size: 14pt"><strong> - Session 
...
<ul>
	...
	<font face="Cambria">This is an Admission Form.</font></strong></p></li>
</ul>
		</td>
...
<form name="frmAdmission" id="frmAdmission" method="post" action="AdmissionFeeReceiptPaymentCounter.php" enctype="multipart/form-data">
<input type="hidden" name="hRegNo" id="hRegNo" value="<?php echo $SelectedRegistrationNo;?>">
		<input type="hidden" name="hSibling" id="hSibling" value="<?php echo $Sibling;?>">
		<input type="hidden" name="hFatherAlumni" id="hFatherAlumni" value="<?php echo $Father_DPS_Alumni;?>">
		<input type="hidden" name="hMotherAlumni" id="hMotherAlumni" value="<?php echo $Mother_DPS_Alumni;?>">
		<input type="hidden" name="hSingleParent" id="hSingleParent" value="<?php echo $Single_Parent;?>">
		<input type="hidden" name="hSpecialNeed" id="hSpecialNeed" value="<?php echo $Special_Needs;?>">
		<input type="hidden" name="hDPSStaff" id="hDPSStaff" value="<?php echo $Staff;?>">
		<input type="hidden" name="hOtherCategory" id="hOtherCategory" value="<?php echo $OtherCategory;?>">
		<input type="hidden" name="hHostelFacility" id="hHostelFacility" value="<?php echo $HostelFacility;?>">
		<input type="hidden" name="hEWSCategory" id="hEWSCategory" value="<?php echo $EWSCategory;?>">
		...
		&nbsp;</td>
			...
			<tr>
				...
				<input name="txtAge" id="txtAge" type="text" class="text-box" value="<?php echo $Age;?>"  readonly="readonly" readonly></font></td>
				<td style="width: 3%" class="auto-style11">
				&nbsp;</td>
				<td style="width: 159px" class="auto-style11" colspan="2">
		...
		<font face="Cambria">
		<input name="txtFatherEducation" id="txtFatherEducation" class="text-box" value="<?php echo $FatherEducation;?>" type="text" readonly></font></td>
		...
		<font face="Cambria">
		<input name="cboDuration" id="cboDuration"  class="text-box" value="<?php echo $FatherQualificationDuration;?>" type="text" readonly></font></td>
					</tr>
				</table>
				</td>
		...
		<font face="Cambria">
		<input id="txtFatherAnnualIncome" name="txtFatherAnnualIncome" value="<?php echo $FatherAnnualIncome;?>" class="text-box" type="text" readonly></font></td>
			</tr>
			<tr>
				<td style="width: 212px" class="auto-style11">
		&nbsp;</td>
...
<p style="page-break-before: always">
		...
		<input name="txtMotherEducation" id="txtMotherEducation" type="text" value="<?php echo $MotherEducation;?>" class="text-box" readonly></font>
		...
		<input name="cboMotherQualificationDuration" id="cboMotherQualificationDuration" class="text-box" value="<?php echo $MotherQualificationDuration;?>" type="text" readonly></font></td>
					</tr>
				</table>
				</td>
		...
		<input name="txtMotherAnnualIncome" id="txtMotherAnnualIncome" value="<?php echo $MontherAnnualIncome;?>" class="text-box" type="text" readonly></font></td>
			</tr>
			<tr>
				<td style="width: 212px" class="auto-style11">
	</td>
...
<p style="page-break-before: always">
		...
		<input name="cboTransport" id="cboTransport" class="text-box" value="<?php echo $TransportAvail;?>" readonly readonly type="text" size="20"></font></td>
		...
		<input name="txtDPSSchoolName" id="txtDPSSchoolName" class="text-box" type="text" value="<?php echo $AlumniSchoolName;?>" size="20" readonly="readonly" readonly="readonly"></font></td>
		...
		<input name="txtLastPassoutClassFather" id="txtLastPassoutClassFather" class="text-box" type="text" value="<?php echo $AlumniFatherPassingClass;?>" size="20" readonly="readonly"></font></td>
		...
		<input name="txtMotherDPSSchoolName" id="txtMotherDPSSchoolName" class="text-box" type="text" value="<?php echo $AlumniMotherSchoolName;?>" size="20" readonly="readonly"></font>
		...
		<input name="txtLastPassoutClassMother" id="txtLastPassoutClassMother" class="text-box" type="text" value="<?php echo $AlumniMotherPassingClass;?>" size="20" readonly="readonly"></font></td>
...
<tr>			
		...
		<font face="Cambria">1. Photograph of Applicant's Father* : <input type="file" name="F1" size="20" accept="image/gif, image/jpeg, image/png, image/tiff, image/bmp,image/tif,image/gif"></font><p>
		<font face="Cambria">2. Photograph of Applicant's Mother* :<input type="file" name="F2" size="20" accept="image/gif, image/jpeg, image/png, image/tiff, image/bmp,image/tif,image/gif"></font>
		<p><font face="Cambria">3. Address Proof* :<input type="file" name="F3" size="20" accept="image/gif, image/jpeg, image/png, image/tiff, image/bmp,image/tif,image/gif"></font></p>
		<!--<p><font face="Cambria">4. Medical Certificate* :<inputF type="file" name="F4" size="20" accept="image/gif, image/jpeg, image/png, image/tiff, image/bmp,image/tif,image/gif"></font></p>-->
		</td>
		...
		<td style="border-bottom-width: 1px"><!--<a  href="http://dpsfsis.com/Health Record.docx">Click Here to Download the Health Card</a>--></td>
		...
		<input type="text" name="T1" value="" readonly size="20"><p><b><font face="Cambria">
...
&nbsp;<input name="btnSubmit" type="button" value="Make Payment" onclick="javascript:Validate();"></td>
