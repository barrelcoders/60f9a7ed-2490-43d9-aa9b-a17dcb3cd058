...
<font face="Cambria" size="3"><u> Bonafide Certificate</u></font></h3>
...
is a student of class <?php if(isset($_POST['FillDetail'])) {   echo $rs['sclass']; } ?> of our school. He has been studying in our school since .<?php if(isset($_POST['FillDetail'])) {   echo $rs['DateOfAdmission']; } ?>
and his admission number is <?php if(isset($_POST['FillDetail'])) {   echo $rs['sadmission']; } ?>. His Date of Birth as per our school records is <?php if(isset($_POST['FillDetail'])) {   echo $rs['DOB']; } ?>.</font></p>
