...
?>
<?php
$rs=mysql_query("SELECT CONCAT(`sname`,' ',`slastname`) as `ApplicantName`,`sfathername`,`RegistrationNo`,`Sex` FROM `NewStudentRegistration` WHERE   `RegistrationNo` in ('N645') ORDER BY `srno` DESC ");
