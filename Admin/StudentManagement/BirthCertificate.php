...
<body>
<form method="post" action="SubmitBonafideCertificate.php">
<p>&nbsp;
</p>
...
<div id="print">
<h1 align="center">&nbsp;</h1>
<h1 align="center"><font face="Cambria" style="font-size: 14pt"><image src="../images/logo.png" height="100" width="100px"></image><br><?php echo $SchoolName; ?><br />
...
<br>
</font><font size="3" face="Cambria">This is to certify that&nbsp; <b> <?php if(isset($_POST['FillDetail'])) {   echo $rs['sname']; } ?></b>

&nbsp;D/o ,S/o Mr.
<b><?php if(isset($_POST['FillDetail'])) {   echo $rs['sfathername']; } ?></b>
&nbsp; is / has been a bonafide student of this school in Class <b><?php if(isset($_POST['FillDetail'])) {   echo $rs['sclass']; } ?></b><br>
&nbsp;. As per school office records his / her date of Birth is&nbsp; &nbsp;
...
................................</font></b></p>
<p class="word">&nbsp;</p>
<p class="word"><b><font face="Cambria" size="3">Place: </font></p>
</div>
<font face="Cambria">
<br /><br /><br /><br />
</font>
