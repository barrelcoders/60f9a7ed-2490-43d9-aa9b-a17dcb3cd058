...
{
		//$ssql="(SELECT `srno` , `sname` , `sadmission`,`sclass` FROM `NewStudentAdmission` where `sadmission` not in (select distinct `sadmission` from `student_master`)";
		$ssql="SELECT `srno` , `sname` , `sadmission`,`sclass` FROM `student_master` where 1=1";
...
if($_REQUEST["isSubmit1"]=="yes")
{
	$hSelectedClass=$_REQUEST["hSelectedClass"];
	$TotalStudent=$_REQUEST["txtTotalStudent"];
	for($i=1;$i<=$TotalStudent;$i++)
	{
		$AdmissionId=$_REQUEST["hsadmission".$i];
		$RollNo=$_REQUEST["txtAllotRollNo".$i];
		$ssql="update `student_master` set `srollno`='$RollNo' where `sadmission`='$AdmissionId'";
		mysql_query($ssql);
		mysql_query("update `user_master` set `srollno`='$RollNo' where `sadmission`='$AdmissionId'");
		//echo $ssql."<br>";
	}
	echo "<br><br><center><b>Roll No updated successfully!";
	exit();
...
{
	var TotalStudent=document.getElementById("txtTotalStudent").value;
	for(i=1;i<=TotalStudent;i++)
	{
		if(document.getElementById("txtAllotRollNo" + i).value=="")
		{
			alert("Please enter roll no!");
			return;
		}
	}
	document.getElementById("frmAllotClassRollNo").submit();
}
...
function ValidateClassRollNo(sclass,rollNo,cnt,AdmissionNo)
{
    ...
    {    // Internet Explorer    
		...
		var submiturl="ValidateClassRollNo2.php?Class=" + sclass + "&RollNo=" + rollNo + "&AdmissionNo=" + AdmissionNo;
...
<strong>Allot Class &amp; Roll No To Existing New Student</strong></font></p>
...
<img height="30" src="images/BackButton.png" width="70" style="float: right"></a></p>
	...
	<table class="auto-style7" style="width: 1024px">
		<form name="frmStudentMaster" id="frmStudentMaster" method="post" action="AllotRollNoOldStudent.php">
	<font face="Cambria">
	...
	<td style="width: 191px" class="auto-style13">
				<font face="Cambria">
				<input name="txtAdmissionId" id="txtAdmissionId" type="text" size="12" class="text-box"></font></td>
	...
	<td style="width: 191px" class="auto-style13">
				...
				<font face="Cambria">
	<select name="cboClass" id="cboClass" style="height: 22px; width: 79px;" class="text-box">
	...
	<td style="width: 191px" class="auto-style13">
				<font face="Cambria">
				<input name="txtRollNo" id="txtRollNo" type="text" style="width: 86px" class="text-box"></font></td>
	...
	<td style="width: 191px" class="auto-style13">
				<font face="Cambria">
				<input name="txtStudentName" id="txtStudentName" type="text" size="12" class="text-box"></font></td>
	...
	<td style="width: 107px" class="auto-style10">
				<font face="Cambria">
				<input name="Button1" type="button" value="Submit" onclick ="Javascript:Validate2();" style="font-weight: 700" class="text-box"></font></td>
	...
	<table id="table3" class="CSSTableGenerator">
		<form name="frmAllotClassRollNo" id="frmAllotClassRollNo" method="post" action="">
		<input type="hidden" name="isSubmit1" id="isSubmit1" value="yes">
		<input type="hidden" name="hSelectedClass" id="hSelectedClass" value="<?php echo $SelectedClass;?>">
			<tr>
			...
			<tr>
				...
				<font face="Cambria">
				<input type="hidden" name="hsadmission<?php echo $num_rows; ?>" id="hsadmission<?php echo $num_rows; ?>" value="<?php echo $Admission;?>">
				...
				<select name="cboAllotClass<?php echo $num_rows; ?>" id="cboAllotClass<?php echo $num_rows; ?>">
				<option selected="" value="Select One">Select One</option>
				<?php
					$ssqlClass="SELECT distinct `class` FROM `class_master` where `class`='$SelectedClass'";
					$rsClass1= mysql_query($ssqlClass);
				while($row1 = mysql_fetch_row($rsClass1))
				{
							$Class=$row1[0];
				?>
				<option value="<?php echo $Class; ?>" <?php if($Class==$SelectedClass) { ?> selected="selected" <?php } ?> ><?php echo $Class; ?></option>
				<?php
				}
				?>
				</select></font></td>
				...
				<?php echo $RollNo; ?></span><font face="Cambria"><input name="txtAllotRollNo<?php echo $num_rows; ?>" id="txtAllotRollNo<?php echo $num_rows; ?>" type="text" value="<?php echo $num_rows; ?>"></font></td>
				
				<td height="35" align="center" style="width: 238px" class="style11">
				
				<font face="Cambria">
				<!--
				<input name="btnAllot<?php echo $num_rows; ?>" id="btnAllot<?php echo $num_rows; ?>" type="button" value="Allot the Roll No" onclick="Javascript:Validate('<?php echo $num_rows; ?>','<?php echo $Admission;?>');" style="font-weight: 700">
				-->
				</font>
				</td>
			...
			<tr>
				...
				<td height="35" align="center" class="style11" colspan="7">

				<font face="Cambria">

				<input name="btnSubmit" type="button" value="Submit" style="font-weight: 700" onclick="javascript:Validate();"></font></td>
