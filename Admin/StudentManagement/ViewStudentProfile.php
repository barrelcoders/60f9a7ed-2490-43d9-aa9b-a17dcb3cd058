...
<title> View Student Dossier</title>
...
<body>
<form name="frmIssue" id="frmIssue" method="post" action="StudentProfile.php">
...
<table class="name" width="100%" cellpadding="0" style="border-collapse: collapse" border="1">
 ...
 <tr>
		  <td align="center" style="border-style: solid; border-width: 1px" width="678">
			<p><b><font face="Cambria">Enter Admission No.</font></b></td>
		  <td align="center" style="border-style: solid; border-width: 1px" width="608">
				<font face="Cambria">
				<input name="txtAdmission" id="txtAdmission" class="text-box" style="float: left"></font></td>
</tr>
</table>
<br>
<br>
