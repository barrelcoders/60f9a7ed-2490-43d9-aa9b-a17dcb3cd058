		 ...
		 if($SelectedFinancialYear=="2016")
          {
		   ...
		   $admcountsql="SELECT distinct `sclass`,count(*) FROM `NewStudentRegistration_2016` where `sclass` !='Test'   group by `sclass` ";
            ...
            {
               $admcountsql="SELECT distinct `sclass`,count(*) FROM `NewStudentRegistration` where `sclass` !='Test'  group by `sclass` ";
	 ...
	 `MotherEducation`, `MotherQualificationDuration`, `MotherOccupatoin`, `MotherDesignation`, `MontherAnnualIncome`, `MotherCompanyName`, `MotherOfficeAddress`, `MotherOfficePhone`,
	  ...
	  `MotherMobile`, `MotherEmail`, `GuradianName`, `GuradianAge`, `GuradinaEducation`, `GuradianOccupation`, `GuradianDesignation`, `GuradianAnnualIncome`, `GuradianCompanyName`,
	   ...
	   `RealBroSisClass`, `AlumniFatherName`, `AlumniSchoolName`, `AlumniPassingYear`, `AlumniMotherName`, `AlumniMotherSchoolName`, `AlumniMotherPassingYear`, `EmergencyContactNo`,
	    ...
	    `ScoreCard`,`SystemDateTime`,`EWSCategory` FROM `NewStudentRegistration_2016` WHERE 1=1";
	 ...
	 `MotherEducation`, `MotherQualificationDuration`, `MotherOccupatoin`, `MotherDesignation`, `MontherAnnualIncome`, `MotherCompanyName`, `MotherOfficeAddress`, `MotherOfficePhone`,
	  ...
	  `MotherMobile`, `MotherEmail`, `GuradianName`, `GuradianAge`, `GuradinaEducation`, `GuradianOccupation`, `GuradianDesignation`, `GuradianAnnualIncome`, `GuradianCompanyName`,
	   ...
	   `RealBroSisClass`, `AlumniFatherName`, `AlumniSchoolName`, `AlumniPassingYear`, `AlumniMotherName`, `AlumniMotherSchoolName`, `AlumniMotherPassingYear`, `EmergencyContactNo`,
	    ...
	    `ScoreCard`,`SystemDateTime`,`EWSCategory` FROM `NewStudentRegistration` WHERE 1=1";
...
<table border="1" width="70%" style="border-collapse: collapse" bordercolor="#000000" class="CSSTableGenerator"  align="left">
	<tr>
		...
		<td width="106" style="width: 804px" class="style2"><strong>Registration 
		Count</strong></td>
	</tr>
	<?php
	$RecCount=1;
	...
	$StClass=$rowC[0];
	$StCount=$rowC[1];
	$TotalStCount=$TotalStCount+$StCount;
	?>
	<tr>
	...
	?>
	<tr>
		<td style="width: 38px" class="style2">Total Number</td>
		<td class="style2"><?php echo $TotalStCount;?></td>
	</tr>
...
<tr>
		...
		<td height="22" align="center" style="border-style: solid; border-width: 1px"><b><font face="Cambria">EWS Cateory</font></b></td>
...
<td style="width: 40px" font="Cambria"><?php echo $row[91];?></td>
