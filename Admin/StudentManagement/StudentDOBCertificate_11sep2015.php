...
<body>
<form name="frmCertificate" id="frmCertificate" method="post" action="SubmitStudentDOBCertificate.php">
<p>&nbsp;</p>
<p><b><font face="Cambria" size=3>Issue Date Of Birth Certificate</font></b></p>
<hr>
<p>&nbsp;</p>
...
<br>
<h2 align="center"><font face="Cambria" size="3"><u><b>Date of Birth Certificate</b></u></font></h2>

<p align="center"><u><font face="Cambria"><b>To Whom So Ever It May Concern</b></font></u></p>
<table width="100%">
<tr>
<td width="50%">
<b><font face="Cambria" size="3">Date : </font></b>
...
resident of <?php if(isset($_POST['FillDetail'])) {   echo $rs['Address']; } ?> is / has been a bonafide student of 
class&nbsp; our school during the session <input name="txtSession" id="txtSession" type="text">.</font></p>

<p>
<font face="Cambria" size="3">As per school records his / her date of birth is <b>
<?php if(isset($_POST['FillDetail'])) {   echo $rs['DOB']; } ?></b>
in words (&nbsp; ).<br /> &nbsp;</font></p>
<p>
<b><font face="Cambria" size="3">Principal</font></b></p>
<b>
</div>
<table align="center">
<tr>
	...
	&nbsp;</font><b><input type="submit" name="FillDetail" value="Submit" style="width:82px; font-weight:700" /></td>
</tr>
</table>
<p>&nbsp;</p>
</form>
