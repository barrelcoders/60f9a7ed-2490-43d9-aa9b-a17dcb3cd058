...
echo $sstr;
$sstr=str_replace("'","''",$sstr);
$ssql="INSERT INTO `AdmissionFees` (`sadmission`,`sname`,`sclass`,`amountpaid`,`quarter`,`FinancialYear`,`FeeReceiptCode`) values ('$sadmission','$sname','$sclass','$GrandTotal','Q1','2015','$sstr')";
mysql_query($ssql) or die(mysql_error());
?>
...
$sstr='<br><div style="width: 268px; height: 349px; left: 25px; top: 16px" id="divICard">
	<table border="1" width="268px" height="361" cellspacing="0" cellpadding="2" style="border-collapse: collapse">
		<tr>
			...
			<p align="left"><b><font face="Cambria"><br>Admission No :'.$sadmission.' </font>
			</b></p>
			<p align="left"><b><font face="Cambria">Student Name : '.$sname.'</font></b>
			</p>
			<p align="left"><b><font face="Cambria">Father\' Name : '.$sfathername.'</font></b>
			</p>
			<p align="left"><b><font face="Cambria">Provisional Class: '.$sclass.'</font>
			</b><br><br></td>
		</tr>
	</table>
</div>';
