...
if ($_REQUEST["isSubmit"]=="yes")
{
	...
	{
	$ssql="INSERT INTO `InquiryDetail` (`InquiryFormNo` ,`Name` ,`FatherName`,`DateOfBirth`,`EmailId`,`sclass`,`smobile`,`Address`,`Stream`,`EntryDate`,`SchoolId`,`Source`) VALUES('$InquiryFormNo','$StudentName','$FatherName','$DOB','$EmailId','$Class','$ContactNo','$Address','$Stream','$currentdate','$ShoolId','$Source')";
...
function Followup(InquiryFormNo)
{
	var myWindow = window.open("FollowUpFrom.php?InqFormNo=" + InquiryFormNo,"","width=1000,height=1000");
}
...
<input type="hidden" name="isSubmit" value="yes">
	...
	<select name="cboClass" id="cboClass" class="text-box">
		...
		<input name="txtDOB" id="txtDOB" type="date" class="text-box"></td>
		...
		<input name="txtEmailId" id="txtEmailId" type="text" class="text-box"></font></td>
				...
				<font face="Cambria">Source</font></td>
		...
		<select name="cboSource" id="cboSource"  class="text-box" onChange="Javascript:ChkPaymentMode();">

		<option selected="" value="Newspaper">Newspaper</option>
...
<br>
		...
		<table style="width: 100%" class="CSSTableGenerator">
			<tr>
				...
				<td class="style5" style="width: 111px" bgcolor="#95C23D">
				<strong>
				<font face="Cambria">Source</font></strong></td>
				<td class="style5" style="width: 111px" bgcolor="#95C23D"><strong>
				...
				<td class="style5" style="width: 111px" bgcolor="#95C23D">
				<strong>
				<font face="Cambria">Follow Up </font></strong></td>
				<td class="style5" style="width: 111px" bgcolor="#95C23D">
				<strong>
				<font face="Cambria">Follow Up History</font></strong></td>
				<td class="style5" style="width: 111px" bgcolor="#95C23D">
				<strong>
				<font face="Cambria">Sell Prospectus</font></strong></td>
		...
		<td class="style5" style="width: 111px; ">
		<a href="Javascript:Followup(<?php echo $InquiryFormNo;?>);">Follow Up</a></td>

		<td class="style5" style="width: 111px; ">
		<a href="Javascript:Followup(<?php echo $InquiryFormNo;?>);">Show History</a></td>
		
		<td class="style5" style="width: 111px; text-align:left">
		<a href="SellRegistrationForm.php?inqno=<?php echo $InquiryFormNo;?>" class="style6">Sell Reg. Form</a>
		</td>
