...
if ($txtName!= "")
{
		...
		$txtChequeDate= $arr[2] . "-" . $arr[0] . "-" . $arr[1];
			...
			$sqlRcpt = "select max(CAST(`newsadmission` AS UNSIGNED)) as `newsadmission` from (SELECT CAST(`sadmission` AS UNSIGNED) as `newsadmission` FROM `student_master` union SELECT CAST(`sadmission` AS UNSIGNED) as `newsadmission` FROM `NewStudentAdmission`) as `x`";
			...
			while($rowA = mysql_fetch_row($rsRcpt))
				...
				$ssql="UPDATE `NewStudentAdmission_temp` SET`TxnAmount`='$txtTotalAmtPaying',`TxnStatus`='SUCCESS',`PGTxnId`='$txtChequeDate',`TxnId`='$txtChequeNo',`PaymentMode`='$cboPaymentMode',`BankName`='$cboBank',`ChequeDate`='$txtChequeDate' where  `sname`='$txtName' and `sfathername`='$txtFatherName'";
				mysql_query($ssql) or die(mysql_error());
			
			$rsCnt=mysql_query("SELECT max(CONVERT(replace(`AdmissionFeeReceipt`,'AF/".$CurrentFinancialYear."/',''),UNSIGNED INTEGER)) as `cnt` FROM `NewStudentAdmission`");
			...
			$ReceiptNo="AF/".$CurrentFinancialYear."/".$NewSrNo;
			
			mysql_query("UPDATE `NewStudentAdmission_temp` SET `AdmissionFeeReceipt`='$ReceiptNo' where  `sname`='$txtName' and `sfathername`='$txtFatherName'") or die(mysql_error());
			...
			//$rsChk= mysql_query("select * from `NewStudentAdmission` where  `sname`='$txtName' and `sfathername`='$txtFatherName'");
			//if (mysql_num_rows($rsChk) == 0)
			//{
			
				//mysql_query("insert into NewStudentAdmission (`RegistrationNo`,`RegistrationDate`,`AdmissionFeeReceipt`,`sadmission`,`sname`,`slastname`,`sclass`,`smobile`,`email`,`sfathername`,`quarter`,`FinancialYear`,`TxnAmount`,`TxnId`,`PGTxnId`,`TxnStatus`) select `RegistrationNo`,`RegistrationDate`,`AdmissionFeeReceipt`,`sadmission`,`sname`,`slastname`,`sclass`,`smobile`,`email`,`sfathername`,`quarter`,`FinancialYear`,`TxnAmount`,`TxnId`,`PGTxnId`,`TxnStatus` from `NewStudentAdmission_temp` where `TxnId`='$txnid'") or die(mysql_error());
			//}
			mysql_query("insert into NewStudentAdmission (`RegistrationNo`,`RegistrationDate`,`AdmissionFeeReceipt`,`sadmission`,`AdmissionDate`,`sname`,`slastname`,`DOB`,`PlaceOfBirth`,`Age`,`AgeYear`,`AgeMonth`,`AgeDays`,`Sex`,`Sibling`,`Father_DPS_Alumni`,`Mother_DPS_Alumni`,`Single_Parent`,`Special_Needs`,`Staff`,`OtherCategory`,`MotherTongue`,`Nationality`,`sclass`,`LastSchool`,`ResidentialAddress`,`Location`,`Distance`,`sfathername`,`sfatherage`,`FatherEducation`,`FatherQualificationDuration`,`FatherOccupation`,`FatherDesignation`,`FatherAnnualIncome`,`FatherCompanyName`,`FatherOfficeAddress`,`FatherOfficePhoneNo`,`FatherMobileNo`,`FatherEmailId`,`MotherName`,`MotherAge`,`MotherEducation`,`MotherQualificationDuration`,`MotherOccupatoin`,`MotherDesignation`,`MontherAnnualIncome`,`MotherCompanyName`,`MotherOfficeAddress`,`MotherOfficePhone`,`MotherMobile`,`MotherEmail`,`GuradianName`,`GuradianAge`,`GuradinaEducation`,`GuradianOccupation`,`GuradianDesignation`,`GuradianAnnualIncome`,`GuradianCompanyName`,`GuradianOfficialAddress`,`GuradianOfficialPhNo`,`GuradianMobileNo`,`TransportAvail`,`SafeTransport`,`RealBroSisName`,`RealBroSisClass`,`RealBroSisAdmissionNo`,`AlumniFatherName`,`AlumniSchoolName`,`AlumniPassingYear`,`AlumniFatherPassingClass`,`AlumniMotherName`,`AlumniMotherSchoolName`,`AlumniMotherPassingYear`,`AlumniMotherPassingClass`,`EmergencyContactNo`,`smobile`,`email`,`quarter`,`FinancialYear`,`TxnAmount`,`TxnId`,`PGTxnId`,`TxnStatus`,`FatherPhoto`,`MotherPhoto`,`AddressProofPhoto`,`MedicalCertificatePhoto`,`PaymentMode`,`BankName`,`ChequeDate`) select `RegistrationNo`,`RegistrationDate`,`AdmissionFeeReceipt`,`sadmission`,`AdmissionDate`,`sname`,`slastname`,`DOB`,`PlaceOfBirth`,`Age`,`AgeYear`,`AgeMonth`,`AgeDays`,`Sex`,`Sibling`,`Father_DPS_Alumni`,`Mother_DPS_Alumni`,`Single_Parent`,`Special_Needs`,`Staff`,`OtherCategory`,`MotherTongue`,`Nationality`,`sclass`,`LastSchool`,`ResidentialAddress`,`Location`,`Distance`,`sfathername`,`sfatherage`,`FatherEducation`,`FatherQualificationDuration`,`FatherOccupation`,`FatherDesignation`,`FatherAnnualIncome`,`FatherCompanyName`,`FatherOfficeAddress`,`FatherOfficePhoneNo`,`FatherMobileNo`,`FatherEmailId`,`MotherName`,`MotherAge`,`MotherEducation`,`MotherQualificationDuration`,`MotherOccupatoin`,`MotherDesignation`,`MontherAnnualIncome`,`MotherCompanyName`,`MotherOfficeAddress`,`MotherOfficePhone`,`MotherMobile`,`MotherEmail`,`GuradianName`,`GuradianAge`,`GuradinaEducation`,`GuradianOccupation`,`GuradianDesignation`,`GuradianAnnualIncome`,`GuradianCompanyName`,`GuradianOfficialAddress`,`GuradianOfficialPhNo`,`GuradianMobileNo`,`TransportAvail`,`SafeTransport`,`RealBroSisName`,`RealBroSisClass`,`RealBroSisAdmissionNo`,`AlumniFatherName`,`AlumniSchoolName`,`AlumniPassingYear`,`AlumniFatherPassingClass`,`AlumniMotherName`,`AlumniMotherSchoolName`,`AlumniMotherPassingYear`,`AlumniMotherPassingClass`,`EmergencyContactNo`,`smobile`,`email`,`quarter`,`FinancialYear`,`TxnAmount`,`TxnId`,`PGTxnId`,`TxnStatus`,`FatherPhoto`,`MotherPhoto`,`AddressProofPhoto`,`MedicalCertificatePhoto`,`PaymentMode`,`BankName`,`ChequeDate` from `NewStudentAdmission_temp` where `sname`='$txtName' and `sfathername`='$txtFatherName'") or die(mysql_error());
		
			
			
			$ssqlRegi="SELECT `sname`,`slastname`,`RegistrationNo`,`sclass`,`TxnAmount`,`smobile`,`email`,`AdmissionFeeReceipt` FROM `NewStudentAdmission` as `a` where`sname`='$txtName' and `sfathername`='$txtFatherName'";	
			...
			if (mysql_num_rows($rsRegiNo1) > 0)
			{
				while($row2 = mysql_fetch_row($rsRegiNo1))
				{
							...
							$smobile=$row2[5];						
							$email=$row2[6];
							$AdmissionFeeReceipt=$row2[7];
							break;							
				}
			}
			if($sclass ="11th")
			{
				$ssql="UPDATE `NewStudentAdmission_temp` SET `sadmission`='$sadmission' where `sname`='$txtName' and `sfathername`='$txtFatherName'";	
				mysql_query($ssql) or die(mysql_error());
				$ssql="UPDATE `NewStudentAdmission` SET `sadmission`='$sadmission' where`sname`='$txtName' and `sfathername`='$txtFatherName'";	
				mysql_query($ssql) or die(mysql_error());
			...
			//Sending SMS*****************
					if($sclass=="11th") 
					{
						$notice="Dear Parent, Your provisional admission process for Student:".$sname." for Class: ".$sclass." at DPS Sec 19 Fbd. has been successfully completed.  Amt: ".$TxnAmount.", Please use the same for future communication.";
						$Emailnotice="Dear Parent, Your provisional admission process for Student:".$sname." for Class: ".$sclass." at DPS Sec 19 Fbd. has been successfully completed.  Amt: ".$TxnAmount.", Please use the same for future communication.<br>Regards,<br>DPS Sector 19 Faridabad";
					}
					else
					{
			...
			//$to="itismeashishs@gmail.com";
		  	$subject = "New Admission Confirmation Mail";
		  	$headers = "MIME-Version: 1.0" . "\r\n";
			$headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
			
			// More headers
			$headers .= 'From: communication@dpsfsis.com' . "\r\n";
			$headers .= 'Cc: info@dpsfsis.com' . "\r\n";
...
<font face="cambria"><b>Email Id: <?php echo $SchoolEmailId; ?></b></font>
	...
	<p align="center" class="style3" ><font face="Cambria"><?php if($sclass=="11th") {?>Provisional<?php }?> Admission Fees Receipt</font></p>
	
	<p align="center"><b><span class="style2">Receipt No. <?php echo $AdmissionFeeReceipt; ?>
	...
	<div align="center">
		...
		<table cellpadding="0" style="border-style:dotted; border-width:1px; width: 61%; border-collapse:collapse; padding-left:4px; padding-right:4px; padding-top:1px; padding-bottom:1px" >
			...
			<tr>
				...
				<span class="style2"></span><font face="Cambria"></font>
