...
<body>
<form name="frmCertificate" id="frmCertificate" method="post" action="SubmitStudentNOCHolydayCertificateforLeave.php">
<p>&nbsp;</p>
...
been a bonafide student of this school and is presently studying in class <?php if(isset($_POST['FillDetail'])) {   echo $rs['sclass']; } ?> 
 examination in <input type="text" name="txtSession" id="txtSession">. It is 
futher certified that the school has no objection to her going abroad during the 
period from <font size="3" face="Cambria"> <font size="3" face="Cambria"> <input type="text" name="txtSession1" id="txtSession1"></font></font> 
to <font size="3" face="Cambria"> <font size="3" face="Cambria"> <input type="text" name="txtSession2" id="txtSession2"></font></font></font> 
. </p>
