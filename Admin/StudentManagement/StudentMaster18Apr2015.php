...
<img src="images/BackButton.png" style="float: right" height="20"></a></p>
	...
	<td style="width: 166px" class="auto-style13">
				<span class="auto-style3"><span style="text-decoration: none">
				Search By Mobile No</span></span></td>
	
	<td style="width: 78px" class="auto-style13">
				<span class="auto-style3"><span style="text-decoration: none">
				Mobile No</span></span></td>
	
	<td style="width: 365px" class="auto-style13">
				<font face="Cambria">
				<input name="txtMobileNo" id="txtRollNo0" type="text" style="width: 86px" size="20"></font></td>
	...
	<td style="width: 365px" class="auto-style13">
				<font face="Cambria">
				<input name="txtBusRoute" id="txtRollNo1" type="text" style="width: 86px" size="20"></font></td>
	...
	<td style="width: 150px" class="auto-style13">
				<font face="Cambria">
				<input name="txtCategory" id="txtStudentName1" type="text" size="20"></font></td>
	...
	<td style="width: 166px" class="auto-style13">
				<span class="auto-style3"><span style="text-decoration: none">
				Search by Date Of Birth</span></span></td>
	...
	<td style="width: 365px" class="auto-style13">
				<font face="Cambria">
				<input name="txtDateOfBirth" id="txtRollNo2" type="text" style="width: 86px" size="20"></font></td>
	...
	&nbsp;<table width="100%" bordercolor="#000000" id="table3" class="style2" border=1>
			...
			<tr>
				...
				<td height="35" bgcolor="#95C23D" align="center" style="width: 55px" class="style11">
				...
				<td height="35" bgcolor="#95C23D" align="center" style="width: 56px" class="style11">
