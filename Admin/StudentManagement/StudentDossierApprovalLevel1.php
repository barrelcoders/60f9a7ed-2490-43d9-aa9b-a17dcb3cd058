...
$ssql="SELECT `SrNo`, `sadmisson`, `sname`, `sclass`, `srollno`, `sfathername`, `smothername`, `FYear`, `CGPASem1`, `CGPASem2`, `CGPAOverall`, `ConceptWorkHabits`, `AttitudeBehaviour`, `ExtraCurricular`, `SpecialTalent`, `LongLeaveReason`, `SpecialIncident`, `EmpId`, `DateOfEntry`, `SystemDateTime` FROM `StudentDossier`";
	//echo $ssql;
	//exit();
...
function fnlApprove(recno,AdmId)
{
	...
	var myWindow = window.open("DossierApprove.php?AdmId=" + AdmissionId+ "&action=approve", "", "width=200, height=100");	
}
</script>
</head>
...
<tr>
		   <td class="style3" color="#FFFFFF" colspan="16" style="border-left-color: #C0C0C0; border-left-width: 1px; border-right-color: #A0A0A0; border-right-width: 1px">
       ...
       <td height="22" align="center" class="style14">
        ...
        <td height="22" align="center" class="style14">
         ...
         <td height="22" align="center" class="style14">
            ...
            <td height="22" align="center" class="style14">
						<b><font face="Cambria">Any special incident and measures takes</font></b></td>
...
<td style="width: 113px" font="Cambria">
