...
$AdmissionId=$row1[0];
	...
	$StudentAttandance="";
	$rsAttandace=mysql_query("select `Studentattendance` from `reportcard_attendance` where `sadmission`='$AdmissionId'");
	while($rowA=mysql_fetch_row($rsAttandace))
	{
		$StudentAttandance=$rowA[0];
		break;
	}
...
<table  width="100%" cellspacing="0" cellpadding="0" align=center style="border-collapse: collapse" border=2 height=600px >
<tr>
<td>
<table  width="90%" cellspacing="0" cellpadding="0" align=center style="border-collapse: collapse" >
<tr><td>&nbsp;</td></tr>
	<tr>
		<td align="left" >
		...
		<img src= "../images/DPSLogo.jpg" width="90" height="90"><br>&nbsp;&nbsp;<b><font face="Cambria"></font></b></font><td align=center width="85%">
		<font face="Cambria" style="font-size:35px" ><b>'.$SchoolName1.'</font><font style="font-size: 13pt"><br>
		</font><br><font face="Cambria" style="font-size: 13pt"><b>'.$SchoolAddress1.'</font></td></tr>
		
		<tr><td colspan=2 align=center width="90%"><font face="Cambria" size="5pt" style="padding:0px 0px 0px 70px"><b>Academic Report : 2015-2016</b></td></tr>	

	<tr>
		<td colspan=2 width="90%">
		<p align="center"><b><font face="Cambria" style="font-size: 15pt"><br></font></b></td>
	</tr>
	
		
	<table border="1" width="90%" cellspacing="0" cellpadding="0" align=center style="border-collapse: collapse; ">
		<tr>
			<td width="723" style="border-left:1px solid #000000; border-top:1px ; border-right-style: solid; border-right-width: 1px; border-bottom-style:solid; border-bottom-width:1px" colspan="4">
			<p align="center"><font face="Cambria"><b>Student Profile</b></font></td>
		</tr>
		<tr>
			<td width="127" style="border-left:1px solid #000000; border-top:1px ; border-right-style: solid; border-right-width: 1px; border-bottom-style:solid; border-bottom-width:1px">
			...
			<td width="139" style="border-top:1px ; border-left-style: solid; border-left-width: 1px; border-right-style: solid; border-right-width: 1px; border-bottom-style:solid; border-bottom-width:1px">
			<font face="Cambria" style="font-size: 11pt">&nbsp;Father Name</font></td>
			<td width="235" style="border-right:1px solid #000000; border-top:1px ; border-left-style: solid; border-left-width: 1px; border-bottom-style:solid; border-bottom-width:1px">
			<font face="Cambria">&nbsp;'.$sfathername.' &nbsp; </font></td>
		</tr>
		<tr>
			<td width="127" style="border-left:1px ; border-right-style: solid; border-right-width: 1px; border-top-style:solid; border-top-width:1px; border-bottom-style:solid; border-bottom-width:1px">
			...
			<font face="Cambria" style="font-size: 11pt">&nbsp;Class / Section</font></td>
			<td width="235" style="border-right:1px ; border-left-style: solid; border-left-width: 1px; border-top-style:solid; border-top-width:1px; border-bottom-style:solid; border-bottom-width:1px">
			<font face="Cambria">&nbsp;'.$sclass.' &nbsp;</font></td>
		</tr>
		
		<tr>
			<td width="293"><font face="Cambria" style="font-size: 11pt">&nbsp;Roll Number</font></td>
			<td width="293"><font face="Cambria" style="font-size: 11pt">&nbsp;'.$srollno.'</font></td>
		...
		<tr>
			<td width="127" style="border-left:1px solid #000000; border-top:1px ; border-right-style: solid; border-right-width: 1px; border-bottom-style:solid; border-bottom-width:1px">
			<font face="Cambria" style="font-size: 11pt">&nbsp;Total number of working days</font></td>
			<td width="222" style="border-top:1px solid #000000; border-left-style: solid; border-left-width: 1px; border-right-style: solid; border-right-width: 1px; border-bottom-style:solid; border-bottom-width:1px">
			<font face="Cambria">&nbsp;92 </font></td>
			<td width="139" style="border-top:1px ; border-left-style: solid; border-left-width: 1px; border-right-style: solid; border-right-width: 1px; border-bottom-style:solid; border-bottom-width:1px">
			<font face="Cambria" style="font-size: 11pt">&nbsp;Attendance</font></td>
			<td width="235" style="border-right:1px solid #000000; border-top:1px ; border-left-style: solid; border-left-width: 1px; border-bottom-style:solid; border-bottom-width:1px">
			<font face="Cambria">&nbsp;'.$StudentAttandance.'</font></td>
		</tr>
...
<table style="width: 90%" class="style1" align=center cellspacing="0" cellpadding="0">
	...
	<tr>
		<td class="style2" style="border-style:solid; border-width:1px; height: 22px" colspan="12">
		<p align="left"><u><b><font face="Cambria">ACADEMIC PERFORMANCE OF THE STUDENT</font></b></u></td>
	</tr>
	
	<tr>
		<td class="style2" rowspan=2 style="border-style:solid; border-width:1px; width: 70px; height: 22px;align:center;" align=center>
		...
		<td class="style2" rowspan=2  style="border-style:solid; border-width:1px; width: 209px; height: 22px;align:center;" align=center>
		<font face="Cambria" style="font-size: 11pt"><strong>&nbsp;Subject</strong></font></td>
		<td class="style2" rowspan=2 style="border-style:solid; border-width:1px; width: 209px; height: 22px;align:center;" align=center><span style="font-size: 11pt">
		<strong>Weekly Test 10%</strong></span></td>
		<td class="style3" colspan=2 style="border-style:solid; border-width:1px; height: 22px;align=center" align=center><strong>
		<font size="3">Ist Sem Exam 40%</font></strong></td>
		
		<td class="style3" rowspan=2 style="border-style:solid; border-width:1px; height: 22px;align=center" align=center><span style="font-size: 11pt">
		<strong>Total 50%</strong></span></td>
		<td class="style3" rowspan=2 style="border-style:solid; border-width:1px; height: 22px;align=center" align=center><strong>
		<span style="font-size: 11pt"><font face="Cambria"><strong>Total (Grade Point) </strong></font></span></font></strong></td>
		
		<td class="style2" rowspan=2 style="border-style:solid; border-width:1px; width: 209px; height: 22px;align:center;" align=center><span style="font-size: 11pt">
		<strong>Weekly Test 10%</strong></span></td>
		<td class="style3" colspan=2 style="border-style:solid; border-width:1px; height: 22px;align=center" align=center><strong>
		<font size="3">2nd Sem Exam 40%</font></strong></td>
		
		<td class="style3" rowspan=2 style="border-style:solid; border-width:1px; height: 22px;align=center" align=center><span style="font-size: 11pt">
		<strong>Total 50%</strong></span></td>
		<!--<td class="style3" rowspan=2 style="border-style:solid; border-width:1px; height: 22px;align=center" align=center><strong>
		<span style="font-size: 11pt"><font face="Cambria"><strong>Total (Grade Point 100%) </strong></font></span></font></strong></td>-->
	...
	<tr>
		...
		<strong>Theory</strong></span></td>
		<td class="style3" style="height: 28px; border-left-style:solid; border-left-width:1px; border-right-style:solid; border-right-width:1px; border-bottom-style:solid; border-bottom-width:1px"><span style="font-size: 11pt">
		<strong>Practical</strong></span></td>
		<td class="style3" style="height: 28px; border-left-style:solid; border-left-width:1px; border-right-style:solid; border-right-width:1px; border-bottom-style:solid; border-bottom-width:1px"><span style="font-size: 11pt">
		<strong>Theory</strong></span></td>
		<td class="style3" style="height: 28px; border-left-style:solid; border-left-width:1px; border-right-style:solid; border-right-width:1px; border-bottom-style:solid; border-bottom-width:1px"><span style="font-size: 11pt">
		<strong>Practical</strong></span></td>
		...
		if(mysql_num_rows($rsSubject) > 0)
		{
			...
			while($rowSu = mysql_fetch_row($rsSubject))
			{
				...
				//$SumFA1=number_format(($FA1_UT+$FA1_A1+$FA1_A2+$FA1_A3)/3,1);
				  $SumFA1=number_format(($FA1_UT+$FA1_A1+$FA1_A2+$FA1_A3),2);
				...
				//$SumFA2=number_format(($FA2_UT+$FA2_A1+$FA2_A2+$FA2_A3)/3,1);
				  $SumFA2=number_format(($FA2_UT+$FA2_A1+$FA2_A2+$FA2_A3),2);
				...
				{
					//$SumSA1=number_format((($SA1_UT+$SA1_A1+$SA1_A2+$SA1_ASL)/100)*30,1);
					$SumSA1=number_format(($SA1_UT+$SA1_A1+$SA1_A2+$SA1_ASL),1);
				...
				*/
				...
				$ConvertedFA1=$SumFA1*(20/100);
				$ConvertedFA2=$SumFA2*20/100;
				$ConvertedSA1=$SumSA1*30/100;
				$Term1ObtainedMarks=$ConvertedFA1+$ConvertedFA2+$ConvertedSA1;
				...
				if($subject=="Information Technologies (IT)")
				{
					...
					//exit();
					$rsTerm1Grade=mysql_query("select `Grade`,`GradePoints` from `grade_master` where `MaxMarks`='100' and ".$Term1ObtainedMarks.">=`RangeFrom` and ".$Term1ObtainedMarks."<=`RangeTo`");
				}
				else
				{
					$rsTerm1Grade=mysql_query("select `Grade`,`GradePoints` from `grade_master` where `MaxMarks`='50' and ".$Term1ObtainedMarks.">=`RangeFrom` and ".$Term1ObtainedMarks."<=`RangeTo`");
				}
				//echo "select `Grade`,`GradePoints` from `grade_master` where `MaxMarks`='50' and ".$Term1ObtainedMarks.">=`RangeFrom` and ".$Term1ObtainedMarks."<=`RangeTo`";
				//exit();
				
				while($rowTerm1Grade = mysql_fetch_row($rsTerm1Grade))
  				{
  					$Term1Grade=$rowTerm1Grade[0];
  					$Term1GradePoint=$rowTerm1Grade[1];
...
$strOneStudent=$strOneStudent.'
	...
	<tr>
		...
		<!--<td class="style4" style="border-style:solid; border-width:1px; width: 209px;">&nbsp;'.$Term1Grade.'('.$Term1GradePoint.')</td>-->
		<td class="style4" style="border-style:solid; border-width:1px; width: 209px;">&nbsp;'.$Term1Grade.'</td>
		<!--<td class="style4" style="border-style:solid; border-width:1px; width: 209px;">&nbsp;'.$Term1GradePoint.'</td>-->

				
	</tr>';
	$SumOfTerm1GradePoint=$SumOfTerm1GradePoint+$Term1GradePoint;
	$cnt=$cnt+1;
	}//End of While loop for FA1 Subject
	}//End of If Condition check FA1 data exists or not
	$totalCGPA=$SumOfTerm1GradePoint/($cnt-1);
	//echo "Total GradePoint:".$SumOfTerm1GradePoint.",No Of Subject:".($cnt-1);
	//exit();
	
$strOneStudent=$strOneStudent.'

<tr><td class="style4" style="border-style:solid; border-width:1px; width: 209px;align=left" colspan=6 >
<font face="Cambria" size=4 ><strong>Total : </strong></font></td>
<td class="style4" style="border-style:solid; border-width:1px; width: 209px;" >
<font face="Cambria" size=4 ><strong>&nbsp;'.substr($totalCGPA,0,strpos($totalCGPA,".") + 2).'</strong></font></td></tr>
	</table>
<font face="Cambria"><br></font>
	<table width="100%" cellspacing="0" cellpadding="0" style="border-collapse: collapse" height="79" align="center">
	<tr>
		<td align="center" height="36">
		<font face="Cambria" style="font-size: 12pt; font-weight: 700">Class Teacher</font></td>
		<td align="center" height="36">
		<font face="Cambria" style="font-size: 12pt; font-weight: 700">Class Coordinator</font></td>
	
		<td align="center">
		<font face="Cambria" style="font-size: 12pt; font-weight: 700">Vice Principal</font></td>
		<td align="center">
		<font face="Cambria" style="font-size: 12pt; font-weight: 700">Principal</font></td>
	</tr>
</table>
<br>
</td>
