...
function Validate()
{
	if(document.getElementById("txtsadmission").value=="")
	{
...
<body>
<form name="frmCertificate" id="frmCertificate" method="post" action="SubmitBonafideCertificate.php">
<p>&nbsp;
</p>
...
<table border="1px" width="100%" cellspacing="0" cellpadding="0" style="border-collapse: collapse">
  <tr>
    ...
    <td style="width: 151px; height: 29px">
       <p align="center">
       <font face="Cambria">
       <input type="text" name="txtsadmission" id="txtsadmission" size="15" style="color: #CC0033; width: 151px;" required />
		</font>
	</td>
...
<div id="print">
<h1 align="center">&nbsp;</h1>
<h1 align="center"><font face="Cambria" style="font-size: 14pt"><image src="../images/logo.png" height="100" width="350px"></image><br><br />
...
<p align="center">
       <font face="Cambria">
       <input type="button" name="FillDetail" value="Generate Certificate" onclick="Javascript:Validate();" style="width:126; font-weight:700; height:28" /></font></p>
<p>&nbsp;</p>
<p>&nbsp;</p>
</form>
