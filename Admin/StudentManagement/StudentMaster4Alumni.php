...
{
	   $ssql="SELECT `srno` , `sname` , `DOB`,`Sex`,`Category`,`Nationality`,`sadmission` ,`sclass`,`srollno`,`LastSchool`,`sfathername`,`FatherEducation`,`FatherOccupation`,`MotherName`,`MotherEducation`,`Address`,`smobile`,`simei`,`suser`,`spassword`,`email`,`routeno`,`FeeSubmissionType`,`DiscontType`,`SchoolId` FROM `student_master` where 1=1";
...
function MoveToAlumni(SrNo,SAdmission)
{
	varCtrlButton = "btnAlmni"+SrNo;
	document.getElementById(varCtrlButton).disabled=true;
	//window.open "EditHoliday.php?srno" . SrNo;

	var myWindow = window.open("MoveToAlumni.php?srno=" + SrNo + "&sadmission=" + SAdmission ,"","width=700,height=650");
...
<title>Alumni Student Active/Inactive</title>
...
<p class="auto-style5" style="height: 12px"><font face="Cambria" size="3"><strong>Search Student</strong></font></p>
...
<img src="images/BackButton.png" style="float: right" height="20"></a></p>
	...
	<table class="auto-style7" style="width: 100%">
		<form name="frmStudentMaster" id="frmStudentMaster" method="post" action="StudentMaster4Alumni.php">
	<font face="Cambria">
...
<td height="35" align="center" style="width: 55px" class="style11">
			...
			<?php 	echo $DiscontType; ?></font></td>
				...
				<td height="35" align="center" style="width: 55px" class="style11">
					...
					<input name="btnAlmni<?php echo $srno ?>" id="btnAlmni<?php echo $srno ?>" type="button" value="Move to Alumni" onclick="Javascript:MoveToAlumni('<?php echo $srno ?>','<?php echo $Admission;?>');">
					</font>
				</td>
