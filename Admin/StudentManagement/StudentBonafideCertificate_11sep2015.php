...
<body>
<form name="frmCertificate" id="frmCertificate" method="post" action="SubmitStudentBonafideCertificate.php">
<p>&nbsp;</p>
<p><b><font face="Cambria" size=3>Issue Bonafide Student Certificate</font></b></p>
<hr>
<p>&nbsp;</p>
...
<h3 align="center"><u><font face="Cambria" size="3">Bonafide Student </font></u>
<font face="Cambria" size="3"><u> Certificate</u></font></h3>
...
resident of <?php if(isset($_POST['FillDetail'])) {   echo $rs['Address']; } ?>  has been a bonafide student of <?php if(isset($_POST['FillDetail'])) {   echo $rs['sclass']; } ?> our school during the session .<input type="text" name="txtSession" id="txtSession"></font></p>

<p>
<font face="Cambria" size="3">As per school records his / her date of birth is <b>
<?php if(isset($_POST['FillDetail'])) {   echo $rs['DOB']; } ?></b>
.<br /> <br /> We wish him / her all the success in life.</font></p>
<font face="Cambria">
<br />&nbsp;</font><p><b><font face="Cambria" size="3">Sd/-</font></b></p>
