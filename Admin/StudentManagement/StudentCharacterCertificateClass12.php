...
try
			...
			var submiturl="GetStudentDetailClass12.php?AdmissionId=" + document.getElementById("txtsadmission").value + "";
...
<p>&nbsp;</p>
<p><b><font face="Cambria" size=3>CERTIFICATE CERTIFICATE</font></b></p>
<hr>
<p>&nbsp;</p>
...
<?php 
			...
			if(isset($_POST['FillDetail'])) 
			{
			 $ID=$_POST['txtsadmission'];
				...
				$result1=mysql_query("SELECT * FROM   Almuni where sadmission=$ID");
...
<span style="font-weight: 400"> <br></span> </font>
</h1>
<h3 align="center"><u><font face="Cambria" size="3">CHARACTER</font></u><font face="Cambria" size="3"><u> CERTIFICATE</u></font></h3>
<p align="center"><font face="Cambria"><b></b></font></p><p>
<b><font face="Cambria" size="3">Date : </font></b></p>
<p align=right>
<b><font face="Cambria" size="3">Certificate No: </font></b></p>
<p>
<font size="3" face="Cambria">Certify that Master/Miss<?php if(isset($_POST['FillDetail'])) {   echo $rs['sname']; } ?>,</b>
&nbsp;S/D/O Mr. / Mrs.<b>
<?php if(isset($_POST['FillDetail'])) {   echo $rs['sfathername']; } ?>,</b>&nbsp; 
is a student of class <?php if(isset($_POST['FillDetail'])) {   echo $rs['sclass']; } ?> 
in Delhi Public School, Faridabad. He/She has passed All India Senior Certificate Examination conducted by Central Board of Secondary Education (CBSE) held in March <?php if(isset($_POST['FillDetail'])) {   echo $rs['DateOfAdmission']; } ?>  under
<?php if(isset($_POST['FillDetail'])) {   echo $rs['srollno']; } ?>. During his/her stay in the school, his/her conduct and character has been Good.</span></p>
