...
{
	   $ssql="SELECT `srno`,`sname`,`DOB`,`Sex`,`Category`,`Nationality`,`sadmission`,`sclass`,`srollno`,`LastSchool`,`sfathername`,`FatherEducation`,`FatherOccupation`,`MotherName`,`MotherEducation`,`Address`,`smobile`,`simei`,`suser`,`spassword`,`email`,`routeno`,`status`,`FinancialYear`,`SchoolId` FROM `Almuni` where 1=1";
...
function MoveToAlumni(SrNo)
{
	...
	var myWindow = window.open("MoveToMaster.php?srno=" + SrNo ,"","width=700,height=650");
...
<title>Move To Students Master</title>
...
<img src="images/BackButton.png" style="float: right" height="20"></a></p>
	...
	<table class="auto-style7" style="width: 100%">
		<form name="frmStudentMaster" id="frmStudentMaster" method="post" action="MoveToStudentMaster.php">
	<font face="Cambria">
	...
	<td style="width: 150px" class="auto-style13">
				<font face="Cambria">
				<input name="txtStudentName" id="txtStudentName" class="text-box" type="text"></font></td>
...
<td height="35" align="center" style="width: 55px" class="style11">
			...
			<?php 	echo $financialyear; ?></font></td>
				...
				<td height="35" align="center" style="width: 55px" class="style11">
					...
					<input name="btnAlmni<?php echo $srno ?>" id="btnAlmni<?php echo $srno ?>" type="button" value="Restore" onclick="Javascript:MoveToAlumni(<?php echo $srno ?>);">
					</font>
				</td>
