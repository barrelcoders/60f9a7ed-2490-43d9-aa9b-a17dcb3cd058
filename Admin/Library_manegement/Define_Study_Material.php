...
<div class="row c">
 <div class="col-md-2 hris1"> 
  ...
  <ul>
   ...
   <li class="active"><a href="Define_Study_Material.php"><button class="btnmanu">Define Study Materials  </button></a></li>
  </ul>
 </div>
<!--------------Details------------------>
 <div class="col-md-10">
  	<div class="librarysetup">
    	<div class="librarysetup_head">Material Type Information</div>
        <div class="librarysetup_input1">
        	<form action="" method="post">
	        	<div class="row">
                	<div class="col-xs-6"><b>1. &nbsp; Material Type:</b></div>
                    <div class="col-xs-6"><input type="text" name="materialType" id="materialType" class="text-box" value=""></div>
                </div>
	        	<div class="row">
                	<div class="col-xs-6"><b>2. &nbsp; Material Name:</b></div>
                    <div class="col-xs-6"><input type="text" name="materialName" id="materialName" class="text-box" value=""></div>
                </div>
	        	<div class="row">
