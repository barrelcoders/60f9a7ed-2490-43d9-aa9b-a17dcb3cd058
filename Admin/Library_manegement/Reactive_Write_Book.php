...
<div class="row c">
 <div class="col-md-2 hris1"> 
  ...
  <ul>
   ...
   <li class="active"><a href="Reactive_Write_Book.php"><button class="btnmanu">Reactive Write off Book  </button></a></li>
...
<!--------------Details------------------>
 <div class="col-md-10">
  	<div class="librarysetup">
    	<div class="librarysetup_head">Library Reactive Write off Book</div>
										...
										<div class="table-responsive">
											<table id="datable_1" class="table table-hover display  pb-30" >
												...
												<tbody>
                                                    <tr>
                                                        <td>1.</td>
                                                        <td><a href="#" class="btn">Reactive Book</a></td>
                                                        <td>ASDDFG ASDF</td>
                                                        <td>ASDDFG ASDF</td>
                                                        <td>ASDDFG ASDF</td>
                                                        <td>ASDDFG ASDF</td>
