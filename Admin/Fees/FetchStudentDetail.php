			      ...
			      if(xmlHttp.readyState==4)
			        {
			        	...
			        	if (parseInt(selectedQtr) == 1)
			        	{
			        		...
			        		{
				        		document.getElementById("frmFees").action = "FeesPaymentHostel.php";
				        		document.frmFees.submit();			        		
			        		}
			        		else
			        		{
				        		document.getElementById("frmFees").action = "FeesPaymentNew.php";
				        		document.frmFees.submit();			        		
			        		}
			        	}
...
<hr class="auto-style3" style="height: -15px">
	...
	<form name="frmFees" id="frmFees" method="post" target="_self">
		...
		<select name="cboFeeType" id="cboFeeType">
