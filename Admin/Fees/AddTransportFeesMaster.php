...
<table width="100%" cellspacing="0" bordercolor="#000000" id="table_11" class="auto-style20" style="height: 33px">
	...
	<tr>
		...
		<strong>Transport Fees Master</strong><hr class="auto-style3" style="height: 0px" noshade="noshade">
...
<table width="100%" border="1" style="border-collapse: collapse">
    <form name="frmFeeMaster" id="frmFeeMaster" method="post" action="TransportFeesMaster.php">
<tr>
<td><font face="Cambria">Transport Fees Head</font></td>

<td><font face="Cambria"><input type="text" name="transportHead" id="txtAmount" size="20" class="text-box" required="true"></font></td>

<td><font face="Cambria">Amount</font></td>
<td><font face="Cambria"><input type="text" name="txtAmount" id="txtAmount" size="20" class="text-box" required="true"></font></td>
