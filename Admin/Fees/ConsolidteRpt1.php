...
<table style="width: 100%" cellpadding="0" class="style1">
	<tr>
		<td class="style8" style="height: 16px" colspan="28">Particulars</td>
	...
	<tr>
		...
		<td class="style6" style="width: 63px">Transport Fee</td>
		<td class="style6" style="width: 63px">Admission Fee </td>
		<td class="style6" style="width: 63px">Caution </td>
		<td class="style6" style="width: 63px">Tuition Fee</td>
		<td class="style6" style="width: 63px">Comp. Fee</td>
		<td class="style6" style="width: 63px">&nbsp;Science Fee</td>
		<td class="style6" style="width: 63px">Registration Fee</td>
		<td class="style6" style="width: 63px">Annual Charge</td>
		<td class="style6" style="width: 63px">&nbsp;Smart Class</td>
		<td class="style6" style="width: 63px">Hostel Adm. Fee</td>
		<td class="style6" style="width: 63px">Hostel Caution Money</td>
		<td class="style6" style="width: 63px">Boarding</td>
		<td class="style6" style="width: 63px">Maintenance</td>
		<td class="style6" style="width: 63px">Electricity</td>
		<td class="style6" style="width: 63px">Activity</td>
		<td class="style6" style="width: 63px">Medical</td>
		<td class="style6" style="width: 63px">House&nbsp; <span class="style12">
		Keeping</span></td>
		<td class="style6" style="width: 63px">Laundry</td>
		<td class="style6" style="width: 63px">Total</td>
	...
	(select sum(`amount`) from `fees_student` where `sadmission`=a.`sadmission` and `feeshead`='admissionfees' and `FeesType`='Hostel') as `HostelAdmissionFees`,
	(select sum(`amount`) from `fees_student` where `sadmission`=a.`sadmission` and `feeshead`='cautionfees' and `FeesType`='Hostel') as `HostelCautionfees`,
	(select sum(`amount`) from `fees_student` where `sadmission`=a.`sadmission` and `feeshead`='boarding' and `FeesType`='Hostel') as `Boarding`,
	(select sum(`amount`) from `fees_student` where `sadmission`=a.`sadmission` and `feeshead`='maintenance' and `FeesType`='Hostel') as `Maintenance`,
	(select sum(`amount`) from `fees_student` where `sadmission`=a.`sadmission` and `feeshead`='electricity' and `FeesType`='Hostel') as `Electricity`,
	(select sum(`amount`) from `fees_student` where `sadmission`=a.`sadmission` and `feeshead`='activity' and `FeesType`='Hostel') as `Activity`,
	(select sum(`amount`) from `fees_student` where `sadmission`=a.`sadmission` and `feeshead`='medical' and `FeesType`='Hostel') as `Medical`,
	(select sum(`amount`) from `fees_student` where `sadmission`=a.`sadmission` and `feeshead`='housekeeping' and `FeesType`='Hostel') as `HouseKeeping`,
	(select sum(`amount`) from `fees_student` where `sadmission`=a.`sadmission` and `feeshead`='laundry' and `FeesType`='Hostel') as `Laundry`
	
	FROM `fees_student` as `a` WHERE `sadmission`='$sadmission'";
	$rsBasicRpt=mysql_query($ssql);
	...
	while($row1=mysql_fetch_row($rsBasicRpt))
	{
		$tuitionfees=$row1[4];
		$SmartClass=$row1[5];
		$CompFees=$row1[6];
		$ScienceFees=$row1[7];
		$AnnualCharges=$row1[8];
		$admissionfees=$row1[9];
		$cautionfees=$row1[10];
		$registrationfees=$row1[11];
		$Transportfees=$row1[12];
		
		$HostelAdmissionFees=$row1[13];
		$HostelCautionfees=$row1[14];
		$Boarding=$row1[15];
		$Maintenance=$row1[16];
		$Electricity=$row1[17];
		$Activity=$row1[18];
		$Medical=$row1[19];
		$HouseKeeping=$row1[20];
		$Laundry=$row1[21];
		
		$Total=$row1[4]+$row1[5]+$row1[6]+$row1[7]+$row1[8]+$row1[9]+$row1[10]+$row1[11]+$row1[12]+$row1[13]+$row1[14]+$row1[15]+$row1[16]+$row1[17]+$row1[18]+$row1[19]+$row1[20]+$row1[21];
	}
	...
	<tr>
		...
		<td class="style3" style="width: 63px"><?php echo $Transportfees;?></td>
		<td class="style3" style="width: 63px"><?php echo $admissionfees;?></td>
		<td class="style3" style="width: 63px"><?php echo $cautionfees;?></td>
		<td class="style3" style="width: 63px"><?php echo $tuitionfees;?></td>
		<td class="style3" style="width: 63px"><?php echo $CompFees;?></td>
		<td class="style3" style="width: 63px"><?php echo $ScienceFees;?></td>
		<td class="style3" style="width: 63px"><?php echo $registrationfees;?></td>
		<td class="style3" style="width: 63px"><?php echo $AnnualCharges;?></td>
		<td class="style3" style="width: 63px"><?php echo $SmartClass;?></td>
		
		<td class="style3" style="width: 63px"><?php echo $HostelAdmissionFees;?></td>
		<td class="style3" style="width: 63px"><?php echo $HostelCautionfees;?></td>
		<td class="style3" style="width: 63px"><?php echo $Boarding;?></td>
		<td class="style3" style="width: 63px"><?php echo $Maintenance;?></td>
		<td class="style3" style="width: 63px"><?php echo $Electricity;?></td>
		<td class="style3" style="width: 63px"><?php echo $Activity;?></td>
		<td class="style3" style="width: 63px"><?php echo $Medical;?></td>
		<td class="style3" style="width: 63px"><?php echo $HouseKeeping;?></td>
		<td class="style3" style="width: 63px"><?php echo $Laundry;?></td>
		
		<td class="style3" style="width: 63px"><?php echo $Total;?></td>
