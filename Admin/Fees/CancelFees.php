...
<title>Quarterly Fees receipt Cancellation</title>
...
<p class="auto-style5" style="height: 12px"><strong><font size="3">Quarterly Fees 
receipt 
Cancellation</font></strong></p>
...
<table style="width: 100%" class="auto-style1">
			<form name="frmFindReceipt" id="frmFindReceipt" method="post" action="CancelFees.php" method="post">
			<tr>
			...
			<td class="style16">
			&nbsp;<p>
			<input name="Submit" type="button" value="Submit" onclick="Javascript:ShowReceiptDetail();" style="float: left; font-weight: 700"></p>
			<p>&nbsp;</p>
			<p>&nbsp;</td>
			</tr>
			</form>
...
<table cellspacing="0" cellpadding="0" class="style12" style="width: 100%">
	<form name="frmNewStudent" id="frmNewStudent" method="post" action="CancelledFeesReceipt.php">
	...
	<tr>
		...
		Fees Payment for Quarter</td>
				...
				<td class="auto-style19">
			<input name="txtQuarter" id="txtQuarter" class="text-box" type="text" value="<?php echo $Quarter; ?>"></td>
		...
		<input name="txtAdjustedLateFee" type="text" class="text-box" value="<?php echo $AdjustedLateFee; ?>" readonly="readonly"></td>
				...
				<input name="txtRefundLateFee" type="text" class="text-box" value="<?php echo $AdjustedLateFee; ?>" readonly="readonly"></td>
