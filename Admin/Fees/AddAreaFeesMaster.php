...
<table width="100%" border="1" style="border-collapse: collapse">
    <form name="frmFeeMaster" id="frmFeeMaster" method="post" action="TransportAreaFeesMaster.php">
<tr>
...
<td><font face="Cambria"><select name="transportHeadID" id="transportHeadID" style="float: left" ; required  class="text-box">
						 ...
						 <?php
							...
							?>
						 <option value="<?php echo $transportHeadId; ?>"><?php echo $transportHead; ?></option>
						 
						 <?php 
							}
							?>
			</select></font></td>
<td><font face="Cambria">Transport Area</font></td>
<td><font face="Cambria"><input type="text" name="transportArea" id="transportArea" size="20" class="text-box" required="true"></font></td>

<td><font face="Cambria"><input type="submit" name="submit" value="Submit " style="font-weight: 700" ></font></td>
