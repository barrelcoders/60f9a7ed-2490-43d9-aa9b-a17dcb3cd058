...
include '../Header/Header3.php';
	...
	$AdmissionId=$_REQUEST["txtAdmissionNo"];	
...
$ssql="select `ExamName`,`ExamFee`,`WorkBook`,`TextBook` from `fees_exam_master` where `sclass`='$MasterClass' and `ExamName` NOT IN (ANCQ)";
$rs=mysql_query($ssql);
...
function fnlCalculateTotal()
{
	...
	GrandTotalFee=parseInt(TotalExamFee)+ parseInt(TotalWorkBookFee)+ parseInt(TotalTextBookFee);
...
<hr>
<p>&nbsp;</p>
<form name="frmExam" id="frmExam" method="post" action="ExamFeeReceipt.php">
...
<tr>
	...
	<td colspan="5" align="right"><b><font face="Cambria">GRAND TOTAL : </font></b></td>
...
<table border="1" width="100%" cellspacing="0" cellpadding="0" style="border-collapse: collapse">
	<tr>
		<td align="center" width="1325" colspan="5"><font face="Cambria"><b>Payment Details</b></font></td>
	</tr>
	<tr>
		<td align="center" width="265"><b><font face="Cambria">Payment Mode</font></b></td>
		<td align="center" width="265"><b><font face="Cambria">Cheque No</font></b></td>
		<td align="center" width="265"><b><font face="Cambria">Cheque date</font></b></td>
		<td align="center" width="265"><b><font face="Cambria">Bank Name</font></b></td>
		<td align="center" width="265"><b><font face="Cambria">Total Amount</font></b></td>
	</tr>
	<tr>
		<td align="center" width="265">
		<p align="center">
		<select size="1" name="cboPaymentMode" id="cboPaymentMode">
		...
		<td align="center" width="265">
		<input type="text" name="txtChequeNo" id="txtChequeNo" size="20"></td>
		<td align="center" width="265">
		<input type="text" name="txtChequeDate" id="txtChequeDate" class="tcal" size="20"></td>
		<td align="center" width="265">
		<input type="text" name="txtBankName" id="txtBankName" size="20"></td>
		<td align="center" width="265">
		<input type="text" name="txtTotalAmount" id="txtTotalAmount" size="20"></td>
	</tr>
</table>
	<p align="center">
...
function validate()
{
	if(document.getElementById("cboPaymentMode").value=="Cheque" || document.getElementById("cboPaymentMode").value=="DD" || document.getElementById("cboPaymentMode").value=="Card")
	{
		if(document.getElementById("txtChequeNo").value=="" || document.getElementById("txtChequeDate").value=="" || document.getElementById("txtBankName").value=="" || document.getElementById("txtTotalAmount").value=="")
		{
			alert("Cheque No / Cheque Date / Bank Name is mandatory!");
			return;
		}		
	}
