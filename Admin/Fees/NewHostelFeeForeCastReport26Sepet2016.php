...
while($rowClass=mysql_fetch_row($rsClass))
{
	...
	$rs=mysql_query($ssql);
				...
				$FinalYearlyBalance=$FinalBillAmount-$HostelFirstInstallment-$FeesSecondInstallment-$FeesThirdInstallment-$FeesFourthInstallment;
