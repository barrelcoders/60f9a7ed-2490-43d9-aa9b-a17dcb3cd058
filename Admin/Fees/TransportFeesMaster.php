...
//  echo "INSERT INTO `tbl_transport_master`(`transportHead`,`amount`,`financialyear`,`status`) VALUES ('$transportHead','$Amount','$FYYear',1)";die;
// 
 $rsFeeHead=mysql_query("INSERT INTO `tbl_transport_master`(`transportHead`,`amount`,`financialyear`,`status`) VALUES ('$transportHead','$Amount','$FYYear',1)");
 echo "<br><br><center><b>Transport Fee defined successfully!<b>";

} 
$ssql="SELECT * FROM tbl_transport_master order by srno DESC";
...
<div class="admissionreport">
    <div class="admission_head">Transport Fees Master <div style="float: right"><a href="AddTransportFeesMaster.php">Add New Transport Fees Master</a></div></div>
...
$i=1;
  ...
  <tr>
                                                   <td><?php echo $i; ?></td>
                                                   <td><?php echo $row['transportHead']; ?></td>
                                                  ...
                                                  <?php if($row['status']==1){$statusClass="active";}else{ $statusClass="inactive"; } ?>
                                                   ...
                                                   <td><a href="updateTransportFeesMaster.php?srno=<?php echo $row['srno']; ?>">Update</a></td>
