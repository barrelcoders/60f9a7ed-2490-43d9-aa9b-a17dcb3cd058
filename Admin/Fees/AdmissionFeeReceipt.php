...
if ($_REQUEST["txtAdmission"] != "")
{
		...
		if (mysql_num_rows($result)==0)
		{
			...
			$ssql="INSERT INTO `NewStudentAdmission` (`sname` , `DOB`, `Sex`, `Category`, `Nationality`,`sadmission`, `sclass`,`srollno`,`LastSchool`, `sfathername`,`FatherEducation`, `FatherOccupation`, `MotherName`, `MotherEducation`,`Address`,`smobile`,`AlternateMobile`,`simei`,`suser`,`spassword`,`email`,`routeno`,`ProfilePhoto`,`FinancialYear`) VALUES('$Name','$DOB','$Sex','$Category','$Nationality','$Admission','$Class','$RollNo','$LastSchool','$Father','$FatherEducation','$FatherOccupation','$MotherName','$MotherEducation','$Address','$MobileNo','$AlternatMobileNo','$Imei','$UserId','$Password','$email','$Route','$ProfilePic','$FYear')";
			...
			$ssql1="INSERT INTO `AdmissionFees` (`sadmission`,`sname`,`sclass`,`srollno`,`amountpaid`,`AnnualAmtPaid`,`AdmissionFeeDiscType`,`AdmissionFeeDiscount`,`AnnualFeeDiscType`,`AnnualFeeDiscount`,`TotalDiscount`,`TotalAmtPayable`,`TotalAmoutPaid`,`BalanceAmt`,`FinancialYear`,`receipt`,`status`,`quarter`,`ReceiptFileName`) values ('$Admission','$Name','$Class','$RollNo','$AdmissionFeeAmt','$AnnualFeeAmt','$AdmissionDiscountType','$AdmissionDiscountFee','$AnnualFeeDiscountType','$AnnualFeeDiscount','$TotalDiscountFee','$TotalFeePayable','$TotalFeePaid','$TotalBalanceAmt','$FYear','$NewReciptNo','PAID','$Quarter','$PDFFileName')";
...
<div id="MasterDiv" style="border-style: solid; border-width: 1px; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px" >
	...
	<img border="0" src="../images/logo.png"  height="68" width="84"></font></p>
...
<form name="frmPDF" id="frmPDF" method="post" action="../StudentManagement/CreatePDF.php">
