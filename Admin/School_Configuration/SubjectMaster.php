...
<div class="row c">
 <div class="col-md-2 hris1"> 
  ...
  <ul>
   ...
   <li class="active"><a href="SubjectMaster.php"><button class="btnmanu">Subject Master </button></a></li>
						...
						<div class="col-sm-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Complete Subject Master</h6>
									</div>
										...
										<div class="table-wrap">
											<table id="footable_2" class="table" data-paging="true" data-filtering="true" data-sorting="true">
												...
												<tr>
													...
													<th data-name="masterSubject">Master Subject</th>
													<th data-name="subject">Subject</th>
													<th data-name="status" data-breakpoints="xs">Status [1= Active / 0= Inactive]</th>
												</tr>
												</thead>
												<tbody>
												<?php 
											...
											<div class="modal-dialog" role="document">
												<form class="modal-content form-horizontal" id="editor">
													<div class="modal-header">
														...
														<h5 class="modal-title" id="editor-title">Add New Subject</h5>
													</div>
													<div class="modal-body">
														<input type="number" id="id" name="id" class="hidden"/>
                                                    </div>
														<div class="form-group required">
															<label for="masterSubject" class="col-sm-3 control-label">Master Subject</label>
															<div class="col-sm-9">
																<select class="form-control" id="masterSubject" name="masterSubject" required>
	...
	ft = FooTable.init('#footable_2', {
		editing: {
			...
			addRow: function(){
				...
				$editor[0].reset();
				$editorTitle.text('Add New Subect');
				$modal.modal('show');
			...
			editRow: function(row){
				...
				$editor.find('#masterSubject').val(values.masterSubject);
				$editor.find('#subject').val(values.subject);
	...
	$editor.on('submit', function(e){
		...
		var row = $modal.data('row'),
			values = {
				...
				masterSubject: $editor.find('#masterSubject').val(),
				subject: $editor.find('#subject').val(),
