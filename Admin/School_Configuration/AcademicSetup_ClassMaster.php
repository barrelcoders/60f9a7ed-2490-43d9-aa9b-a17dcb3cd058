...
?>
<?php
$masterClass = $class = $status  = "";
if( isset($_POST['submit']) )
{
  $sql = "INSERT INTO `class_master`(`srno`, `MasterClass`, `class`, `status`, `datetime`) VALUES ('', '$masterClass', '$class', '$status', '')";
...
<style>
table.footable-editing button.footable-add{display:block; float:left;}
...
<div class="row c">
 <div class="col-md-2 hris1"> 
  <h4>SELF SERVICE</h4>
  <ul>
   <li class="active"><a href="AcademicSetup_ClassMaster.php"><button class="btnmanu">Class Master </button></a></li>
...
<!--------------Details------------------>
 <div class="col-md-10">
  <div class="academicsetup">
   <div class="academicsetup_outer"> 
     <div class="academicsetup_table">
      <!-- Row -->
					<div class="row">
						<div class="col-sm-12">
							<div class="panel panel-default card-view">
								<div class="panel-heading">
									<div class="pull-left">
										<h6 class="panel-title txt-dark">Complete Class Master</h6>
									</div>
										...
										<div class="table-wrap">
											<table id="footable_2" class="table" data-paging="true" data-filtering="true" data-sorting="true">
												...
												<tr>
													...
													<th data-name="masterClass">Master Class</th>
...
$sql="SELECT `srno`, `MasterClass`, `class`, `status`, `datetime` FROM `class_master` WHERE 1=1";
											...
											<div class="modal-dialog" role="document">
												<form class="modal-content form-horizontal" id="editor" method="post" action="AcademicSetup.php">
													<div class="modal-header">
														<button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        	<span aria-hidden="true">×</span></button>
														<h5 class="modal-title" id="editor-title">Add New Class</h5>
													</div>
													<div class="modal-body">
														<input type="number" id="id" name="id" class="hidden"/>
														<div class="form-group required">
															<label for="masterClass" class="col-sm-3 control-label">Master Class</label>
															<div class="col-sm-9">
																<select class="form-control" id="masterClass" name="masterClass" required>
														...
														<div class="form-group">
															<label for="status" class="col-sm-3 control-label">Status<br>[1= Active / 0= Inactive]</label>
															<div class="col-sm-9">
	...
	ft = FooTable.init('#footable_2', {
		editing: {
			...
			addRow: function(){
				...
				$editor[0].reset();
				$editorTitle.text('Add New Class');
				$modal.modal('show');
			...
			editRow: function(row){
				...
				$editor.find('#masterClass').val(values.masterClass);
	...
	$editor.on('submit', function(e){
		...
		var row = $modal.data('row'),
			values = {
				...
				masterClass: $editor.find('#masterClass').val(),
