...
<div class="row c">
 <div class="col-md-2 hris1"> 
  ...
  <ul>
   ...
   <li class="active"><a href="SalaryDeductionCom.php"><button class="btnmanu">Salary Deduction Components </button></a></li>
   <li><a href="DefineLeaveType.php"><button class="btnmanu">Define Leave Types </button></a></li>
  </ul>
 </div>
<!--------------Details------------------>
 <div class="col-md-10">
