...
$ssql="select `srno`,`RegistrationNo`,`sname`,`sclass`,`TxnAmount`,`RegistrationFormNo`,DATE_FORMAT(`RegistrationDate`,'%d-%m-%Y') as `date`,'Paid' from  `NewStudentRegistration` where 1=1";
if($DateFrom!="")
{
	$ssql=$ssql." and `RegistrationDate`>='$DateFrom' and `RegistrationDate`<='$DateTo'";
}
if($School!="All")
{
 ...
 <table id="table3" class="CSSTableGenerator" cellspacing="0" cellpadding="0" >
   	...
   	<tr>
		   <td class="style3" colspan="8">
			...
			<b>Registration Fees Report<br>Report Date:&nbsp; <?php 
	if($DateFrom!="")
	{
	//echo $currentdate1; 
	$arr=explode('-',$DateTo);
   	...
   	<tr>
		   ...
		   <td   align="center" width="189" class="style2"   bgcolor="#95C23D">
			...
			<font face="Cambria" size="3">Student Class</font></td>
   		   <td   align="center" width="189" class="style2" bgcolor="#95C23D" >
			<font face="Cambria" size="3">Registration Fee Paid</font></td>
