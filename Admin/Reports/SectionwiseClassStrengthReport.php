...
if($_REQUEST["cboSchool"]!="")
{
	...
	$ssql="SELECT distinct `sclass`,count(*) FROM `student_master` where 1=1";
	...
	$ssql=$ssql." group by `sclass` order by `sclass`";
 ...
 <table id="table3" class="style1" style="width:100%; " cellspacing="0" cellpadding="0" >
   	...
   	<tr>
		   <td class="style3" colspan="3">
			...
			</span>Class wise strength Report<br>Report Date:&nbsp; <?php echo $currentdate1; ?></strong></span><strong> </strong></td>
