...
<body>
<p>&nbsp;</p>
<p><b><font face="Cambria">Student Attendance Register</font></b></p>
<hr>
<p>&nbsp;</p>
...
<input type="hidden" name="isSubmit" id="isSubmit" value="yes">
		...
		<tr>
			<td style="width: 278px"><font face="Cambria">Class</font>:<select name="cboClass">
			...
			<td><font face="Cambria">Month</font>: <input type="month" name="month" id="month" style="width:150px;"></td>
			<td style="width: 278px"><font face="Cambria">Roll No:</font><input name="txtRollNo" id="txtRollNo" type="text"></td>
...
<?php
			...
			$query=$query." ORDER BY CAST(`srollno` AS UNSIGNED)";
...
?>
           ...
           else 
           {
			...
			{	
			    echo "<tr><td><input type='text'   name='srno'". $i."  value='".$test['srno']."'readonly style='background-color: #FFFFFF; color: #000000; text-align:center;                                 width:50px;'/</td>
				<td><input type='text'  name='sclass'". $i." value='".$test['sclass']."' readonly style='background-color: #FFFFFF; color: #000000;                     text-align:center;width:50px;''/></td>
				<td><input type='text'  name='sname'". $i." value='".$test['sname']."' readonly style='background-color: #FFFFFF; color: #000000; text-align:center;'/></td>
				<td><input type='text'  name='srollno'". $i." value='".$test['srollno']."' readonly style='background-color: #FFFFFF; color: #000000;                     text-align:center;width:50px;'/></td>";
