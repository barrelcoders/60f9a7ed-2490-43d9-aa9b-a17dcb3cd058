...
{
	//$ssql="SELECT DISTINCT  `sclass` , COUNT(*) , (SELECT COUNT(*) FROM  `NewStudentAdmission` WHERE  `sclass` = a.`sclass`) AS  `AdmissionCount`,(select COUNT(*) as `RegistrationCount` FROM  `NewStudentRegistration` where `sclass`=a.`sclass`) as `RegistrationCount` FROM  `student_master` AS  `a` where NOT (`sclass` like '%NURSERY%' OR `sclass` like '%LKG%' OR `sclass` like '%UKG%') GROUP BY  `sclass` ORDER BY `sclass`";
	$ssql="SELECT DISTINCT  `sclass` , COUNT(*) , (SELECT COUNT(*) FROM  `NewStudentAdmission` WHERE  `sclass` = a.`sclass`) AS  `AdmissionCount`,(select COUNT(*) as `RegistrationCount` FROM  `NewStudentRegistration` where `sclass`=a.`sclass`) as `RegistrationCount` FROM  `student_master` AS  `a` where NOT (`sclass` like '%NURSERY%' OR `sclass` like '%LKG%') GROUP BY  `sclass` ORDER BY `sclass`";
	$result=mysql_query($ssql);
	
	//$ssql1="SELECT DISTINCT  `sclass` , COUNT(*) , (SELECT COUNT(*) FROM  `student_master` WHERE  ucase(`sclass`) LIKE '%a.`sclass`%') AS  `StudentCount`,(select COUNT(*) as `AdmissionCount` FROM  `NewStudentAdmission` where ucase(`sclass`) LIKE '%a.`sclass`%') as `AdmissionCount` FROM  `NewStudentRegistration` AS  `a` where (`sclass` like '%NURSERY%' OR `sclass` like '%LKG%' OR `sclass` like '%UKG%') GROUP BY  `sclass` ORDER BY `sclass`";
	...
	//, (SELECT COUNT(*) FROM  `student_master` WHERE  ucase(`sclass`) LIKE '%a.`sclass`%') AS  `StudentCount`,(select COUNT(*) as `AdmissionCount` FROM  `NewStudentAdmission` where ucase(`sclass`) LIKE '%a.`sclass`%') as `AdmissionCount`
