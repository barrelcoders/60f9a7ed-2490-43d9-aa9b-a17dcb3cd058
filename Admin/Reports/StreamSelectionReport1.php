...
if($_REQUEST["isSubmit"]=="yes")
{
	...
	$ssql="SELECT `ProfilePhoto`,`sadmission`,`sname` ,`sclass`,`Stream`,`OptionalSubjects`,`ITR`,`MotherITR`,`ScoreCard` FROM `StudentMasterInfo` WHERE 1=1";
...
<form name="frmRpt" method="post" action="StreamSelectionReport1.php">
...
<td height="22" align="center" class="style12" ><b><font face="Cambria">
		...
		<td height="22" align="center" class="style13">
		<b><font face="Cambria">Marksheet</font></b></td>
...
<td style="width: 153px" font="Cambria" class="style10"><font face="Cambria"><?php echo $row[5];?></font></td>
<td style="width: 152px" font="Cambria" class="style13"><font face="Cambria"><a href="http://dpsfsis.com/Admin/StudentManagement/StudentDocuments/<?php echo $Marksheet;?>"  target="_blank">MarkSheet</a></font></td>
