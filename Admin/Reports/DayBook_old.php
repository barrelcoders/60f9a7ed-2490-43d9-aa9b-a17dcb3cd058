...
$ssqlReg="select `srno`,`sadmission`,`sname`,`sclass`,`amountpaid`,`receipt`,DATE_FORMAT(`date`,'%d-%m-%Y') as `date`,'Paid',`TxnId`,`PGTxnId` from  `fees` as `a` where 1=1";
if($DateFrom!="")
{
...
.style6 {
 ...
 <table id="table3" class="CSSTableGenerator" cellspacing="0" cellpadding="0" width="1327" >
	...
	?></strong></span></span><strong><font style="font-size: 12pt"> </font> </strong></td>
   	...
   	<tr>
		   <td   align="center" width="92" class="style2"   bgcolor="#95C23D" style="text-align: center; background-color: #009900; width: 120px;">
			<b>
			<font face="Cambria" size="3" color="#FFFFFF">Sr No</font></b></td>
		   <td   align="center" width="124" class="style2"   bgcolor="#95C23D" style="text-align: center; background-color: #009900; width: 120px;">
			<b>
			<font face="Cambria" size="3" color="#FFFFFF">Amount Type</font></b></td>
		   <td   align="center" width="111" class="style2"   bgcolor="#95C23D" style="text-align: center; background-color: #009900; width: 120px;">
			<b>
			<font face="Cambria" size="3" color="#FFFFFF">Unique Id. No.</font></b></td>
		   <td   align="center" width="109" class="style2"   bgcolor="#95C23D" style="text-align: center; background-color: #009900; width: 120px;">
			<b>
			<font face="Cambria" size="3" color="#FFFFFF">Source Name</font><font color="#FFFFFF">
			</font></b>
			</td>
			<td   align="center"   width="102" class="style2" bgcolor="#95C23D" style="text-align: center; background-color: #009900; width: 121px;">
			<b>
			<font face="Cambria" size="3" color="#FFFFFF">Class</font></b></td>
   		   <td   align="center" width="114" class="style2" bgcolor="#95C23D" style="text-align: center; background-color: #009900; width: 121px;" >
			<b>
			<font face="Cambria" size="3" color="#FFFFFF">Amount Paid</font></b></td>
			
			 
   		   
   		   <td   align="center" width="119" class="style2" bgcolor="#95C23D" style="text-align: center; background-color: #009900; width: 121px;" >
			<b>
   	...
   	?>
   	<tr>
		   <td   align="center" width="92" class="style2" style="width: 120px"   >
			<font face="Cambria" size="3"><?php echo $RecCount;?></font></td>
		   <td   align="center" width="124" class="style2" style="width: 120px"   >
			<font face="Cambria" style="font-size: 11pt">Registration Fee</font></td>
		   <td   align="center" width="111" class="style2" style="width: 120px"   >
			<font face="Cambria" size="3"><?php echo $RegistrationNo;?></font></td>
		   <td   align="center" width="109" class="style2" style="width: 120px"   >
			<font face="Cambria" size="3"><?php echo $sname;?></font>
			</td>
			<td   align="center"   width="102" class="style2" style="width: 121px" >
			<font face="Cambria" size="3"><?php echo $sclass;?></font></td>
   		   <td   align="center" width="114" class="style2" style="text-align: right; width: 121px;"  >
			<font face="Cambria" size="3"><?php echo $TxnAmount;?></font></td>
			
   
   		   <td   align="center" width="119" class="style2" style="width: 121px"  >
		   ...
		   <td   align="center" width="119" class="style2" style="text-align: center; width: 121px;"  >
   	...
   	<tr>
		   <td class="style5" colspan="5" style="background-color: #009900"   >
			<strong><span class="style4">Total Collection amount</span>:</strong></td>
   		   <td   align="center" width="114" class="style2" style="background-color: #009900; text-align:right; width: 121px;"  >
			<font face="Cambria" size="3"><strong><span class="style4"><?php echo $TotalRegistrationFeePaid;?></span></strong></font></td>
   
   		   <td   align="center" class="style2" colspan="5" style="width: 932px"  >
			&nbsp;</td>
   	...
   	<tr>
		   <td class="style5" colspan="5"   >
			<b><font size="3">Registration Fees Collection</font></b></td>
   		   <td   align="center" class="style2" colspan="6" style="width: 1121px"  >
   	...
   	<tr>
		   <td class="style3" colspan="5"   >
			<strong>Cashier</strong></td>
   		   <td   align="center" class="style2" colspan="3" style="width: 1134px"  >
			<strong>Accounts Officer / Sr. Accountant</strong></td>
   

		   			   
   		   <td class="style3" colspan="3" style="width: 552px"  >
