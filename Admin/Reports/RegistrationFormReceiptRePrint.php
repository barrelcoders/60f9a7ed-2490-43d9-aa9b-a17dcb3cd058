...

{
			...
			$ssqlRegi="SELECT `sname`,`slastname`,`RegistrationNo`,`sclass`,`TxnAmount`,`smobile`,`email`,`RegistrationFormNo`,`ProfilePhoto` FROM `NewStudentRegistration` as `a` where `srno`='$srno'";
	...
	<div align="center">
		...
		<table cellpadding="0" style="border-style:dotted; border-width:1px; width: 61%; border-collapse:collapse; padding-left:4px; padding-right:4px; padding-top:1px; padding-bottom:1px" >
			...
			<tr>
				...
				<td align="left" style="border-style: dotted; border-width: 1px; width: 191px" rowspan="5">



	<img src="../../StudentRegistrationPhotos/<?php echo $ProfilePic;?>" height="120px;" width="139px;"></td>
