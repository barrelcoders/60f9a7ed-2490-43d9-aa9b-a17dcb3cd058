...
?>
			...
			{	
				...
				$tp="select `attendance` FROM `attendance` where  `srollno`='$test[srollno]' and `attendance`='P'  and                     sclass='$class'  " ;
                $tp1= mysql_query($tp);
				...
				$tp11="select `attendance` FROM `attendance` where  `srollno`='$test[srollno]' and `attendance`='A' and                       sclass='$class'  " ;
				...
				$tp21="select `attendance` FROM `attendance` where  `srollno`='$test[srollno]' and `attendance`='L'  and                        sclass='$class' " ;
