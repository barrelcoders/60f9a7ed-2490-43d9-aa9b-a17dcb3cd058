					...
					$rsD= mysql_query($ssql);
	   				...
	   				{	
						while($row1 = mysql_fetch_assoc($rsD))
		   				...
		   				$ssql="select `remarks`,`marks`,`Grade`,`GradePoint` from `report_card` where `sname`='$StudentName' and `sclass`='$SelectedClass' and `srollno`='$StudentRollNo' and `subject`='$SelectedSubject' and `testtype`='$SelectedTestType'";
