...
<img height="28" src="images/BackButton.png" width="70" style="float: right"></a></p>
	...
	<tr>
		...
		-->
				...
				<select name="examtype" id="examtype" style="float: left" ; required >
						 <option selected="" value="Select One">Select One</option>
						 <?php
						 if ($_REQUEST["SubmitType"]=="ReloadWithSubject")
							{
							$ssqlName="SELECT distinct `examtype` FROM `exam_master` where `class` in (select `MasterClass` from `class_master` where `class`='$class') and `status`='1'";
		...
		<table width="100%" cellpadding="0" class="style6" >
			...
			<tr>
				...
				while($rowG = mysql_fetch_row($rsGrade1))
				{
					$Grade1=$rowG[0];
				?>
				<option value="<?php echo $Grade1; ?>"><?php echo $Grade1; ?></option>
				<?php
				}
				?>
				</select></td>
				...
				<td style="border-style:solid; border-width:1px; width: 248px; height: 21px" class="style7">
				<input name="assignmentproject<?php echo $Cnt;?>" id="assignmentproject<?php echo $Cnt;?>" type="text" readonly="readonly"></td>
				<?php
				...
				<?php
							while($rowG2 = mysql_fetch_row($rsGrade2))
							{
									$Grade2=$rowG2[0];
							?>
						 <option value="<?php echo $Grade2; ?>"><?php echo $Grade2; ?></option>
						 <?php 
							}
							?>
				</select>
				...
				<td style="border-style:solid; border-width:1px; width: 248px; height: 21px" align="center">
				<input name="ppassignment<?php echo $Cnt;?>" id="ppassignment<?php echo $Cnt;?>" type="text" readonly="readonly"></td>
				<?php
				...
				<option selected="" value="Select One">Select One</option>
							...
							while($rowG3 = mysql_fetch_row($rsGrade3))
							{
									$Grade3=$rowG3[0];
							?>
						 <option value="<?php echo $Grade3; ?>"><?php echo $Grade3; ?></option>
						 <?php 
							}
							?>
				</td>
				...
				<input name="txtnumeracy<?php echo $Cnt;?>" id="txtnumeracy<?php echo $Cnt;?>" type="text"></td>
				<?php
				...
				<option selected="" value="Select One">Select One</option>
							...
							while($rowG4 = mysql_fetch_row($rsGrade4))
							{
									$Grade4=$rowG4[0];
							?>
						 <option value="<?php echo $Grade4; ?>"><?php echo $Grade4; ?></option>
						 <?php 
							}
							?>
				</td>
				...
				<input name="txtselfenv<?php echo $Cnt;?>" id="txtselfenv<?php echo $Cnt;?>" type="text"></td>
