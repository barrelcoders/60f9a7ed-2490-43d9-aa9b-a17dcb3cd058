...
<title>Report Card Education Visual Aarts</title>
...
<form method="post">
	...
	<table border="1px" width="100%">
		 <tr>
		        ...
		        <td style="width: 179px; height: 52px;" class="auto-style38" bgcolor="#CC0033" colspan="2"> <h1><font color="#000000"> Report Card Education Visual Aarts</font></h1></td> 
		 </tr>
    ...
    <table table width="100%" bordercolor="#000000" id="table3" class="style2" border=1 style="width:800px;" align="center">
   	...
   	<tr>
		   ...
		   <td height="35" bgcolor="#CC0033" align="center" style="width: 54px" class="style11">DESCRIPTIVE INDICATOR</td>
   		    <td height="35" bgcolor="#CC0033" align="center" style="width: 54px" class="style11">SUB INDICATOR</td>
   		...
   		$result=mysql_query("select * from  reportcard_education_visual_arts");
