...
<table  width="100%" cellspacing="0" cellpadding="0" style="border-collapse: collapse">
	<tr >
		...
		<font face="Cambria" style="font-size: 24pt"><b><?php echo $SchoolName2 ?></b><b><?php echo $AffiliationNo; ?></b></font><font style="font-size: 11pt"><br>
	...
	<div align="center">
		<table border="1" width="90%" cellspacing="0" cellpadding="0" style="border-collapse: collapse; border-left-width:0px; border-right-width:0px" >
			<tr>
				...
				<td align="center" width="6%" style="border-style:solid; border-width:1px; height: 16px">
				<font face="Cambria" style="font-size: 10pt"><b>GRADES</b></font></td>
				<td align="center" style="border-style:solid; border-width:1px; height: 16px" width="81%"><b>
			...
			?>
			<tr>
				<td width="13%" bgcolor="#C0C0C0" align=center class="style4" style="border-style: solid; border-width: 1px">
				<font face="Cambria" style="font-size: 10pt">&nbsp;<?php echo $Subject;?></font></td>
				<td bgcolor="#C0C0C0" width="6%" align="left" class="style17" style="border-style: solid; border-width: 1px">&nbsp;</td>
				...
				?>
			<tr>
				<td width="13%" class="style16" style="height: 19px; border-left-color:#C0C0C0; border-left-width:1px">
				<font face="Cambria" style="font-size: 10pt">&nbsp;
				<?php echo $descriptiveindicator;?></font></td>
				<td width="6%" class="style16" align="center" style="height: 19px">
				<font face="Cambria" style="font-size: 10pt">&nbsp;<?php echo $Grade;?></font></td>
				<td class="style16" style="height: 19px; border-right-color:#808080; border-right-width:1px" width="81%"><font style="font-size: 10pt">&nbsp;<?php echo $indicatordescription;?> </font></td>
			</tr>
				...
				?>
				<tr>
				<td width="170" colspan="3" class="style3" style="border-bottom-color: #A0A0A0; border-bottom-width: 1px; border-left-color:#C0C0C0; border-left-width:1px; border-right-color:#808080; border-right-width:1px">
				&nbsp;</td>
				</tr>
			<?php
			}
