...
<font face="Cambria"><br></font>
	<table width="90%" align=Center cellspacing="0" border=1 cellpadding="0" style="border-collapse: collapse" height="60">
			...
			<table width="90%" align=Center cellspacing="0" cellpadding="0" style="border-collapse: collapse" height="60">
				<tr >
				<td align=left colspan="3"><font face="Cambria">Specific Remarks:__________________________________________________________________________________</td>
			
			</tr>
			<tr >
				<td align=left colspan="3"><font face="Cambria">______________________________________________________________________________________________________</td>
	...
	<table width="90%" align=center cellspacing="0" cellpadding="0" style="border-collapse: collapse" height="100">
			...
			<tr>
				...
				<!--<p align="center"><font face="Cambria" style="font-size: 10pt"><b>A* - Outstanding, A - Excellent, B - Very good, C - Good</b></font>-->
				</td>
			</tr>
			</table>
