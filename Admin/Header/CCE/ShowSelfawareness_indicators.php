...
<title>Report Card Self Awareness</title>
...
<form method="post">
	...
	<table border="1px" width="100%">
		 <tr>
		        ...
		        <td style="width: 179px; height: 52px;" class="auto-style38" bgcolor="#CC0033" colspan="2"> <h1><font color="#000000">   Report Card Self Awareness</font></h1></td> 
		 </tr>
 ...
 echo'<br>	
    ...
    <table table width="100%" bordercolor="#000000" id="table3" class="style2" border=1 style="width:800px;" align="center">
     	...
     	<tr>
   		...
   		$result=mysql_query("select * from    reportcard_selfawareness");
