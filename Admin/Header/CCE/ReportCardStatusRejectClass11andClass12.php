...
$ssql="SELECT distinct `sadmission`,`sname`,`sclass`,`srollno`,`testtype`,`approvalstatus` FROM `reportcard_Class11and12_values` where `sclass`='$SelectedClass' and `testtype`='$SelectedExamType' order by `sname` desc";
$rs= mysql_query($ssql);
