...
$AdmissionId=$row1[0];
	...
	$sql = "SELECT distinct `subject`,`testtype`,`MaxMarks`,`Grade`,`GradePoint`,`marks`,UT,A1,A2,A3,OTBA,ASL FROM `report_card` WHERE `testtype`='FA1' and `sadmission`= '$AdmissionId'";
				...
				while($rowTerm1Grade = mysql_fetch_row($rsTerm1Grade))
  				{
  					...
  					//echo "(".$Term1TotalObtainedMarks."/".$Term1TotalMaxMarks.")".$rowTerm1Grade[0];
  					//exit();
  					break;
  				}
