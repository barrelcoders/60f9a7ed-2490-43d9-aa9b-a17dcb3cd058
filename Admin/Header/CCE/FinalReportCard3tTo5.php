...
<table  width="100%" cellspacing="0" cellpadding="0" style="border-collapse: collapse">
	<tr >
		...
		<tr><td colspan=2 align=center><b><font face="Cambria" size="4">Achievement Record</font></b></td></tr>	
...
$strOneStudent=$strOneStudent.$DOB.'</font></td>
	...
	<div align="center">
		<table border="1" width="90%" cellspacing="0" cellpadding="0" style="border-collapse: collapse">
			...
			<tr>
				<td width="30%" bgcolor="#C0C0C0" align=center class="style4">
				<font face="Cambria" style="font-size: 10pt">&nbsp;'.$Subject.'</font></td>
				<td bgcolor="#C0C0C0" width="10%" align="left" class="style17">&nbsp;</td>
	...
	$strOneStudent=$strOneStudent.'				
			<tr>
				<td width="35%" class="style16" style="height: 19px">
				...
				<td class="style16" style="height: 19px"><font style="font-size: 10pt">&nbsp;'.$indicatordescription.'</font></td>
			</tr>';
				}
	$strOneStudent=$strOneStudent.'
				<tr>
				<td width="170" colspan="3" class="style3" style="border-bottom-color: #000000; border-bottom-width: 1px; style="border-collapse: collapse">
				&nbsp;</td>
				</tr>';
			}
$strOneStudent=$strOneStudent.'
			</table>
			<table width="90%" align=center cellspacing="0" cellpadding="0" style="border-collapse: collapse" height="154" style="border-collapse: collapse">
				<tr>
