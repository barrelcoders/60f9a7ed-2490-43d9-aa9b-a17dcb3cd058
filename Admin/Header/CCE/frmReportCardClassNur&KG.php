...
<img height="28" src="images/BackButton.png" width="70" style="float: right"></a></p>
	...
	<tr>
		...
		<p style="text-align: center">
			<select name="cboSubject" id="cboClass0" class="auto-style23" onchange="Javascript:fnlExam();" size="1">
	...
	<tr>
		...
		<td class="style3" colspan="7" style="border-bottom-style: none; border-bottom-width: medium; height: 59px;">
	<?php
	if ($_REQUEST["SubmitType"]=="ReloadWithSubject")
	{
	?>
		...
		<table width="100%" cellpadding="0" class="style6" >
			...
			<tr>
				...
				<td style="border-style:solid; border-width:1px; height: 36px; width: 248px" class="style7" bgcolor="#95C23D" align="center">
				<font face="Cambria">
				<b>Student Name:</b></font></td>
				...
				<b>Speaking Grade</b></font></td>

				<td style="border-style:solid; border-width:1px; height: 36px; width: 248px" class="style7" bgcolor="#95C23D" align="center">

				<b><font face="Cambria">Speaking Remarks</font></b></td>
				<td class="style8" style="border-style:solid; border-width:1px; width: 248px" bgcolor="#95C23D" align="center">
				<font face="Cambria">
				<b>Writing Grade</b></font></td>
				<td class="style8" style="border-style:solid; border-width:1px; width: 248px" bgcolor="#95C23D" align="center">
				<font face="Cambria">
				<b>Writing Remarks</b></font></td>
				<td class="style8" style="border-style:solid; border-width:1px; width: 248px" bgcolor="#95C23D" align="center">
				<font face="Cambria">
				<b>Grade</b></font></td>
				...
				<td class="style8" style="border-style:solid; border-width:1px; width: 248px" bgcolor="#95C23D" align="center">
				<font face="Cambria">
				<b>Self and Environment</b></font></td>

				<td class="style8" style="border-style:solid; border-width:1px; width: 248px" bgcolor="#95C23D" align="center">
				<font face="Cambria">
				<b>Star Ranking</b></font></td>
...
?>
	...
	<tr>
		...
		<td class="style5" colspan="7" style="border-style: none; border-width: medium">
