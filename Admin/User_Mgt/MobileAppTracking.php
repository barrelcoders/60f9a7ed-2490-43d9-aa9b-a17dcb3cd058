...
<div class="row c">
 <div class="col-md-2 hris1"> 
  ...
  <ul>
   ...
   <li class="active"><a href="MobileAppTracking.php"><button class="btnmanu">Mobile Application </button></a></li>
  </ul>
 </div>
<!--------------Details------------------>
 <div class="col-md-10">
  <div class="logintracking">
   <div class="logintracking_parent">
    <div class="logintracking_head">Mobile Application Login Tracking</div>
