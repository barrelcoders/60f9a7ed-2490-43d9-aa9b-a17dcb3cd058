...
<!--------------Details------------------>
 <div class="col-md-10">
  <div class="emplmaster-desig">
   <div class="emplmastertop">Add Section Field</div>
   <div class="row">
    <div class="col-xs-4"><b>1.</b>&nbsp;Section :</div>
    <div class="col-xs-8"><input type="text" name="employeesection" id="employeesection" class="text-box"></div>
    <div class="col-xs-4"><b>2.</b>&nbsp;Status :</div>
    <div class="col-xs-8"><select name="sectionstatus" id="sectionstatus" class="text-box tbs">
 ...
 <div class="empdepartment-table" style="display:none;" id="comment">
  <table>
   <tr class="col"> <td>Sr.No.</td><td>Section</td><td>Status</td> </tr>
