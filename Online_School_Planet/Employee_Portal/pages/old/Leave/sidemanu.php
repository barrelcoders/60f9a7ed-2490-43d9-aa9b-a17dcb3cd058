  ...
  <div class="a11">
   <div align="center" style="font-size:15px; color:#0b462d; margin-top:12px; line-height:1;">
    <img src="../../images/DPS Logo.jpg" class="img-responsive" width="100px;" height="100px"><br>
    Sharvan Kumar<br>
    kbg
   </div>
	 <h4 align="center" style="background:#0b462d; color:#fff; padding:1.5%;"><b>IMPORTANT LINKS</b></h4>
	 <ul>
