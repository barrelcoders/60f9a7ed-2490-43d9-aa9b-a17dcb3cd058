...
<div id="container">
 ...
 <div class="row">
  ...
  <div class="col-xs-3 xs1"> <input name="txtAge" id="txtAge" type="text" class="text-box" onClick="javascript:CalculateAgeInQC();" readonly placeholder="01-April-2017"></div>
 </div>
 <div class="row">
 ...
 <div class="row">
  ...
  <div class="col-xs-3 xs1"> <textarea name="txtAddress" id="txtAddress" class="text-box-address text-box tba" rows="3" ></textarea></div>
  <div class="col-xs-3"> Select Locality*: </div>
  <div class="col-xs-3"> 
  	<select name="cboLocation" id="cboLocation" class="text-box tbs" size="1">
  ...
  <div class="col-xs-3"> Tick If Applicable:</div>
  <div class="col-xs-3"> 
    <select name="cboHostelFacility" class="text-box" id="cboHostelFacility">
		<option value="">Select One</option>
 ...
 <div class="row">
  ...
  <div class="col-xs-3 xs"> Highest Qualification Mode*: </div>
 ...
 <div class="row">
  <div class="col-xs-3"> Father's Annual Income*:</div>
  <div class="col-xs-3"> 
 	<select name="txtFatherAnnualIncome" id="txtFatherAnnualIncome" class="text-box tbs">
		<option selected value="">Select One</option>
 ...
 <div class="row">
  ...
  <div class="col-xs-3"> <input name="txtFatherOfficialPhNo" id="txtFatherOfficialPhNo" class="text-box" type="text"></div>
 </div>
 <div class="row">
 ...
 <div class="row">
  <div class="col-xs-3"> Mother's Annual Income:<br> <font class="f">(If employed)</font></div>
  <div class="col-xs-3"> 
  	<select name="txtMotherAnnualIncome" id="txtMotherAnnualIncome" class="text-box tbs">
		<option value="">Select One</option>
		<option value="Less than 1 Lakh">Less than 1 Lakh</option>
		<option value="1 Lakh to 2 Lakhs">1 Lakh to 2 Lakhs</option>
		<option value="2 Lakhs to 3 Lakhs">2 Lakhs to 3 Lakhs</option>
 ...
 <div class="row">
  ...
  <div class="col-xs-3"> Residence Landline. No:</div>
  <div class="col-xs-3"> <input name="txtMotherOfficialPhNo" id="txtMotherOfficialPhNo" class="text-box" type="text"></div>
 </div>
 <div class="row">
 ...
 <div class="row">
  <div class="col-xs-3">Family Annual Income</div>
  <div class="col-xs-3"><input type="text" name="familyincome" id="familyincome" class="text-box"></div>
 ...
 <div class="row">
  ...
  <div class="col-xs-3 xs"> Guardian's Annual Income:<br><font class="f">(If employed)</font></div>
  <div class="col-xs-3 xs1"> <input name="txtGuradianAnnualIncome" id="txtGuradianAnnualIncome" class="text-box" type="text" ></div>
 </div>
 <div class="row">
 ...
 <div align="center">
		...
		</strong> <p>(If there is more than one sibling, mention any one)</p>
 </div>
 <div>&nbsp;</div>
 <div class="row">
 ...
 <div class="row">
  ...
  <div class="col-xs-3">
   <select size="1" name="cbosingleparent" id="cbosingleparent" class="text-box tbs"  onchange="Javascript:fnlChkSpecialNeedDetail();">
		<option value="">Select One</option>
 ...
 <div class="row">
  ...
  <div class="col-xs-3"> Last Passout Class:</div>
  <div class="col-xs-3"> 
 ...
 <div class="row">
  ...
  <div class="col-xs-3">
   <select size="1" name="cboSpecialNeed" id="cboSpecialNeed" class="text-box tbs"  onchange="Javascript:fnlChkSpecialNeedDetail();">
		<option value="">Select One</option>
 ...
 <div class="row">
  <div class="col-xs-6 xss"> 2. Photograph of Applicant* :</div>
 ...
 <div class="row">
  <div class="col-xs-6 xss"> 5. Previous Class Score Card (Applicable Only for Admission to Class Prep to IX and Class XIth) :</div>
  <div class="col-xs-6 xss1"> <input type="file" name="F3" ></div>
 </div>
 <div class="row">
  <div class="col-xs-6 xss"> 6. Copy Of ST/SC/OBC Certificate * :</div>
  <div class="col-xs-6 xss1"> <input type="file" name="F2" accept="image/gif, image/jpeg, image/png, image/tiff, image/bmp,image/tif,image/gif"> </div>
 </div>
 ...
 <div class="row">
  <div class="col-xs-12" style="padding:0 4%;"><strong>Declaration:</strong>
    <p><b>1.</b>I understand that the registration fee of <span style="font-weight: 400">INR 25</span>/- (NURSERY) 
