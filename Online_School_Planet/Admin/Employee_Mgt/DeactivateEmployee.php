...
<div class="row c">
 <div class="col-md-2 hris1"> 
  <h4>SELF SERVICE</h4>
  <ul>
   <li class="active"><a href="DeactivateEmployee.php"><button class="btnmanu">De-Activate An Employee </button></a></li>
...
<!--------------Details------------------>
 ...
 <div class="employee_mgt">
  <div class="empmgt_top">De-Activate An Employee</div>
  <div class="emp_search1">
   ...
   <div class="col-xs-12" align="center" style="margin-top:1%"><input type="submit" name="submit" id="submit" class="btn" ></div>
  </div>
