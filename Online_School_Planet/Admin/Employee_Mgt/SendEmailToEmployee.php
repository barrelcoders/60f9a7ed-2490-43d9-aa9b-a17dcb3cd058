...
<div class="row c">
 <div class="col-md-2 hris1"> 
  <h4>SELF SERVICE</h4>
  <ul>
   <li><a href="SendSMSToEmployee.php"><button class="btnmanu">Send SMS to Employee </button></a></li>
   <li class="active"><a href="SendEmailToEmployee.php"><button class="btnmanu">Send Email to Employee  </button></a></li>
...
<!--------------Details------------------>
 <div class="col-md-10">
  ...
  <div class="employee_mgt">
   <div class="empmgt_top">Send Email to Employees</div>
