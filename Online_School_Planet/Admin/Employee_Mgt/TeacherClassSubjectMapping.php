...
<div class="row c">
 <div class="col-md-2 hris1"> 
  ...
  <ul>
   ...
   <li class="active"><a href="TeacherClassSubjectMapping.php"><button class="btnmanu">Teacher-Class-Subject Mapping </button></a></li>
...
<!--------------Details------------------>
 ...
 <div class="employee_mgt">
  <div class="empmgt_top">Teacher-Class-Subject Mapping</div>
									...
									<div class="table-wrap">
										<div class="table-responsive">
											<table id="datable_1" class="table table-hover display  pb-30" >
												...
												<tbody>
                                                <?php
$sql = "SELECT `EmpId` , `Name` , `ClassTeacher` ,`TeachingSubject` FROM `employee_master` where 1=1"  ;
