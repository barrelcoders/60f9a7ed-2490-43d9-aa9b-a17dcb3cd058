...
<div class="row c">
 <div class="col-md-2 hris1"> 
  <h4>SELF SERVICE</h4>
  <ul>
   <li class="active"><a href="LoginTracking_admin-office.php"><button class="btnmanu">Admin & Office User Tracking </button></a></li>
   <li><a href="ParentPortalTracking.php"><button class="btnmanu">Parent Portal </button></a></li>
...
<!--------------Details------------------>
 <div class="col-md-10">
  <div class="logintracking">
   <div class="logintracking_admin">
    <div class="logintracking_head">Office Users Login Tracking</div>
