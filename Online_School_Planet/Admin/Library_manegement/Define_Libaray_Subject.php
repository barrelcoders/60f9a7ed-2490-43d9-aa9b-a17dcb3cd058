...
<div class="row c">
 <div class="col-md-2 hris1"> 
  ...
  <ul>
   ...
   <li class="active"><a href="Define_Libaray_Subject.php"><button class="btnmanu">Define Library Subjects </button></a></li>
...
<!--------------Details------------------>
 <div class="col-md-10">
  	<div class="librarysetup">
    	<div class="librarysetup_head">Add Subject</div>
        <div class="librarysetup_input1">
        	<form action="" method="post">
	        	<div class="row">
                	<div class="col-xs-6"><b>1. &nbsp; Subject Code:</b></div>
                    <div class="col-xs-6"><input type="text" name="subjectCode" id="subjectCode" class="text-box" value=""></div>
                </div>
	        	<div class="row">
                	<div class="col-xs-6"><b>2. &nbsp; Subject Name:</b></div>
                    <div class="col-xs-6"><input type="text" name="subjectName" id="subjectName" class="text-box" value=""></div>
                </div>
	        	<div class="row">
                	<div class="col-xs-6"><b>3. &nbsp; Subject Sub-Category:</b></div>
                    <div class="col-xs-6"><input type="text" name="subjectSubCategory" id="subjectSubCategory" class="text-box" value=""></div>
                </div>
	        	<div class="row">
