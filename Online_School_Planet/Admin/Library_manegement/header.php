  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li class="active"><a href="LibraryMgt_Landing.php">HOME</a></li>
        <li><a href="LibrarySetup_Name.php">Library Setup</a></li>
        <li><a href="BookIssue_Return.php">Book Issue / Return</a></li>
        <li><a href="Acquisition_Add.php" >Acquisition</a></li>
        <li><a href="Report_Book.php">REPORTS</a></li>
