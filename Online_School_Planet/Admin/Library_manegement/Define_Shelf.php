...
<div class="row c">
 <div class="col-md-2 hris1"> 
  ...
  <ul>
   ...
   <li class="active"><a href="Define_Shelf.php"><button class="btnmanu">Define Shelf  </button></a></li>
...
<!--------------Details------------------>
 <div class="col-md-10">
  	<div class="librarysetup">
    	<div class="librarysetup_head">Shelf Information</div>
        <div class="librarysetup_input1">
        	<form action="" method="post">
	        	<div class="row">
                	<div class="col-xs-6"><b>1. &nbsp; Shelf No:</b></div>
                    <div class="col-xs-6"><input type="text" name="shelfNo" id="shelfNo" class="text-box" value=""></div>
                </div>
	        	<div class="row">
                	<div class="col-xs-6"><b>2. &nbsp; Name:</b></div>
                    <div class="col-xs-6"><input type="text" name="shelfName" id="shelfName" class="text-box" value=""></div>
                </div>
	        	<div class="row">
                	<div class="col-xs-6"><b>3. &nbsp; Row:</b></div>
                    <div class="col-xs-6"><input type="text" name="shelfRow" id="shelfRow" class="text-box" value=""></div>
                </div>
	        	<div class="row">
