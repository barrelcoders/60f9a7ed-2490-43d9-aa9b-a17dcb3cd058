...
<div class="row c">
 <div class="col-md-2 hris1"> 
  <h4>SELF SERVICE</h4>
  <ul>
   <li class="active"><a href="LibrarySetup_Name.php"><button class="btnmanu">Define Library Name </button></a></li>
...
<!--------------Details------------------>
 <div class="col-md-10">
  	<div class="librarysetup">
    	<div class="librarysetup_head">Add Library</div>
        <div class="librarysetup_input">
        	<form action="" method="post">
	        	<div class="row">
                	<div class="col-xs-3"><b>Add Library Name:</b></div>
                    <div class="col-xs-6"><input type="text" name="libraryname" id="libraryname" class="text-box" value=""></div>
