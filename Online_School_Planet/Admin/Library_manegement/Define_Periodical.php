...
<div class="row c">
 <div class="col-md-2 hris1"> 
  ...
  <ul>
   ...
   <li class="active"><a href="Define_Periodical.php"><button class="btnmanu">Define Periodicals  </button></a></li>
...
<!--------------Details------------------>
 <div class="col-md-10">
  	<div class="librarysetup">
    	<div class="librarysetup_head">Periodical Type Information</div>
        <div class="librarysetup_input1">
        	<form action="" method="post">
	        	<div class="row">
                	<div class="col-xs-6"><b>1. &nbsp; Periodical Type:</b></div>
                    <div class="col-xs-6"><input type="text" name="periodicalType" id="periodicalType" class="text-box" value=""></div>
                </div>
	        	<div class="row">
                	<div class="col-xs-6"><b>2. &nbsp; Periodical Name:</b></div>
                    <div class="col-xs-6"><input type="text" name="periodicalName" id="periodicalName" class="text-box" value=""></div>
                </div>
	        	<div class="row">
                	<div class="col-xs-6"><b>3. &nbsp; Periodical Frequency:</b></div>
                    <div class="col-xs-6"><input type="text" name="periodicalFrequency" id="periodicalFrequency" class="text-box" value=""></div>
                </div>
	        	<div class="row">
