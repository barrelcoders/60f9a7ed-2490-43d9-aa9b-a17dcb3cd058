...
<div class="row c">
 <div class="col-md-2 hris1"> 
  ...
  <ul>
   ...
   <li class="active"><a href="Book_Issue_Staff.php"><button class="btnmanu">Book Issue To Staff  </button></a></li>
...
<!--------------Details------------------>
 <div class="col-md-10">
  	<div class="librarysetup">
    	<div class="librarysetup_head">Issue Book To Staff Members</div>
        <div class="librarysetup_input2">
        	<form action="" method="post">
	        	<div class="row">
                	<div class="col-xs-12 h">Staff Information :-</div>
                </div>
                <div class="row">
                	<div class="col-xs-3"><b>Emp No.:</b></div>
                    <div class="col-xs-3"><input type="text" name="emplNo" id="emplNo" class="text-box" value=""></div>
                	<div class="col-xs-3"><b>Emp Name:</b></div>
                    <div class="col-xs-3"><input type="text" name="emplName" id="emplName" class="text-box" value=""></div>
                </div>
	        	<div class="row">
                	<div class="col-xs-3"><b>Emp Type:</b></div>
                    <div class="col-xs-3"><input type="text" name="emplType" id="emplType" class="text-box" value=""></div>
                	<div class="col-xs-3"><b>Mobile No:</b></div>
                    <div class="col-xs-3"><input type="text" name="emplMobile" id="emplMobile" class="text-box" value=""></div>
                </div>
        	...
        	<form action="" method="post">
                <table class="table-responsive" >
                    <tr class="col">
                        ...
                        <td width="50px">Emp No.</td>
                        <td width="130px">Emp Name</td>
                        <td width="50px">Emp Type</td>
                        <td width="50px">Mobile No</td>
                    ...
                    <tr>
                        <td>1.</td>
                        <td width="50px"><input type="text" name="emplNo1" id="emplNo1" class="tb" value="A-101" readonly></td>
                        <td width="130px"><textarea name="emplName1" id="emplName1" class="tb" readonly>wsdfjiko</textarea></td>
                        <td width="50px"><input type="text" name="emplType1" id="emplType1" class="tb" value="1" readonly></td>
                        <td width="50px"><input type="text" name="emplMobile1" id="emplMobile1" class="tb" value="101" readonly></td>
                        ...
                        <td width="80px"><input type="submit" name="submit" id="submit" class="btn" value="Issued"></td>
                    </tr>
                </table>
        	</form>
        </div>
