 ...
 <div class="col-md-10">
  <div class="studentpromote">
   ...
   <div class="studentpromote_link">
    <div class="row">
     <div class="col-xs-6">
      <a href="Student_Promotion.php"><button class="btnmanu">Student Promotion</button></a>
     </div>
     <div class="col-xs-6">
      <a href="Student_Bulk_Promotion.php" class="active"><button class="btnmanu">Bulk Student Promotion &nbsp;<font size="+2">&dArr;</font></button></a>
     </div>
    </div>
   </div>
   <div class="studentpromote_table">
    <form action="#" method="post">
     <table class="table-responsive">
      <tr class="col">
       <td>Sr. No.</td><td>Current Class</td><td>Current Master Class</td><td>Promote To Class</td><td>Promoted to Master Class</td><td>Action</td>
      </tr>
      <tr>
       <td>1</td>
       <td>I-D</td>
