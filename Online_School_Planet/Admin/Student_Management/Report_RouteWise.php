...
<div class="row c">
 <div class="col-md-2 hris1"> 
  ...
  <ul>
   ...
   <li class="active"><a href="Report_RouteWise.php"><button class="btnmanu">Route wise Student Report</button></a></li>
...
<!--------------Details------------------>
 <div class="col-md-10">
  <div class="studentwithdrawal">
    	<div class="studentwithdrawal_head">Route wise Report</div>
        <div class="studentroll">
        	<form action="" method="post">
	        	<div class="row">
    	        	<div class="col-md-9">
			        	<div class="row">
                			<div class="col-xs-6">Route Type</div>
                			<div class="col-xs-6">	<select name="routeType" id="routeType" class="text-box">
