...
if($LoggedInUser == "")
{
	echo ("<br><br><center><b>Due to security reason or network issues your session has expired!<br>Click <a href='http://ais81.onlineschoolplanet.in/Admin/logoff.php'>here</a> to login again");
	exit();
}
...
<div id="wrapper"> 
  ...
  <div class="top_main_holder">
    ...
    <div class="logoPart"><a href="index.asp"><img src="../images/logo.png" height=70 width=285/></a></div>
