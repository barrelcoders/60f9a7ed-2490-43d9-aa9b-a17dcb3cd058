...
if($LoggedInUser == "")
{
	echo ("<br><br><center><b>Due to security reason or network issues your session has expired!<br>Click <a href='http://dpsrohini.info/Admin/logoff.php'>here</a> to login again");
	exit();
}
else
{
	$rsChk=mysql_query("SELECT * FROM  `employee_master` where `UserId`='$LoggedInUser'");
	if(mysql_num_rows($rsChk)==0)
	{
		$rsChk=mysql_query("SELECT * FROM  `admin` where `suser`='$LoggedInUser'");
		if(mysql_num_rows($rsChk)==0)
		{
			echo ("<br><br><center><b>Due to security reason or network issues your session has expired!<br>Click <a href='http://dpsrohini.info/Admin/logoff.php'>here</a> to login again");
			exit();
...
<div id="wrapper"> 
  ...
  <div class="top_main_holder">
    <div class="logoPart"><a href="index.asp">

		<img src="../images/logo.png" height=33 width=166/></a></div>
    ...
    <div class="right_login_part">
      ...
      <div style="width: 563px; height: 25px">
       ...
       <a href="#" target="_blank">(<?php echo $_SESSION['userid']; ?>)<font face="Cambria"> 

		Select Application</font> �</a></b>
                  	...
                  	<ul id="ddsubmenu<?php echo $rowcount;?>" class="ddsubmenustyle">
	                  	...
	                  	?>
					               ...
					               <li>
						               	...
						               	<a href="<?php echo $MAINURL;?>"><?php echo $MenuItem;?> <?php if(mysql_num_rows($rsSubMenuItem) > 0) {?>Â»<?php }?></a>
...
ddlevelsmenu.setup("ddtopmenubar", "topbar") //ddlevelsmenu.setup("mainmenuid", "topbar|sidebar")
              ...
              <ul id="ddsubmenu3" class="ddsubmenustyle">
                ...
                <li class="dir"><a href="#">Issue Certificates Â»</a>
              ...
              <ul id="ddsubmenu4" class="ddsubmenustyle">
                ...
                <li ><a href="#">De-register / Withdraw StudentÂ»</a>
