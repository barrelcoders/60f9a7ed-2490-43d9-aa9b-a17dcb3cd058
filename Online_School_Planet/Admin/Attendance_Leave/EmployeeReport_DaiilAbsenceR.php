...
<!--------------Details------------------>
 <div class="col-md-10">
  <div class="attendancereport">
   <div class="attendancereport_top">Employee Attendance (Daily Absenee) Reports </div>
  ...
  <div class="attendancereport_table">
   <form action="#" method="post">
    <table>
     <tr class="col">
      <td>Sr.No.</td><td>Employee ID</td><td>Employee Name</td><td>Date</td><td>Attendance</td>
     </tr>
     <tr>
      <td>Sr.No.</td><td>Employee ID</td><td>Employee Name</td><td>Date</td><td>Attendance</td>
     </tr>
