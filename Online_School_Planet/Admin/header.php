  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li class="active"><a href="Employeemgt1.php">HOME</a></li>
        <li><a href="EmployeeMaster.php">EMPLOYEE TASKS</a></li>
        <li><a href="HRISbasicdetail.php">NEW EMPLOYEE</a></li>
        <li><a href="DeactivateEmployee.php" >EMPLOYEE EXIT</a></li>
        <li><a href="SendSMSToEmployee.php" >COMMUNICATION</a></li>
        <li><a href="LeaveOpningBalance.php" >LEAVE MGT</a></li>
        <li><a href="ServiceBook.php" >SERVICE BOOK</a></li>
      </ul>
