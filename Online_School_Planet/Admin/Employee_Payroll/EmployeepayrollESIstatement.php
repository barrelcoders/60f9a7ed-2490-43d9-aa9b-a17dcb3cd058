...
<div class="row c">
 <div class="col-md-2 hris1"> 
  ...
  <ul>
   ...
   <li class="active"><a href="EmployeepayrollESIstatement.php"><button class="btnmanu">ESI Statement</button></a></li>
...
<!--------------Details------------------>
 <div class="col-md-10"> 
  <div class="empl-top">ESI Fund Statement</div>
  ...
  <form action="" method="post" id="form" >
   ...
   <!------------------Table------------------------->
    ...
    <style>
     ...
     <table>
      <tr class="col">
       <td width="10px;">S.No.</td> <td width="150px;">Employee Code</td> <td width="250px;">Name</td> <td>Month</td> <td width="450px;">ESI Fund Amount - Employee Contribution</td>
      </tr>
      <tr> <td width="10px;">S.No.</td> <td>Employee Code</td> <td width="250px;">Name</td> <td>Month</td> <td>ESI Amount</td> </tr>
      <tr> <td width="10px;">S.No.</td> <td>Employee Code</td> <td width="250px;">Name</td> <td>Month</td> <td>ESI Amount</td> </tr>
