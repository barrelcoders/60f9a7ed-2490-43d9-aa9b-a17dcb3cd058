...
<!--------------Details------------------>
 <div class="col-md-10">
  <div class="emplmaster-desig">
   <div class="emplmastertop">Add Designation</div>
   <div class="row">
    ...
    <div class="col-xs-8"><input type="text" name="adddesignationname" id="adddesignationname" class="text-box"></div>
    <div class="col-xs-4"><b>3.</b>&nbsp;Status :</div>
    <div class="col-xs-8"><select name="designationstatus" id="designationstatus" class="text-box tbs">
    					  	<option value="">Select One</option>
 ...
 <div class="empdepartment-table" style="display:block;" id="comment">
  <table>
   <tr class="col"> <td>Sr.No.</td><td>Department</td><td>Designation</td><td>Status</td>  </tr>
   <tr> <td>1.</td> <td>XYZ</td> <td>HIJ</td> <td>0</td> </tr>
   <tr> <td>2.</td> <td>XYZ</td> <td>HIJ</td> <td>1</td> </tr>
  </table>
 </div>
</div>
<script>
