...
<div class="row c">
 <div class="col-md-2 hris1"> 
  ...
  <ul>
   ...
   <li class="active"><a href="Employeepayroll_Incometax2.php"><button class="btnmanu">Submit Investment Proof</button></a></li>
...
<!--------------Details------------------>
 <div class="col-md-10">
  <div class="emptax-top">Submit Declaration</div>
  ...
  <div class="declaration1">
   ...
   <div class="row">
    ...
    <div class="col-xs-3"><input type="date" name="fromdate" id="fromdate" class="text-box tbd"></div>
    <div class="col-xs-3">To Date</div>
    <div class="col-xs-3"><input type="date" name="todate" id="todate" class="text-box tbd"></div>
   </div>
   <div class="row">
    <div class="col-xs-3">City</div>
    <div class="col-xs-3"><input type="text" name="city" id="city" class="text-box"></div>
    <div class="col-xs-3">Landlord Name</div>
    <div class="col-xs-3"><input type="text" name="landlordname" id="landlordname" class="text-box"></div>
   </div>
   <div class="row">
    <div class="col-xs-3">Address</div>
    <div class="col-xs-3"><input type="text" name="address" id="address" class="text-box"></div>
    <div class="col-xs-3">PAN No.</div>
    <div class="col-xs-3"><input type="text" name="panno" id="panno" class="text-box"></div>
   </div>
   <div class="row">
    <div class="col-xs-3">Declared Amount</div>
    <div class="col-xs-3"><input type="number" name="declaredamount" id="declaredamount" class="text-box"></div>
    <div class="col-xs-3">Actual Amount</div>
    <div class="col-xs-3"><input type="number" name="actualamount" id="actualamount" class="text-box"></div>
   </div>
   <div class="row" style="border-bottom:1px solid #ccc; padding-bottom:1%;">
    <div class="col-xs-3">Approved Amount</div>
    <div class="col-xs-3"><input type="number" name="approvedamount" id="approvedamount" class="text-box"></div>
    <div class="col-xs-3">Document</div>
    <div class="col-xs-3"><input type="text" name="document" id="document" class="text-box"></div>    
   </div>
   <div class="row incometax-table1">
    <div class="col-xs-6">Higher Education Loan Interest Repayment (80E)</div>
    <div class="col-xs-6"><input type="number" name="highereducationloanrepay" id="highereducationloanrepay" class="text-box"></div>
    <div class="col-xs-6">Donation for Research (80GGA)</div>
    <div class="col-xs-6"><input type="number" name="donationreserch80gga" id="donationreserch80gga" class="text-box"> </div>
    <div class="col-xs-6">Claim Exemption under Section 80GG</div>
    <div class="col-xs-6"><select name="claimexemption80gg" id="claimexemption80gg" class="text-box tbs">
