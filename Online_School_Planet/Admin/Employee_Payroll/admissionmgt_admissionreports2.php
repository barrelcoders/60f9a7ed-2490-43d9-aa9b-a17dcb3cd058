...
.admission_table table td{padding:0.2% 1%; font-size:13px; border:1px solid #ccc; width:25%}
...
<div class="admission_table">
 <table class="table-responsive">
  <tr class="col"> <td>Sr.No.</td><td>Class</td><td>Count</td><td>Total Registration Fees Collected</td> </tr>
  <tr> <td>Sr.No.</td><td>Class</td><td>Count</td><td>Total Registration Fees Collected</td> </tr>
  <tr class="col1"> <td colspan="3">Total Registration Fee amount:</td><td>0</td> </tr>
 </table>
</div>
</form>
</div>
