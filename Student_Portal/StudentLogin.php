...
{
	header('Location: http://www.dpsfdb.info/mPortal/index.php');
	exit();
}
	...
	else
	{
			if ($spassword==$password1)
			{
				...
				//header('location: http://dpsfsis.com/Users/Notices.php');
   				echo "<script type='text/javascript'>window.location.href = 'http://dpsfbd.info/Student_Portal/Pages/index.php';</script>";
   				exit();
   				//die();	
			}
			else
 ...
 <div class="row">
  ...
  <div class="col-md-4">
   <table class="table-responsive">
    <thead style="background:#2d604a;" class="m">
    	<td colspan="3" class="c1"><img src="../image/m.png" class="img-responsive"></td>
    </thead>
    
    <tr>
    	<td  colspan="3"><h3 align="center" >STUDENT LOGIN</h3></td> 
    </tr>
    
    <tr>
    	<td colspan="3" class="c1"><input type="text" name="pupilname" id="pupilname" placeholder="Username" class="c"/></td>
    </tr>
    
    <tr>
    	<td colspan="3" class="c1"><input type="password" name="pupilpass" id="pupilpass" placeholder="Password" class="c"/></td>
    </tr>
    
    <tr> 
    	<td colspan="3" class="c1"><input type="submit" name="pupillogin" value="Login" id="pupillogin" onClick="Javascript:Validate();" class="btn"></td>
    </tr>
    
    <tr class="last">	
	    <td colspan="2"><input type="checkbox" value="r">&nbsp;&nbsp;Remember me </td>
	    <td ><a href="Admin/ForgotPassword.php" style="margin-left:0%"><u>Forget Password</u></a></td>
    </tr>
    
    <tr class="col">
	    <td><a href="https://www.facebook.com/pages/Delhi-Public-School-Faridabad/1660756614156230"><img src="../image/f.png"></a> </td>
	    <td><a href="#linkedln.com"><img src="../image/i.png"></a></td>
