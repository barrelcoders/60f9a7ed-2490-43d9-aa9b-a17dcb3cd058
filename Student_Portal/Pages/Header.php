...
<div id="container">
 <div class="top_header"> 
  <div class="row">
   <div class="col-md-4"><a href="index.php"><img src="../image/logo.png" class="img-responsive" ></a></div>
   <div class="col-md-8">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="http://dpsfbd.info/Admin/britannica.html">LEARNING ZONE</a></li>
      </ul>
    </div>
  </div>
</nav>
