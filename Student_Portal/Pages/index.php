...
<head>
 <meta charset='utf-8'>
   ...
   <title>Student Portal</title><link rel="icon" href="../image/l1.png" type="image/x-icon">
  ...
  <!-------Happening--------->
   <div class="col-md-6">
    <div class="happening_top">
     ...
     <div class="happening_top2"><a href="ImportantNews.php"><img src="../image/le.png" width="8%;">&nbsp;&nbsp;View All...</a></div>
    </div>
